...
is(
  ...
  "Test expand_path_template(): normal expand."
);
is(
  ...
  "customers/12345/accountBudgets/67890",
  "Test expand_path_template(): expand with more arguments."
);
is(
  expand_path_template($path_template, $customer_id),
  "customers/12345/accountBudgets/{account_budget_id}",
  "Test expand_path_template(): expand with less arguments."
);

$path_template = "v1/customers/{+customersId}/adGroups:mutate";
is(
  expand_path_template($path_template, $customer_id),
  "v1/customers/12345/adGroups:mutate",
  "Test expand_path_template(): expand with {+customersId}."
);
$path_template = "v1/googleAdsFields:search";
is(expand_path_template($path_template),
  "v1/googleAdsFields:search", "Test expand_path_template(): no expand");
...
$copied_campaign->{networkSettings}{targetSearchNetwort} = "false";
ok(
  eq_hash(
