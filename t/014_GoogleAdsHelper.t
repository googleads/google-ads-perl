...
my $path_template = "v18/googleAdsFields:search";
...
$path_template = "v18/customers/{+customerId}/adGroups:mutate";
is(
  expand_path_template(
    $path_template,
    {
  ...
  "v18/customers/12345/adGroups:mutate",
  "Test expand_path_template(): normal expand with hash reference."
);

$path_template = "v18/{+resourceName}:listAsyncErrors";
$args          = {
...
is(
  ...
  "v18/customers/12345/campaignDrafts/98765:listAsyncErrors",
