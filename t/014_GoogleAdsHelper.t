...
my $path_template = "v15/googleAdsFields:search";
...
$path_template = "v15/customers/{+customerId}/adGroups:mutate";
is(
  expand_path_template(
    $path_template,
    {
  ...
  "v15/customers/12345/adGroups:mutate",
  "Test expand_path_template(): normal expand with hash reference."
);

$path_template = "v15/{+resourceName}:listAsyncErrors";
$args          = {
...
is(
  ...
  "v15/customers/12345/campaignDrafts/98765:listAsyncErrors",
...
my $original_campaign = Google::Ads::GoogleAds::V15::Resources::Campaign->new({
    name                   => "Interplanetary Cruise",
    advertisingChannelType => "SEARCH",
    status                 => "PAUSED",
    biddingStrategy        => "MANUAL_CPC",
