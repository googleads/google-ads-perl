...
my $json_response = decode_json($json_text);
my $exception = Google::Ads::GoogleAds::GoogleAdsException->new($json_response);
...
$json_response = decode_json($json_text);
$exception = Google::Ads::GoogleAds::GoogleAdsException->new($json_response);
