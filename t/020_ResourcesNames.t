...
# Tests use Google::Ads::GoogleAds::V14::Utils::ResourceNames.
use_ok("Google::Ads::GoogleAds::V14::Utils::ResourceNames");

# Tests account_budget_proposal().
my $expected = "customers/1234/accountBudgetProposals/5678";
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::account_budget_proposal(
    1234, 5678
  ),
  $expected,
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_group_ad(
    1234, 5678, 1011
  ),
  $expected,
  "ad_group_ad"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_group_bid_modifier(
    1234, 5678, 1011
  ),
  $expected,
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_group_criterion(
    1234, 5678, 1011
  ),
  $expected,
  "ad_group_criterion"
...
is(Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_group(1234, 5678),
  $expected, "ad_group");

# Tests ad_parameter().
$expected = "customers/1234/adParameters/5678~1011~3";
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_parameter(
    1234, 5678, 1011, 3
  ),
  $expected,
  "ad_parameter"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_schedule_view(
    1234, 5678, 1011
  ),
  $expected,
  "ad_schedule_view"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::bidding_strategy(
    1234, 5678
  ),
  $expected,
  "bidding_strategy"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::billing_setup(1234, 5678),
  $expected, "billing_setup"
);

# Tests campaign().
$expected = "customers/1234/campaigns/5678";
is(Google::Ads::GoogleAds::V14::Utils::ResourceNames::campaign(1234, 5678),
  $expected, "campaign");

# Tests campaign_bid_modifier().
$expected = "customers/1234/campaignBidModifiers/5678~1011";
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::campaign_bid_modifier(
    1234, 5678, 1011
  ),
  $expected,
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::campaign_criterion(
    1234, 5678, 1011
  ),
  $expected,
  "campaign_criterion"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::campaign_shared_set(
    1234, 5678, 91011
  ),
  $expected,
  "campaign_shared_set"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::change_status(
    1234, "5678asd"
  ),
  $expected,
  "change_status"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::click_view(
...
is(Google::Ads::GoogleAds::V14::Utils::ResourceNames::customer(1234),
  $expected, "customer");

# Tests geo_target_constant().
$expected = "geoTargetConstants/1234";
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::geo_target_constant(1234),
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::google_ads_field(
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::keyword_view(
    1234, 5678, 1011
  ),
  $expected,
  "keyword_view"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::mobile_app_category_constant(
    1234),
  $expected,
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::mobile_device_constant(
    1234),
  $expected,
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::operating_system_version_constant(
    1234),
  $expected,
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::remarketing_action(
    1234, 5678
  ),
  $expected,
  "remarketing_action"
...
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::search_term_view(
...
is(Google::Ads::GoogleAds::V14::Utils::ResourceNames::shared_set(1234, 5678),
  $expected, "shared_set");

# Tests shared_criterion().
$expected = "customers/1234/sharedCriteria/5678~91011";
is(
  Google::Ads::GoogleAds::V14::Utils::ResourceNames::shared_criterion(
    1234, 5678, 91011
  ),
  $expected,
  "shared_criterion"
...
is(Google::Ads::GoogleAds::V14::Utils::ResourceNames::video(1234, "5678asd"),
  $expected, "video");
