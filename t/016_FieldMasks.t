...
use Google::Ads::GoogleAds::V10::Common::TextAdInfo;
...
my $original_campaign = Google::Ads::GoogleAds::V10::Resources::Campaign->new({
  name => "test name",
  id   => 1234
});
my $modified_campaign = Google::Ads::GoogleAds::V10::Resources::Campaign->new({
  name => "test string",
  id   => 5678
});
...
$original_campaign = Google::Ads::GoogleAds::V10::Resources::Campaign->new();
$modified_campaign = Google::Ads::GoogleAds::V10::Resources::Campaign->new({
  name => "test string",
  id   => 5678
});
...
my $original_ad = Google::Ads::GoogleAds::V10::Resources::Ad->new({
  finalUrls => ["url 1"],
});
my $modified_ad = Google::Ads::GoogleAds::V10::Resources::Ad->new({
...
$original_ad = Google::Ads::GoogleAds::V10::Resources::Ad->new({
  finalUrls => ["url 1", "url 2"],
});
$modified_ad = Google::Ads::GoogleAds::V10::Resources::Ad->new({
    finalUrls => ["url 1"]});
$field_mask = field_mask($original_ad, $modified_ad);
ok(eq_set($field_mask->{paths}, ["final_urls"]),
...
$original_ad = Google::Ads::GoogleAds::V10::Resources::Ad->new({
    textAd => Google::Ads::GoogleAds::V10::Common::TextAdInfo->new({
        headline => "headline"
      })});
$modified_ad = Google::Ads::GoogleAds::V10::Resources::Ad->new({
    textAd => Google::Ads::GoogleAds::V10::Common::TextAdInfo->new({
