...
my $google_ads_service =
  Google::Ads::GoogleAds::V4::Services::GoogleAdsService->new({
...
ok(
  $google_ads_failure->isa(
    "Google::Ads::GoogleAds::V4::Errors::GoogleAdsFailure"),
"GoogleAdsFailure : Is a Google::Ads::GoogleAds::V4::Errors::GoogleAdsFailure."
);
