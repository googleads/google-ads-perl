...
use Google::Ads::GoogleAds::V5::Services::GoogleAdsService;
use
...
my $google_ads_service =
  Google::Ads::GoogleAds::V5::Services::GoogleAdsService->new({
...
"GoogleAdsFailure : Is a Google::Ads::GoogleAds::V5::Errors::GoogleAdsFailure."
);
