...
use Google::Ads::GoogleAds::V9::Services::GoogleAdsService;
use
...
my $google_ads_service =
  Google::Ads::GoogleAds::V9::Services::GoogleAdsService->new({
...
"GoogleAdsFailure : Is a Google::Ads::GoogleAds::V9::Errors::GoogleAdsFailure."
);
