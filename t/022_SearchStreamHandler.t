...
use Google::Ads::GoogleAds::V6::Services::GoogleAdsService;
use
...
my $google_ads_service =
  Google::Ads::GoogleAds::V6::Services::GoogleAdsService->new({
...
ok(
  $google_ads_failure->isa(
    "Google::Ads::GoogleAds::V6::Errors::GoogleAdsFailure"),
"GoogleAdsFailure : Is a Google::Ads::GoogleAds::V6::Errors::GoogleAdsFailure."
);
