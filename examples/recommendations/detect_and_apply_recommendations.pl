...
use
  Google::Ads::GoogleAds::V23::Services::RecommendationService::ApplyRecommendationOperation;
use
...
sub build_recommendation_operation {
  ...
  #   Google::Ads::GoogleAds::V23::Utils::ResourceNames::recommendation(
  #   $customer_id, $recommendation_id);

  # Each recommendation type has optional parameters to override the recommended values.
  # Below is an example showing how to override a recommended ad when a TextAdRecommendation
  # is applied.
  # my $overriding_ad = Google::Ads::GoogleAds::V23::Resources::Ad->new({
  #   id => "INSERT_AD_ID_AS_INTEGER_HERE"
  # });
  # my $text_ad_parameters =
  #   Google::Ads::GoogleAds::V23::Services::RecommendationService::TextAdParameters
