...
use
  Google::Ads::GoogleAds::V24::Services::RecommendationService::ApplyRecommendationOperation;
use
...
sub build_recommendation_operation {
  ...
  # is applied.
  # my $overriding_ad = Google::Ads::GoogleAds::V24::Resources::Ad->new({
  #   id => "INSERT_AD_ID_AS_INTEGER_HERE"
  # });
  # my $text_ad_parameters =
  #   Google::Ads::GoogleAds::V24::Services::RecommendationService::TextAdParameters
