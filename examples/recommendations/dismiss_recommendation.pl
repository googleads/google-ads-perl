...
#
# This example dismisses a given recommendation. To retrieve recommendations
...
use
  Google::Ads::GoogleAds::V1::Services::RecommendationService::DismissRecommendationOperation;
...
sub dismiss_recommendation {
  my ($client, $customer_id, $recommendation_id) = @_;

  my $recommendation_resource_name =
    Google::Ads::GoogleAds::V1::Utils::ResourceNames::recommendation(
  ...
  my $dismiss_recommendation_response =
    $client->RecommendationService()->dismiss({
...
# Call the example.
dismiss_recommendation($client, $customer_id =~ s/-//gr, $recommendation_id);
