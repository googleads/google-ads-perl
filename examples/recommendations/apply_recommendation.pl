...
sub apply_recommendation {
  ...
  #
  # my $overriding_ad = Google::Ads::GoogleAds::V1::Resources::Ad->new({
  #   id => "INSERT_AD_ID_AS_INTEGER_HERE"
  # });
  # my $text_ad_parameters =
  #   Google::Ads::GoogleAds::V1::Services::RecommendationService::TextAdParameters
  #   ->new({ad => $overriding_ad});
  # $apply_recommendation_operation->{textAd} = $text_ad_parameters;

  # Apply the recommendation.
  my $apply_recommendation_response = $client->RecommendationService()->apply({
...
# Call the example.
apply_recommendation($client, $customer_id =~ s/-//gr, $recommendation_id);
