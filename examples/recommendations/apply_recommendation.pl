...
use
  Google::Ads::GoogleAds::V10::Services::RecommendationService::ApplyRecommendationOperation;
...
sub apply_recommendation {
  ...
  my $recommendation_resource_name =
    Google::Ads::GoogleAds::V10::Utils::ResourceNames::recommendation(
  ...
  #
  # my $overriding_ad = Google::Ads::GoogleAds::V10::Resources::Ad->new({
  #   id => "INSERT_AD_ID_AS_INTEGER_HERE"
  # });
  # my $text_ad_parameters =
  #   Google::Ads::GoogleAds::V10::Services::RecommendationService::TextAdParameters
