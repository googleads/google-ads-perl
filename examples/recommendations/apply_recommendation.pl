...
use
  Google::Ads::GoogleAds::V2::Services::RecommendationService::ApplyRecommendationOperation;
...
sub apply_recommendation {
  ...
  my $recommendation_resource_name =
    Google::Ads::GoogleAds::V2::Utils::ResourceNames::recommendation(
  ...
  # https://developers.google.com/google-ads/api/reference/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ApplyRecommendationOperation.
  #
  # my $overriding_ad = Google::Ads::GoogleAds::V2::Resources::Ad->new({
  #   id => "INSERT_AD_ID_AS_INTEGER_HERE"
  # });
  # my $text_ad_parameters =
  #   Google::Ads::GoogleAds::V2::Services::RecommendationService::TextAdParameters
