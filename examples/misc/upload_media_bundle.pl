...
use Google::Ads::GoogleAds::V10::Resources::MediaFile;
use Google::Ads::GoogleAds::V10::Resources::MediaBundle;
use Google::Ads::GoogleAds::V10::Enums::MediaTypeEnum qw(MEDIA_BUNDLE);
use Google::Ads::GoogleAds::V10::Services::MediaFileService::MediaFileOperation;
...
sub upload_media_bundle {
  ...
  # Create a media file.
  my $media_file = Google::Ads::GoogleAds::V10::Resources::MediaFile->new({
      name        => "Ad Media Bundle",
      type        => MEDIA_BUNDLE,
      mediaBundle => Google::Ads::GoogleAds::V10::Resources::MediaBundle->new({
          data => $bundle_content
        })});

  # Create a media file operation.
  my $media_file_operation =
    Google::Ads::GoogleAds::V10::Services::MediaFileService::MediaFileOperation
    ->new({
      create => $media_file
    });
