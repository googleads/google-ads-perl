...
use Google::Ads::GoogleAds::V10::Resources::MediaImage;
use Google::Ads::GoogleAds::V10::Resources::MediaFile;
use Google::Ads::GoogleAds::V10::Enums::MediaTypeEnum qw(IMAGE);
...
sub upload_image {
  ...
  my $media_image = Google::Ads::GoogleAds::V10::Resources::MediaImage->new({
