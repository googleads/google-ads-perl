...
use Google::Ads::GoogleAds::V9::Resources::MediaImage;
use Google::Ads::GoogleAds::V9::Resources::MediaFile;
use Google::Ads::GoogleAds::V9::Enums::MediaTypeEnum qw(IMAGE);
...
sub upload_image {
  ...
  my $media_image = Google::Ads::GoogleAds::V9::Resources::MediaImage->new({
