...
use Google::Ads::GoogleAds::V9::Resources::KeywordPlan;
use Google::Ads::GoogleAds::V9::Resources::KeywordPlanForecastPeriod;
use Google::Ads::GoogleAds::V9::Resources::KeywordPlanCampaign;
use Google::Ads::GoogleAds::V9::Resources::KeywordPlanGeoTarget;
use Google::Ads::GoogleAds::V9::Resources::KeywordPlanAdGroup;
use Google::Ads::GoogleAds::V9::Resources::KeywordPlanAdGroupKeyword;
use Google::Ads::GoogleAds::V9::Resources::KeywordPlanCampaignKeyword;
use Google::Ads::GoogleAds::V9::Enums::KeywordPlanForecastIntervalEnum
  qw(NEXT_QUARTER);
use Google::Ads::GoogleAds::V9::Enums::KeywordPlanNetworkEnum qw(GOOGLE_SEARCH);
use Google::Ads::GoogleAds::V9::Enums::KeywordMatchTypeEnum
  qw(BROAD PHRASE EXACT);
use
  Google::Ads::GoogleAds::V9::Services::KeywordPlanService::KeywordPlanOperation;
use
  Google::Ads::GoogleAds::V9::Services::KeywordPlanCampaignService::KeywordPlanCampaignOperation;
use
  Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupService::KeywordPlanAdGroupOperation;
use
  Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupKeywordService::KeywordPlanAdGroupKeywordOperation;
use
  Google::Ads::GoogleAds::V9::Services::KeywordPlanCampaignKeywordService::KeywordPlanCampaignKeywordOperation;
...
sub create_keyword_plan {
  ...
  my $keyword_plan = Google::Ads::GoogleAds::V9::Resources::KeywordPlan->new({
      name           => "Keyword plan for traffic estimate #" . uniqid(),
      forecastPeriod =>
        Google::Ads::GoogleAds::V9::Resources::KeywordPlanForecastPeriod->new({
...
sub create_keyword_plan_campaign {
  ...
  my $keyword_plan_campaign =
    Google::Ads::GoogleAds::V9::Resources::KeywordPlanCampaign->new({
  ...
  $keyword_plan_campaign->{geoTargets} = [
    Google::Ads::GoogleAds::V9::Resources::KeywordPlanGeoTarget->new({
  ...
  $keyword_plan_campaign->{languageConstants} = [
    ...
    Google::Ads::GoogleAds::V9::Utils::ResourceNames::language_constant(1000)];
...
sub create_keyword_plan_ad_group {
  ...
  my $keyword_plan_ad_group =
    Google::Ads::GoogleAds::V9::Resources::KeywordPlanAdGroup->new({
...
sub create_keyword_plan_ad_group_keywords {
  ...
  my $keyword_plan_ad_group_keyword1 =
    Google::Ads::GoogleAds::V9::Resources::KeywordPlanAdGroupKeyword->new({
      text               => "mars cruise",
...
sub create_keyword_plan_negative_campaign_keywords {
  ...
  my $keyword_plan_campaign_keyword =
    Google::Ads::GoogleAds::V9::Resources::KeywordPlanCampaignKeyword->new({
      text                => "moon walk",
      matchType           => BROAD,
      negative            => "true",
      keywordPlanCampaign => $keyword_plan_campaign_resource
