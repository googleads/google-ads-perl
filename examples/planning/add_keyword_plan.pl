...
use Google::Ads::GoogleAds::V6::Enums::KeywordPlanForecastIntervalEnum
  qw(NEXT_QUARTER);
use Google::Ads::GoogleAds::V6::Enums::KeywordPlanNetworkEnum qw(GOOGLE_SEARCH);
use Google::Ads::GoogleAds::V6::Enums::KeywordMatchTypeEnum
  qw(BROAD PHRASE EXACT);
use
  Google::Ads::GoogleAds::V6::Services::KeywordPlanService::KeywordPlanOperation;
use
  Google::Ads::GoogleAds::V6::Services::KeywordPlanCampaignService::KeywordPlanCampaignOperation;
use
  Google::Ads::GoogleAds::V6::Services::KeywordPlanAdGroupService::KeywordPlanAdGroupOperation;
use
  Google::Ads::GoogleAds::V6::Services::KeywordPlanAdGroupKeywordService::KeywordPlanAdGroupKeywordOperation;
use
  Google::Ads::GoogleAds::V6::Services::KeywordPlanCampaignKeywordService::KeywordPlanCampaignKeywordOperation;
...
sub create_keyword_plan {
  ...
  my $keyword_plan = Google::Ads::GoogleAds::V6::Resources::KeywordPlan->new({
      name => "Keyword plan for traffic estimate #" . uniqid(),
      forecastPeriod =>
        Google::Ads::GoogleAds::V6::Resources::KeywordPlanForecastPeriod->new({
...
sub create_keyword_plan_campaign {
  ...
  my $keyword_plan_campaign =
    Google::Ads::GoogleAds::V6::Resources::KeywordPlanCampaign->new({
  ...
  $keyword_plan_campaign->{languageConstants} = [
    ...
    Google::Ads::GoogleAds::V6::Utils::ResourceNames::language_constant(1000)];
...
sub create_keyword_plan_ad_group {
  ...
  my $keyword_plan_ad_group =
    Google::Ads::GoogleAds::V6::Resources::KeywordPlanAdGroup->new({
...
sub create_keyword_plan_ad_group_keywords {
  ...
  my $keyword_plan_ad_group_keyword1 =
    Google::Ads::GoogleAds::V6::Resources::KeywordPlanAdGroupKeyword->new({
      text               => "mars cruise",
...
sub create_keyword_plan_negative_campaign_keywords {
  ...
  my $keyword_plan_campaign_keyword =
    Google::Ads::GoogleAds::V6::Resources::KeywordPlanCampaignKeyword->new({
      text                => "moon walk",
      matchType           => BROAD,
      negative            => "true",
      keywordPlanCampaign => $keyword_plan_campaign_resource
