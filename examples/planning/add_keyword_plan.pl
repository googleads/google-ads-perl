...
use Google::Ads::GoogleAds::V1::Resources::KeywordPlan;
use Google::Ads::GoogleAds::V1::Resources::KeywordPlanForecastPeriod;
use Google::Ads::GoogleAds::V1::Resources::KeywordPlanCampaign;
use Google::Ads::GoogleAds::V1::Resources::KeywordPlanGeoTarget;
use Google::Ads::GoogleAds::V1::Resources::KeywordPlanAdGroup;
use Google::Ads::GoogleAds::V1::Resources::KeywordPlanKeyword;
use Google::Ads::GoogleAds::V1::Resources::KeywordPlanNegativeKeyword;
use Google::Ads::GoogleAds::V1::Enums::KeywordPlanForecastIntervalEnum
  qw(NEXT_QUARTER);
use Google::Ads::GoogleAds::V1::Enums::KeywordPlanNetworkEnum qw(GOOGLE_SEARCH);
use Google::Ads::GoogleAds::V1::Enums::KeywordMatchTypeEnum
  qw(BROAD PHRASE EXACT);
use
  Google::Ads::GoogleAds::V1::Services::KeywordPlanService::KeywordPlanOperation;
use
  Google::Ads::GoogleAds::V1::Services::KeywordPlanCampaignService::KeywordPlanCampaignOperation;
use
  Google::Ads::GoogleAds::V1::Services::KeywordPlanAdGroupService::KeywordPlanAdGroupOperation;
use
  Google::Ads::GoogleAds::V1::Services::KeywordPlanKeywordService::KeywordPlanKeywordOperation;
use
  Google::Ads::GoogleAds::V1::Services::KeywordPlanNegativeKeywordService::KeywordPlanNegativeKeywordOperation;
...
sub add_keyword_plan {
  ...
  my $keyword_plan_resource = create_keyword_plan($client, $customer_id);

  my $keyword_plan_campaign_resource =
    create_keyword_plan_campaign($client, $customer_id, $keyword_plan_resource);

  my $keyword_plan_ad_group_resource =
    create_keyword_plan_ad_group($client, $customer_id,
    $keyword_plan_campaign_resource);

  create_keyword_plan_keywords($client, $customer_id,
...
sub create_keyword_plan {
  ...
  my $keyword_plan = Google::Ads::GoogleAds::V1::Resources::KeywordPlan->new({
  ...
  my $keyword_plan_resource = $client->KeywordPlanService()->mutate({
...
sub create_keyword_plan_campaign {
  my ($client, $customer_id, $keyword_plan_resource) = @_;
  ...
  $keyword_plan_campaign->{languageConstants} = [
    ...
    Google::Ads::GoogleAds::V1::Utils::ResourceNames::language_constant(1000)];
  ...
  my $keyword_plan_campaign_resource =
    $client->KeywordPlanCampaignService()->mutate({
      customerId => $customer_id,
...
sub create_keyword_plan_ad_group {
  my ($client, $customer_id, $keyword_plan_campaign_resource) = @_;
  ...
  my $keyword_plan_ad_group_resource =
    $client->KeywordPlanAdGroupService()->mutate({
      customerId => $customer_id,
...
sub create_keyword_plan_keywords {
  my ($client, $customer_id, $keyword_plan_ad_group_resource) = @_;
  ...
  my $keyword_plan_keyword_response =
    $client->KeywordPlanKeywordService()->mutate({
      customerId => $customer_id,
...
sub create_keyword_plan_negative_keywords {
  ...
  my $keyword_plan_negative_keyword_response =
    $client->KeywordPlanNegativeKeywordService()->mutate({
      customerId => $customer_id,
...
# Call the example.
add_keyword_plan($client, $customer_id =~ s/-//gr);
