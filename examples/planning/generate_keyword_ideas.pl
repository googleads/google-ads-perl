...
use Google::Ads::GoogleAds::V15::Enums::KeywordPlanNetworkEnum
  qw(GOOGLE_SEARCH GOOGLE_SEARCH_AND_PARTNERS);
use Google::Ads::GoogleAds::V15::Services::KeywordPlanIdeaService::UrlSeed;
use Google::Ads::GoogleAds::V15::Services::KeywordPlanIdeaService::KeywordSeed;
use
  Google::Ads::GoogleAds::V15::Services::KeywordPlanIdeaService::KeywordAndUrlSeed;
...
sub generate_keyword_ideas {
  ...
  if (!scalar @$keyword_texts) {
    ...
    $request_option_args->{urlSeed} =
      Google::Ads::GoogleAds::V15::Services::KeywordPlanIdeaService::UrlSeed->
      new({
        url => $page_url
      });
  } elsif (not $page_url) {
    ...
    $request_option_args->{keywordSeed} =
      Google::Ads::GoogleAds::V15::Services::KeywordPlanIdeaService::KeywordSeed
      ->new({
