...
use Google::Ads::GoogleAds::V24::Enums::KeywordPlanNetworkEnum
  qw(GOOGLE_SEARCH GOOGLE_SEARCH_AND_PARTNERS);
use Google::Ads::GoogleAds::V24::Services::KeywordPlanIdeaService::UrlSeed;
use Google::Ads::GoogleAds::V24::Services::KeywordPlanIdeaService::KeywordSeed;
use
