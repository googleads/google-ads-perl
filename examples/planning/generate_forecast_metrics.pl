...
use Google::Ads::GoogleAds::V19::Common::DateRange;
use Google::Ads::GoogleAds::V19::Common::KeywordInfo;
use
  Google::Ads::GoogleAds::V19::Services::KeywordPlanIdeaService::BiddableKeyword;
use
  Google::Ads::GoogleAds::V19::Services::KeywordPlanIdeaService::CampaignToForecast;
use
  Google::Ads::GoogleAds::V19::Services::KeywordPlanIdeaService::CriterionBidModifier;
use
  Google::Ads::GoogleAds::V19::Services::KeywordPlanIdeaService::ForecastAdGroup;
use
  Google::Ads::GoogleAds::V19::Services::KeywordPlanIdeaService::ManualCpcBiddingStrategy;
...
sub create_campaign_to_forecast {
  ...
  $campaign_to_forecast->{languageConstants} = [
    ...
    Google::Ads::GoogleAds::V19::Utils::ResourceNames::language_constant(1000)];
