...
use Google::Ads::GoogleAds::V20::Enums::ReachPlanAdLengthEnum
  qw(FIFTEEN_OR_TWENTY_SECONDS);
use Google::Ads::GoogleAds::V20::Enums::GenderTypeEnum qw(MALE FEMALE);
use Google::Ads::GoogleAds::V20::Enums::DeviceEnum qw(DESKTOP MOBILE TABLET);
use Google::Ads::GoogleAds::V20::Enums::ReachPlanAgeRangeEnum
  qw(AGE_RANGE_18_65_UP);
use Google::Ads::GoogleAds::V20::Services::ReachPlanService::PlannedProduct;
use Google::Ads::GoogleAds::V20::Services::ReachPlanService::CampaignDuration;
use Google::Ads::GoogleAds::V20::Services::ReachPlanService::Targeting;
use
  Google::Ads::GoogleAds::V20::Services::ReachPlanService::GenerateReachForecastRequest;
...
sub forecast_mix {
  ...
  push @$product_mix,
    Google::Ads::GoogleAds::V20::Services::ReachPlanService::PlannedProduct->
    new({
...
sub build_reach_request {
  ...
  my $duration =
    Google::Ads::GoogleAds::V20::Services::ReachPlanService::CampaignDuration->
    new({
      durationInDays => 28
    });

  my $genders = [
    Google::Ads::GoogleAds::V20::Common::GenderInfo->new({
        type => FEMALE
      }
    ),
    Google::Ads::GoogleAds::V20::Common::GenderInfo->new({
  ...
  my $devices = [
    Google::Ads::GoogleAds::V20::Common::DeviceInfo->new({
        type => DESKTOP
      }
    ),
    Google::Ads::GoogleAds::V20::Common::DeviceInfo->new({
  ...
  my $targeting =
    Google::Ads::GoogleAds::V20::Services::ReachPlanService::Targeting->new({
      plannableLocationId => $location_id,
