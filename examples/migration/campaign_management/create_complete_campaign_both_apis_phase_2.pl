...
#
# This code example is the third in a series of code examples that show how to
...
#
# In this code example, the functionalities to create a campaign budget and a
# search campaign have been migrated to the Google Ads API. The remaining
# functionalities - creating an ad group, creating expanded text ads and creating
...
use Google::Ads::GoogleAds::V10::Enums::AdvertisingChannelTypeEnum qw(SEARCH);
...
sub create_complete_campaign_both_apis_phase_2 {
  ...
  my $ad_group = create_ad_group($adwords_client, $campaign->{id});
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V10::Resources::Campaign->new({
      ...
      manualCpc      => Google::Ads::GoogleAds::V10::Common::ManualCpc->new(),
...
create_complete_campaign_both_apis_phase_2

=head1 DESCRIPTION

This code example is the third in a series of code examples that show how to create
...
In this code example, the functionalities to create a campaign budget and a search
campaign have been migrated to the Google Ads API. The remaining functionalities -
creating an ad group, creating expanded text ads and creating keywords - are using
the AdWords API.
