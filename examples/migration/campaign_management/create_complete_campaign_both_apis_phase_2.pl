...
#
# This code example is the third in a series of code examples that show
...
#
# In this code example, the functionalities to create a campaign budget and
# a search campaign have been migrated to the Google Ads API. The remaining
# functionalities - creating an ad group, creating expanded text ads and
# creating keywords - are using the AdWords API.
...
use Google::Ads::GoogleAds::V2::Enums::CampaignStatusEnum qw(PAUSED);
use
