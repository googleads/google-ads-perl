...
use Google::Ads::GoogleAds::V7::Resources::FeedItemSetLink;
use
  Google::Ads::GoogleAds::V7::Services::FeedItemSetLinkService::FeedItemSetLinkOperation;
...
sub link_feed_item_set {
  ...
  my $feed_item_set_link =
    Google::Ads::GoogleAds::V7::Resources::FeedItemSetLink->new({
      feedItemSet =>
        Google::Ads::GoogleAds::V7::Utils::ResourceNames::feed_item_set(
        $customer_id, $feed_id, $feed_item_set_id
        ),
      feedItem => Google::Ads::GoogleAds::V7::Utils::ResourceNames::feed_item(
