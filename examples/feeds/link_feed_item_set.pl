...
use Google::Ads::GoogleAds::V15::Resources::FeedItemSetLink;
use
  Google::Ads::GoogleAds::V15::Services::FeedItemSetLinkService::FeedItemSetLinkOperation;
...
sub link_feed_item_set {
  ...
  my $feed_item_set_link =
    Google::Ads::GoogleAds::V15::Resources::FeedItemSetLink->new({
      feedItemSet =>
        Google::Ads::GoogleAds::V15::Utils::ResourceNames::feed_item_set(
        $customer_id, $feed_id, $feed_item_set_id
        ),
      feedItem => Google::Ads::GoogleAds::V15::Utils::ResourceNames::feed_item(
