...
use Google::Ads::GoogleAds::V16::Resources::FeedItemSet;
use Google::Ads::GoogleAds::V16::Common::DynamicLocationSetFilter;
use Google::Ads::GoogleAds::V16::Common::BusinessNameFilter;
use Google::Ads::GoogleAds::V16::Common::DynamicAffiliateLocationSetFilter;
use Google::Ads::GoogleAds::V16::Enums::FeedItemSetStringFilterTypeEnum
  qw(EXACT);
use
  Google::Ads::GoogleAds::V16::Services::FeedItemSetService::FeedItemSetOperation;
...
sub create_feed_item_set {
  ...
  my $feed_item_set = Google::Ads::GoogleAds::V16::Resources::FeedItemSet->new({
      feed => Google::Ads::GoogleAds::V16::Utils::ResourceNames::feed(
        $customer_id, $feed_id
      ),
  ...
  #   Google::Ads::GoogleAds::V16::Common::DynamicLocationSetFilter->new({
  #     # Add a filter for a business name using exact matching.
  #     businessNameFilter =>
  #       Google::Ads::GoogleAds::V16::Common::BusinessNameFilter->new({
  #         businessName => "INSERT_YOUR_BUSINESS_NAME_HERE",
  #         filterType   => EXACT
  #       })});
  # 2) Affiliate extension.
  # $feed_item_set->{dynamicAffiliateLocationSetFilter} =
  #   Google::Ads::GoogleAds::V16::Common::DynamicAffiliateLocationSetFilter->new({
