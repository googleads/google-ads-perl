...
use Google::Ads::GoogleAds::V18::Services::FeedItemService::FeedItemOperation;
...
sub remove_feed_items {
  ...
  for my $feed_item_id (@$feed_item_ids) {
    my $feed_item_resource_name =
      Google::Ads::GoogleAds::V18::Utils::ResourceNames::feed_item($customer_id,
      $feed_id, $feed_item_id);

    push @$feed_item_operations,
      Google::Ads::GoogleAds::V18::Services::FeedItemService::FeedItemOperation
      ->new({
