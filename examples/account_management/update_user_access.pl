...
use Google::Ads::GoogleAds::V25::Resources::CustomerUserAccess;
use
  Google::Ads::GoogleAds::V25::Services::GoogleAdsService::SearchGoogleAdsRequest;
use
  Google::Ads::GoogleAds::V25::Services::CustomerUserAccessService::CustomerUserAccessOperation;
...
sub modify_user_access {
  ...
  my $user_access =
    Google::Ads::GoogleAds::V25::Resources::CustomerUserAccess->new({
      resourceName =>
        Google::Ads::GoogleAds::V25::Utils::ResourceNames::customer_user_access(
        $customer_id, $user_id
        ),
