...
use Google::Ads::GoogleAds::V12::Resources::CustomerUserAccess;
use
  Google::Ads::GoogleAds::V12::Services::GoogleAdsService::SearchGoogleAdsRequest;
use
  Google::Ads::GoogleAds::V12::Services::CustomerUserAccessService::CustomerUserAccessOperation;
...
# See Google::Ads::GoogleAds::V12::Enums::AccessRoleEnum for optional values.
...
sub modify_user_access {
  ...
  my $user_access =
    Google::Ads::GoogleAds::V12::Resources::CustomerUserAccess->new({
      resourceName =>
        Google::Ads::GoogleAds::V12::Utils::ResourceNames::customer_user_access(
        $customer_id, $user_id
        ),
