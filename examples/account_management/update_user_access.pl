...
use
  Google::Ads::GoogleAds::V10::Services::CustomerUserAccessService::CustomerUserAccessOperation;
...
# See Google::Ads::GoogleAds::V10::Enums::AccessRoleEnum for optional values.
...
sub modify_user_access {
  ...
  my $user_access =
    Google::Ads::GoogleAds::V10::Resources::CustomerUserAccess->new({
      resourceName =>
        Google::Ads::GoogleAds::V10::Utils::ResourceNames::customer_user_access(
        $customer_id, $user_id
        ),
