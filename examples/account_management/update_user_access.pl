...
use
  Google::Ads::GoogleAds::V8::Services::CustomerUserAccessService::CustomerUserAccessOperation;
...
# See Google::Ads::GoogleAds::V8::Enums::AccessRoleEnum for optional values.
...
sub modify_user_access {
  ...
  my $user_access =
    Google::Ads::GoogleAds::V8::Resources::CustomerUserAccess->new({
      resourceName =>
        Google::Ads::GoogleAds::V8::Utils::ResourceNames::customer_user_access(
        $customer_id, $user_id
        ),
