...
use Google::Ads::GoogleAds::V8::Enums::MerchantCenterLinkStatusEnum
  qw(ENABLED PENDING);
use
  Google::Ads::GoogleAds::V8::Services::MerchantCenterLinkService::MerchantCenterLinkOperation;
...
sub update_merchant_center_link_status {
  ...
  my $merchant_center_link_to_update =
    Google::Ads::GoogleAds::V8::Resources::MerchantCenterLink->new({
