...
use Google::Ads::GoogleAds::V10::Enums::MerchantCenterLinkStatusEnum
  qw(ENABLED PENDING);
use
  Google::Ads::GoogleAds::V10::Services::MerchantCenterLinkService::MerchantCenterLinkOperation;
...
sub update_merchant_center_link_status {
  ...
  my $merchant_center_link_to_update =
    Google::Ads::GoogleAds::V10::Resources::MerchantCenterLink->new({
