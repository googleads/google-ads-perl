...
use Google::Ads::GoogleAds::V7::Resources::MerchantCenterLink;
use Google::Ads::GoogleAds::V7::Enums::MerchantCenterLinkStatusEnum
  qw(ENABLED PENDING);
use
  Google::Ads::GoogleAds::V7::Services::MerchantCenterLinkService::MerchantCenterLinkOperation;
...
sub update_merchant_center_link_status {
  ...
  my $merchant_center_link_to_update =
    Google::Ads::GoogleAds::V7::Resources::MerchantCenterLink->new({
