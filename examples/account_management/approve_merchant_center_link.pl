...
use Google::Ads::GoogleAds::V6::Enums::MerchantCenterLinkStatusEnum
  qw(ENABLED PENDING);
use
  Google::Ads::GoogleAds::V6::Services::MerchantCenterLinkService::MerchantCenterLinkOperation;
...
sub update_merchant_center_link_status {
  ...
  my $merchant_center_link_to_update =
    Google::Ads::GoogleAds::V6::Resources::MerchantCenterLink->new({
