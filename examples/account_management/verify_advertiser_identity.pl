...
use Google::Ads::GoogleAds::V25::Enums::IdentityVerificationProgramEnum
  qw (ADVERTISER_IDENTITY_VERIFICATION);
use
  Google::Ads::GoogleAds::V25::Services::IdentityVerificationService::StartIdentityVerificationRequest;
