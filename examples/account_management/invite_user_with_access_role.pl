...
use
  Google::Ads::GoogleAds::V9::Services::CustomerUserAccessInvitationService::CustomerUserAccessInvitationOperation;
...
sub invite_user_with_access_role {
  ...
  my $user_access_invitation =
    Google::Ads::GoogleAds::V9::Resources::CustomerUserAccessInvitation->new({
