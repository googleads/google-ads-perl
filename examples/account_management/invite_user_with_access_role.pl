...
use
  Google::Ads::GoogleAds::V8::Services::CustomerUserAccessInvitationService::CustomerUserAccessInvitationOperation;
...
sub invite_user_with_access_role {
  ...
  my $user_access_invitation =
    Google::Ads::GoogleAds::V8::Resources::CustomerUserAccessInvitation->new({
