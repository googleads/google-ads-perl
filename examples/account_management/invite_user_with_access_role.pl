...
use Google::Ads::GoogleAds::V23::Resources::CustomerUserAccessInvitation;
use
  Google::Ads::GoogleAds::V23::Services::CustomerUserAccessInvitationService::CustomerUserAccessInvitationOperation;
...
sub invite_user_with_access_role {
  ...
  my $user_access_invitation =
    Google::Ads::GoogleAds::V23::Resources::CustomerUserAccessInvitation->new({
