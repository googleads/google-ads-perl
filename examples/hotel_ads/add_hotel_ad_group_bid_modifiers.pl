...
use Google::Ads::GoogleAds::V1::Enums::DayOfWeekEnum qw(MONDAY);
use
  Google::Ads::GoogleAds::V1::Services::AdGroupBidModifierService::AdGroupBidModifierOperation;
...
sub add_hotel_ad_group_bid_modifiers {
  ...
  my $ad_group_bid_modifier_response =
    $client->AdGroupBidModifierService()->mutate({
...
# Call the example.
add_hotel_ad_group_bid_modifiers($client, $customer_id =~ s/-//gr,
  $ad_group_id);
