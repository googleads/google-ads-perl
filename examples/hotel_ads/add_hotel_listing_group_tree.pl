...
use Google::Ads::GoogleAds::V1::Common::HotelClassInfo;
use Google::Ads::GoogleAds::V1::Common::HotelCountryRegionInfo;
...
sub add_hotel_listing_group_tree {
  my ($client, $customer_id, $ad_group_id, $percent_cpc_bid_micro_amount) = @_;
...
sub add_level_1_nodes {
  ...
  my $five_starred_dimension_info =
    Google::Ads::GoogleAds::V1::Common::ListingDimensionInfo->new({
      hotelClass => Google::Ads::GoogleAds::V1::Common::HotelClassInfo->new({
          value => 5
        })});
