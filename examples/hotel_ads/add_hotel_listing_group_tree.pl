...
use Google::Ads::GoogleAds::V9::Common::HotelClassInfo;
use Google::Ads::GoogleAds::V9::Common::HotelCountryRegionInfo;
...
sub add_level_1_nodes {
  ...
  my $five_starred_dimension_info =
    Google::Ads::GoogleAds::V9::Common::ListingDimensionInfo->new({
      hotelClass => Google::Ads::GoogleAds::V9::Common::HotelClassInfo->new({
          value => 5
        })});
...
sub add_level_2_nodes {
  ...
  my $japan_dimension_info =
    Google::Ads::GoogleAds::V9::Common::ListingDimensionInfo->new({
      ...
      hotelCountryRegion =>
        Google::Ads::GoogleAds::V9::Common::HotelCountryRegionInfo->new({
