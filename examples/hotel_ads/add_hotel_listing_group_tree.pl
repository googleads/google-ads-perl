...
use Google::Ads::GoogleAds::V13::Common::HotelClassInfo;
use Google::Ads::GoogleAds::V13::Common::HotelCountryRegionInfo;
...
sub add_level_2_nodes {
  ...
  my $japan_dimension_info =
    Google::Ads::GoogleAds::V13::Common::ListingDimensionInfo->new({
      ...
      hotelCountryRegion =>
        Google::Ads::GoogleAds::V13::Common::HotelCountryRegionInfo->new({
