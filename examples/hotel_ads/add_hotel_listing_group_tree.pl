...
use Google::Ads::GoogleAds::V8::Common::HotelClassInfo;
use Google::Ads::GoogleAds::V8::Common::HotelCountryRegionInfo;
use Google::Ads::GoogleAds::V8::Enums::ListingGroupTypeEnum
  qw(SUBDIVISION UNIT);
...
sub add_level_1_nodes {
  ...
  my $five_starred_dimension_info =
    Google::Ads::GoogleAds::V8::Common::ListingDimensionInfo->new({
      hotelClass => Google::Ads::GoogleAds::V8::Common::HotelClassInfo->new({
          value => 5
        })});
...
sub add_level_2_nodes {
  ...
  my $japan_dimension_info =
    Google::Ads::GoogleAds::V8::Common::ListingDimensionInfo->new({
      ...
      hotelCountryRegion =>
        Google::Ads::GoogleAds::V8::Common::HotelCountryRegionInfo->new({
...
sub create_listing_group_info {
  ...
  my $listing_group_info =
    Google::Ads::GoogleAds::V8::Common::ListingGroupInfo->new({
