...
use Google::Ads::GoogleAds::V12::Resources::HotelSettingInfo;
use Google::Ads::GoogleAds::V12::Resources::NetworkSettings;
...
use Google::Ads::GoogleAds::V12::Common::PercentCpc;
use Google::Ads::GoogleAds::V12::Common::HotelAdInfo;
use Google::Ads::GoogleAds::V12::Enums::BudgetDeliveryMethodEnum   qw(STANDARD);
use Google::Ads::GoogleAds::V12::Enums::AdvertisingChannelTypeEnum qw(HOTEL);
use Google::Ads::GoogleAds::V12::Enums::AdGroupTypeEnum qw(HOTEL_ADS);
...
sub add_hotel_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V12::Resources::Campaign->new({
      ...
      hotelSetting           =>
        Google::Ads::GoogleAds::V12::Resources::HotelSettingInfo->new({
      ...
      percentCpc => Google::Ads::GoogleAds::V12::Common::PercentCpc->new(
      ...
      # hotel campaigns.
      networkSettings =>
        Google::Ads::GoogleAds::V12::Resources::NetworkSettings->new({
...
sub add_hotel_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V12::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V12::Resources::Ad->new({
          hotelAd => Google::Ads::GoogleAds::V12::Common::HotelAdInfo->new()}
      ),
      status => Google::Ads::GoogleAds::V12::Enums::AdGroupAdStatusEnum::ENABLED
    });
