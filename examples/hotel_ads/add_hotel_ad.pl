...
use Google::Ads::GoogleAds::V6::Resources::HotelSettingInfo;
...
use Google::Ads::GoogleAds::V6::Common::HotelAdInfo;
use Google::Ads::GoogleAds::V6::Enums::BudgetDeliveryMethodEnum qw(STANDARD);
use Google::Ads::GoogleAds::V6::Enums::AdvertisingChannelTypeEnum qw(HOTEL);
use Google::Ads::GoogleAds::V6::Enums::AdGroupTypeEnum qw(HOTEL_ADS);
...
sub add_hotel_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V6::Resources::Campaign->new({
      ...
      hotelSetting =>
        Google::Ads::GoogleAds::V6::Resources::HotelSettingInfo->new({
      ...
      percentCpc => Google::Ads::GoogleAds::V6::Common::PercentCpc->new(
