...
use Google::Ads::GoogleAds::V1::Resources::HotelSettingInfo;
use Google::Ads::GoogleAds::V1::Resources::NetworkSettings;
...
use Google::Ads::GoogleAds::V1::Enums::AdvertisingChannelTypeEnum qw(HOTEL);
use Google::Ads::GoogleAds::V1::Enums::AdGroupTypeEnum qw(HOTEL_ADS);
...
sub add_hotel_ad {
  my ($client, $customer_id, $hotel_center_account_id,
  ...
  my $campaign_resource_name =
    add_hotel_campaign($client, $customer_id,
    $budget_resource_name, $hotel_center_account_id,
    $cpc_bid_ceiling_micro_amount);

  # Create a hotel ad group.
  my $ad_group_resource_name =
    add_hotel_ad_group($client, $customer_id, $campaign_resource_name);

  # Create a hotel ad group ad.
  add_hotel_ad_group_ad($client, $customer_id, $ad_group_resource_name);
...
sub add_hotel_campaign {
  my ($client, $customer_id, $budget_resource_name, $hotel_center_account_id,
    $cpc_bid_ceiling_micro_amount)
    = @_;
  ...
  my $campaign = Google::Ads::GoogleAds::V1::Resources::Campaign->new({
      ...
      hotelSetting =>
        Google::Ads::GoogleAds::V1::Resources::HotelSettingInfo->new({
      ...
      percentCpc => Google::Ads::GoogleAds::V1::Common::PercentCpc->new(
      ...
      # hotel campaigns.
      networkSettings =>
        Google::Ads::GoogleAds::V1::Resources::NetworkSettings->new({
...
sub add_hotel_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V1::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V1::Resources::Ad->new({
          hotelAd => Google::Ads::GoogleAds::V1::Common::HotelAdInfo->new()}
      ),
...
# Call the example.
add_hotel_ad($client, $customer_id =~ s/-//gr,
