...
use Google::Ads::GoogleAds::V1::Enums::ListingGroupTypeEnum
  qw(SUBDIVISION UNIT);
use Google::Ads::GoogleAds::V1::Enums::AdGroupCriterionStatusEnum qw(ENABLED);
use Google::Ads::GoogleAds::V1::Enums::ProductConditionEnum qw(NEW USED);
use
...
sub add_shopping_product_listing_group_tree {
  my ($client, $customer_id, $ad_group_id, $replace_existing_tree) = @_;
...
# Call the example.
add_shopping_product_listing_group_tree($client, $customer_id =~ s/-//gr,
