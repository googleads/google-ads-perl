...
use Google::Ads::GoogleAds::V12::Common::ProductConditionInfo;
use Google::Ads::GoogleAds::V12::Common::ProductBrandInfo;
use Google::Ads::GoogleAds::V12::Enums::ListingGroupTypeEnum
  qw(SUBDIVISION UNIT);
use Google::Ads::GoogleAds::V12::Enums::AdGroupCriterionStatusEnum qw(ENABLED);
use Google::Ads::GoogleAds::V12::Enums::ProductConditionEnum       qw(NEW USED);
use
...
sub add_shopping_product_listing_group_tree {
  ...
  my $ad_group_criterion_condition_new = create_listing_group_unit_biddable(
    ...
    Google::Ads::GoogleAds::V12::Common::ListingDimensionInfo->new({
        productCondition =>
          Google::Ads::GoogleAds::V12::Common::ProductConditionInfo->new({
            condition => NEW
          })}
    ),
    200000
  ...
  my $ad_group_criterion_brand_cool_brand = create_listing_group_unit_biddable(
    ...
    Google::Ads::GoogleAds::V12::Common::ListingDimensionInfo->new({
        productBrand =>
          Google::Ads::GoogleAds::V12::Common::ProductBrandInfo->new(
          {value => "CoolBrand"})}
    ),
    900000
  );
