...
use Google::Ads::GoogleAds::V2::Enums::ListingGroupTypeEnum
  qw(SUBDIVISION UNIT);
use Google::Ads::GoogleAds::V2::Enums::AdGroupCriterionStatusEnum qw(ENABLED);
use Google::Ads::GoogleAds::V2::Enums::ProductConditionEnum qw(NEW USED);
use
...
sub add_shopping_product_listing_group_tree {
  ...
  my $ad_group_criterion_condition_new = create_listing_group_unit_biddable(
    ...
    Google::Ads::GoogleAds::V2::Common::ListingDimensionInfo->new({
        productCondition =>
          Google::Ads::GoogleAds::V2::Common::ProductConditionInfo->new({
            condition => NEW
          })}
    ),
    200000
  ...
  my $ad_group_criterion_brand_cool_brand = create_listing_group_unit_biddable(
    ...
    Google::Ads::GoogleAds::V2::Common::ListingDimensionInfo->new({
        listingBrand =>
          Google::Ads::GoogleAds::V2::Common::ListingBrandInfo->new(
          {value => "CoolBrand"})}
    ),
    900000
  );
...
sub create_listing_group_subdivision {
  ...
  my $listing_group_info =
    Google::Ads::GoogleAds::V2::Common::ListingGroupInfo->new({
