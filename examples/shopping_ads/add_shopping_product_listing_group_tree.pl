...
use Google::Ads::GoogleAds::V19::Common::ListingGroupInfo;
use Google::Ads::GoogleAds::V19::Common::ListingDimensionInfo;
use Google::Ads::GoogleAds::V19::Common::ProductConditionInfo;
use Google::Ads::GoogleAds::V19::Common::ProductBrandInfo;
use Google::Ads::GoogleAds::V19::Enums::ListingGroupTypeEnum
  qw(SUBDIVISION UNIT);
use Google::Ads::GoogleAds::V19::Enums::AdGroupCriterionStatusEnum qw(ENABLED);
use Google::Ads::GoogleAds::V19::Enums::ProductConditionEnum       qw(NEW USED);
use
...
sub add_shopping_product_listing_group_tree {
  ...
  my $ad_group_criterion_condition_new = create_listing_group_unit_biddable(
    ...
    Google::Ads::GoogleAds::V19::Common::ListingDimensionInfo->new({
        productCondition =>
          Google::Ads::GoogleAds::V19::Common::ProductConditionInfo->new({
            condition => NEW
          })}
    ),
    200000
...
sub create_listing_group_subdivision {
  ...
  my $listing_group_info =
    Google::Ads::GoogleAds::V19::Common::ListingGroupInfo->new({
