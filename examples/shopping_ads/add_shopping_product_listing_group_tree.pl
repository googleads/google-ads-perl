...
use Google::Ads::GoogleAds::V24::Common::ProductConditionInfo;
use Google::Ads::GoogleAds::V24::Common::ProductBrandInfo;
use Google::Ads::GoogleAds::V24::Enums::ListingGroupTypeEnum
  qw(SUBDIVISION UNIT);
use Google::Ads::GoogleAds::V24::Enums::AdGroupCriterionStatusEnum qw(ENABLED);
use Google::Ads::GoogleAds::V24::Enums::ProductConditionEnum       qw(NEW USED);
use
...
sub add_shopping_product_listing_group_tree {
  ...
  my $ad_group_criterion_condition_new = create_listing_group_unit_biddable(
    ...
    Google::Ads::GoogleAds::V24::Common::ListingDimensionInfo->new({
        productCondition =>
          Google::Ads::GoogleAds::V24::Common::ProductConditionInfo->new({
            condition => NEW
          })}
    ),
    200000
