...
use Google::Ads::GoogleAds::V10::Common::ShoppingSmartAdInfo;
...
use Google::Ads::GoogleAds::V10::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V10::Enums::AdvertisingChannelSubTypeEnum
  qw(SHOPPING_SMART_ADS);
use Google::Ads::GoogleAds::V10::Enums::AdGroupTypeEnum;
...
use Google::Ads::GoogleAds::V10::Enums::ListingGroupTypeEnum qw(UNIT);
...
sub add_smart_shopping_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V10::Resources::AdGroup->new({
    ...
    # other types
    type =>
      Google::Ads::GoogleAds::V10::Enums::AdGroupTypeEnum::SHOPPING_SMART_ADS,
...
sub add_smart_shopping_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V10::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V10::Resources::Ad->new({
          shoppingSmartAd =>
            Google::Ads::GoogleAds::V10::Common::ShoppingSmartAdInfo->new()}
      ),
