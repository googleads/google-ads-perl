...
sub add_smart_shopping_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V4::Resources::Campaign->new({
      ...
      maximizeConversionValue =>
        Google::Ads::GoogleAds::V4::Common::MaximizeConversionValue->new(
        {targetRoas => 3.5}
        ),
      # Set the budget.
...
sub add_smart_shopping_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V4::Resources::AdGroup->new({
    ...
    # other types
    type =>
      Google::Ads::GoogleAds::V4::Enums::AdGroupTypeEnum::SHOPPING_SMART_ADS,
...
sub add_smart_shopping_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V4::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V4::Resources::Ad->new({
          shoppingSmartAd =>
            Google::Ads::GoogleAds::V4::Common::ShoppingSmartAdInfo->new()}
      ),
