...
use Google::Ads::GoogleAds::V11::Common::ShoppingSmartAdInfo;
use Google::Ads::GoogleAds::V11::Common::ListingGroupInfo;
use Google::Ads::GoogleAds::V11::Enums::BudgetDeliveryMethodEnum qw(STANDARD);
use Google::Ads::GoogleAds::V11::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V11::Enums::AdvertisingChannelSubTypeEnum
  qw(SHOPPING_SMART_ADS);
use Google::Ads::GoogleAds::V11::Enums::AdGroupTypeEnum;
...
use Google::Ads::GoogleAds::V11::Enums::ListingGroupTypeEnum qw(UNIT);
...
sub add_smart_shopping_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V11::Resources::AdGroup->new({
    ...
    # other types
    type =>
      Google::Ads::GoogleAds::V11::Enums::AdGroupTypeEnum::SHOPPING_SMART_ADS,
...
sub add_smart_shopping_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V11::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V11::Resources::Ad->new({
          shoppingSmartAd =>
            Google::Ads::GoogleAds::V11::Common::ShoppingSmartAdInfo->new()}
      ),
...
sub add_shopping_listing_group {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V11::Resources::AdGroupCriterion->new({
      ...
      listingGroup =>
        Google::Ads::GoogleAds::V11::Common::ListingGroupInfo->new({
          type => UNIT
        }
        ),
      status =>
