...
use Google::Ads::GoogleAds::V1::Resources::ShoppingSetting;
...
use Google::Ads::GoogleAds::V1::Common::MaximizeConversionValue;
use Google::Ads::GoogleAds::V1::Common::ShoppingSmartAdInfo;
use Google::Ads::GoogleAds::V1::Common::ListingGroupInfo;
use Google::Ads::GoogleAds::V1::Enums::BudgetDeliveryMethodEnum qw(STANDARD);
use Google::Ads::GoogleAds::V1::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V1::Enums::AdvertisingChannelSubTypeEnum
  qw(SHOPPING_SMART_ADS);
use Google::Ads::GoogleAds::V1::Enums::AdGroupTypeEnum;
use Google::Ads::GoogleAds::V1::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V1::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V1::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V1::Enums::ListingGroupTypeEnum qw(UNIT);
use Google::Ads::GoogleAds::V1::Enums::AdGroupCriterionStatusEnum;
use
  Google::Ads::GoogleAds::V1::Services::CampaignBudgetService::CampaignBudgetOperation;
use Google::Ads::GoogleAds::V1::Services::CampaignService::CampaignOperation;
use Google::Ads::GoogleAds::V1::Services::AdGroupService::AdGroupOperation;
use Google::Ads::GoogleAds::V1::Services::AdGroupAdService::AdGroupAdOperation;
use
...
sub add_shopping_smart_ad {
  my ($client, $customer_id, $merchant_center_id, $create_default_listing_group)
    = @_;

  # Create a budget to be used by the campaign that will be created below.
  my $budget_resource_name = add_campaign_budget($client, $customer_id);

  # Create a smart shopping campaign.
  my $campaign_resource_name =
    add_smart_shopping_campaign($client, $customer_id,
    $budget_resource_name, $merchant_center_id);

  # Create a smart shopping ad group.
  my $ad_group_resource_name =
    add_smart_shopping_ad_group($client, $customer_id, $campaign_resource_name);

  # Creates a smart shopping ad group ad.
  add_smart_shopping_ad_group_ad($client, $customer_id,
...
sub add_campaign_budget {
  ...
  # Add the budget.
  my $campaign_budget_resource_name = $client->CampaignBudgetService()->mutate({
...
sub add_smart_shopping_campaign {
  my ($client, $customer_id, $budget_resource_name, $merchant_center_id) = @_;

  # Create a smart shopping campaign.
  my $campaign = Google::Ads::GoogleAds::V1::Resources::Campaign->new({
      ...
      shoppingSetting =>
        Google::Ads::GoogleAds::V1::Resources::ShoppingSetting->new({
      ...
      status => Google::Ads::GoogleAds::V1::Enums::CampaignStatusEnum::PAUSED,
  ...
  my $campaign_operation =
    Google::Ads::GoogleAds::V1::Services::CampaignService::CampaignOperation->
    new({create => $campaign});

  # Add the campaign.
  my $campaign_resource_name = $client->CampaignService()->mutate({
      customerId => $customer_id,
...
sub add_smart_shopping_ad_group {
  my ($client, $customer_id, $campaign_resource_name) = @_;

  # Create an ad group.
  my $ad_group = Google::Ads::GoogleAds::V1::Resources::AdGroup->new({
    name     => "Earth to Mars Cruises #" . uniqid(),
    campaign => $campaign_resource_name,
    # Set the ad group type to SHOPPING_SMART_ADS. This cannot be set to
    # other types
    type =>
      Google::Ads::GoogleAds::V1::Enums::AdGroupTypeEnum::SHOPPING_SMART_ADS,
    status => Google::Ads::GoogleAds::V1::Enums::AdGroupStatusEnum::ENABLED
  });

  # Create an ad group operation.
  my $ad_group_operation =
    Google::Ads::GoogleAds::V1::Services::AdGroupService::AdGroupOperation->
    new({create => $ad_group});

  # Add the ad group.
  my $ad_group_resource_name = $client->AdGroupService()->mutate({
      customerId => $customer_id,
...
sub add_smart_shopping_ad_group_ad {
  my ($client, $customer_id, $ad_group_resource_name) = @_;

  # Create an ad group ad and set a shopping smart ad to it.
  my $ad_group_ad = Google::Ads::GoogleAds::V1::Resources::AdGroupAd->new({
      # Set the ad group.
      ...
      status => Google::Ads::GoogleAds::V1::Enums::AdGroupAdStatusEnum::PAUSED
    });

  # Create an ad group ad operation.
  my $ad_group_ad_operation =
    Google::Ads::GoogleAds::V1::Services::AdGroupAdService::AdGroupAdOperation
    ->new({create => $ad_group_ad});

  # Add the ad group ad.
  my $ad_group_ad_resource_name = $client->AdGroupAdService()->mutate({
      customerId => $customer_id,
...
sub add_shopping_listing_group {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V1::Resources::AdGroupCriterion->new({
      ...
      listingGroup => Google::Ads::GoogleAds::V1::Common::ListingGroupInfo->new(
        {
          type => UNIT
        }
      ),
      status =>
        Google::Ads::GoogleAds::V1::Enums::AdGroupCriterionStatusEnum::ENABLED
    });
  ...
  my $ad_group_criterion_resource_name =
    $client->AdGroupCriterionService()->mutate({
      customerId => $customer_id,
...
# Call the example.
add_shopping_smart_ad($client, $customer_id =~ s/-//gr,
