...
use Google::Ads::GoogleAds::V9::Common::ListingDimensionInfo;
use Google::Ads::GoogleAds::V9::Common::ProductBrandInfo;
use Google::Ads::GoogleAds::V9::Common::ProductCustomAttributeInfo;
use Google::Ads::GoogleAds::V9::Common::ProductTypeInfo;
use Google::Ads::GoogleAds::V9::Common::ListingScopeInfo;
use Google::Ads::GoogleAds::V9::Enums::ProductCustomAttributeIndexEnum
  qw(INDEX0);
use Google::Ads::GoogleAds::V9::Enums::ProductTypeLevelEnum qw(LEVEL1 LEVEL2);
use
...
sub add_listing_scope {
  ...
  push @$dimensions,
    Google::Ads::GoogleAds::V9::Common::ListingDimensionInfo->new({
      productBrand => Google::Ads::GoogleAds::V9::Common::ProductBrandInfo->new(
        {
          value => "google"
        })});
  ...
  push @$dimensions,
    Google::Ads::GoogleAds::V9::Common::ListingDimensionInfo->new({
      productCustomAttribute =>
        Google::Ads::GoogleAds::V9::Common::ProductCustomAttributeInfo->new({
          index => INDEX0,
  ...
  push @$dimensions,
    Google::Ads::GoogleAds::V9::Common::ListingDimensionInfo->new({
      productType => Google::Ads::GoogleAds::V9::Common::ProductTypeInfo->new({
          level => LEVEL1,
          value => "electronics"
        })});
  ...
  $campaign_criterion->{listingScope} =
    Google::Ads::GoogleAds::V9::Common::ListingScopeInfo->new({
