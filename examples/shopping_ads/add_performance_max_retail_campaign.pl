...
use Google::Ads::GoogleAds::V19::Resources::ShoppingSetting;
...
use Google::Ads::GoogleAds::V19::Resources::CampaignConversionGoal;
use Google::Ads::GoogleAds::V19::Resources::AssetGroupListingGroupFilter;
...
use Google::Ads::GoogleAds::V19::Enums::AdvertisingChannelTypeEnum
  qw(PERFORMANCE_MAX);
use Google::Ads::GoogleAds::V19::Enums::AssetGroupStatusEnum;
use Google::Ads::GoogleAds::V19::Enums::AssetFieldTypeEnum
  qw(HEADLINE DESCRIPTION LONG_HEADLINE BUSINESS_NAME LOGO MARKETING_IMAGE SQUARE_MARKETING_IMAGE);
use Google::Ads::GoogleAds::V19::Enums::ConversionActionCategoryEnum
  qw(PURCHASE);
use Google::Ads::GoogleAds::V19::Enums::ConversionOriginEnum qw(WEBSITE);
use Google::Ads::GoogleAds::V19::Enums::ListingGroupFilterTypeEnum
  qw(UNIT_INCLUDED);
use Google::Ads::GoogleAds::V19::Enums::ListingGroupFilterListingSourceEnum
  qw(SHOPPING);
...
use
  Google::Ads::GoogleAds::V19::Services::AssetGroupListingGroupFilterService::AssetGroupListingGroupFilterOperation;
use
  ...
  return
    ...
    new({
      campaignBudgetOperation =>
        Google::Ads::GoogleAds::V19::Services::CampaignBudgetService::CampaignBudgetOperation
        ->new({
          create => Google::Ads::GoogleAds::V19::Resources::CampaignBudget->new(
            {
      ...
      campaignOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V19::Resources::Campaign->new({
              ...
              # maximizeConversions =>
              #   Google::Ads::GoogleAds::V19::Common::MaximizeConversions->
              #   new({
              ...
              shoppingSetting =>
                Google::Ads::GoogleAds::V19::Resources::ShoppingSetting->new({
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V19::Resources::CampaignCriterion->new({
              ...
              language =>
                Google::Ads::GoogleAds::V19::Common::LanguageInfo->new({
                  languageConstant =>
                    Google::Ads::GoogleAds::V19::Utils::ResourceNames::language_constant(
                    1000)    # English
                })})})});
...
sub create_listing_group_filter_operation {
  ...
  my $listing_group_filter =
    Google::Ads::GoogleAds::V19::Resources::AssetGroupListingGroupFilter->new({
      assetGroup =>
        Google::Ads::GoogleAds::V19::Utils::ResourceNames::asset_group(
        $customer_id, ASSET_GROUP_TEMPORARY_ID
        ),
    ...
    new({
      assetOperation =>
        ...
        new({
          create => Google::Ads::GoogleAds::V19::Resources::Asset->new({
              resourceName =>
                Google::Ads::GoogleAds::V19::Utils::ResourceNames::asset(
                $customer_id, $next_temp_id
                ),
              textAsset => Google::Ads::GoogleAds::V19::Common::TextAsset->new({
                  text => $text
                })})})});
    ...
    new({
      assetGroupAssetOperation =>
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V19::Resources::AssetGroupAsset->new({
              asset => Google::Ads::GoogleAds::V19::Utils::ResourceNames::asset(
                $customer_id, $next_temp_id
              ),
              assetGroup =>
                Google::Ads::GoogleAds::V19::Utils::ResourceNames::asset_group(
      ...
      assetOperation =>
        ...
        new({
          create => Google::Ads::GoogleAds::V19::Resources::Asset->new({
              ...
              name       => $asset_name,
              imageAsset =>
                Google::Ads::GoogleAds::V19::Common::ImageAsset->new({
