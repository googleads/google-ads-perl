...
use Google::Ads::GoogleAds::V22::Resources::ShoppingSetting;
...
use Google::Ads::GoogleAds::V22::Enums::ConversionActionCategoryEnum
  qw(PURCHASE);
use Google::Ads::GoogleAds::V22::Enums::ConversionOriginEnum qw(WEBSITE);
      ...
      campaignOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V22::Resources::Campaign->new({
              ...
              # maximizeConversions =>
              #   Google::Ads::GoogleAds::V22::Common::MaximizeConversions->
              #   new({
