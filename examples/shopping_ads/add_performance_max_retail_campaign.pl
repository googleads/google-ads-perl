...
use Google::Ads::GoogleAds::V24::Resources::ShoppingSetting;
...
use Google::Ads::GoogleAds::V24::Resources::AssetAutomationSetting;
use Google::Ads::GoogleAds::V24::Resources::AssetGroup;
use Google::Ads::GoogleAds::V24::Resources::AssetGroupAsset;
use Google::Ads::GoogleAds::V24::Resources::CampaignConversionGoal;
use Google::Ads::GoogleAds::V24::Resources::AssetGroupListingGroupFilter;
...
use Google::Ads::GoogleAds::V24::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V24::Enums::AdvertisingChannelTypeEnum
  qw(PERFORMANCE_MAX);
use Google::Ads::GoogleAds::V24::Enums::AssetAutomationStatusEnum qw(OPTED_IN);
use Google::Ads::GoogleAds::V24::Enums::AssetAutomationTypeEnum
...
use Google::Ads::GoogleAds::V24::Enums::AssetGroupStatusEnum;
use Google::Ads::GoogleAds::V24::Enums::AssetFieldTypeEnum
  qw(HEADLINE DESCRIPTION LONG_HEADLINE BUSINESS_NAME LOGO MARKETING_IMAGE SQUARE_MARKETING_IMAGE);
use Google::Ads::GoogleAds::V24::Enums::ConversionActionCategoryEnum
  qw(PURCHASE);
use Google::Ads::GoogleAds::V24::Enums::ConversionOriginEnum qw(WEBSITE);
use Google::Ads::GoogleAds::V24::Enums::ListingGroupFilterTypeEnum
  qw(UNIT_INCLUDED);
use Google::Ads::GoogleAds::V24::Enums::ListingGroupFilterListingSourceEnum
  qw(SHOPPING);
...
use Google::Ads::GoogleAds::V24::Services::AssetService::AssetOperation;
use
...
use
  Google::Ads::GoogleAds::V24::Services::AssetGroupListingGroupFilterService::AssetGroupListingGroupFilterOperation;
use
  Google::Ads::GoogleAds::V24::Services::CampaignAssetService::CampaignAssetOperation;
  ...
  return
    ...
    new({
      campaignBudgetOperation =>
        Google::Ads::GoogleAds::V24::Services::CampaignBudgetService::CampaignBudgetOperation
        ->new({
          create => Google::Ads::GoogleAds::V24::Resources::CampaignBudget->new(
            {
      ...
      campaignOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V24::Resources::Campaign->new({
              ...
              status =>
                Google::Ads::GoogleAds::V24::Enums::CampaignStatusEnum::PAUSED,
              ...
              maximizeConversionValue =>
                Google::Ads::GoogleAds::V24::Common::MaximizeConversionValue->
                new({
                  targetRoas => 3.5
                }
                ),
              ...
              # maximizeConversions =>
              #   Google::Ads::GoogleAds::V24::Common::MaximizeConversions->
              #   new({
...
sub create_listing_group_filter_operation {
  ...
  my $listing_group_filter =
    Google::Ads::GoogleAds::V24::Resources::AssetGroupListingGroupFilter->new({
      assetGroup =>
        Google::Ads::GoogleAds::V24::Utils::ResourceNames::asset_group(
        $customer_id, ASSET_GROUP_TEMPORARY_ID
        ),
    ...
    new({
      assetOperation =>
        ...
        new({
          create => Google::Ads::GoogleAds::V24::Resources::Asset->new({
              resourceName =>
                Google::Ads::GoogleAds::V24::Utils::ResourceNames::asset(
                $customer_id, $next_temp_id
                ),
              textAsset => Google::Ads::GoogleAds::V24::Common::TextAsset->new({
                  text => $text
                })})})});
    ...
    new({
      assetGroupAssetOperation =>
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V24::Resources::AssetGroupAsset->new({
              asset => Google::Ads::GoogleAds::V24::Utils::ResourceNames::asset(
                $customer_id, $next_temp_id
              ),
              assetGroup =>
                Google::Ads::GoogleAds::V24::Utils::ResourceNames::asset_group(
      ...
      assetOperation =>
        ...
        new({
          create => Google::Ads::GoogleAds::V24::Resources::Asset->new({
              ...
              name       => $asset_name,
              imageAsset =>
                Google::Ads::GoogleAds::V24::Common::ImageAsset->new({
    ...
    push @$operations,
      ...
      ->new({
        campaignAssetOperation =>
          ...
          ->new({
            create =>
              Google::Ads::GoogleAds::V24::Resources::CampaignAsset->new({
