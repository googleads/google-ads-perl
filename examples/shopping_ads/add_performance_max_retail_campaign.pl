...
use Google::Ads::GoogleAds::V13::Resources::ShoppingSetting;
...
use Google::Ads::GoogleAds::V13::Enums::ConversionActionCategoryEnum
  qw(PURCHASE);
use Google::Ads::GoogleAds::V13::Enums::ConversionOriginEnum qw(WEBSITE);
use Google::Ads::GoogleAds::V13::Enums::ListingGroupFilterTypeEnum
  qw(UNIT_INCLUDED);
use Google::Ads::GoogleAds::V13::Enums::ListingGroupFilterVerticalEnum
  qw(SHOPPING);
...
use
  Google::Ads::GoogleAds::V13::Services::CampaignConversionGoalService::CampaignConversionGoalOperation;
use
  Google::Ads::GoogleAds::V13::Services::AssetGroupListingGroupFilterService::AssetGroupListingGroupFilterOperation;
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V13::Resources::CampaignCriterion->new({
              ...
              language =>
                Google::Ads::GoogleAds::V13::Common::LanguageInfo->new({
                  languageConstant =>
...
sub create_listing_group_filter_operation {
  ...
  my $listing_group_filter =
    Google::Ads::GoogleAds::V13::Resources::AssetGroupListingGroupFilter->new({
      assetGroup =>
        Google::Ads::GoogleAds::V13::Utils::ResourceNames::asset_group(
        $customer_id, ASSET_GROUP_TEMPORARY_ID
        ),
...
sub create_conversion_goal_operations {
  ...
  foreach my $customer_conversion_goal (@$customer_conversion_goals) {
    my $campaign_conversion_goal =
      Google::Ads::GoogleAds::V13::Resources::CampaignConversionGoal->new({
        resourceName =>
          Google::Ads::GoogleAds::V13::Utils::ResourceNames::campaign_conversion_goal(
          $customer_id,
