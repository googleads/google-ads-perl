...
use Google::Ads::GoogleAds::V11::Resources::ListingGroupFilterDimension;
use Google::Ads::GoogleAds::V11::Resources::ProductCondition;
use Google::Ads::GoogleAds::V11::Resources::ProductBrand;
...
use Google::Ads::GoogleAds::V11::Enums::ListingGroupFilterVerticalEnum
  qw(SHOPPING);
use Google::Ads::GoogleAds::V11::Enums::ListingGroupFilterProductConditionEnum
  qw(NEW USED);
...
sub add_performance_max_product_listing_group_tree {
  ...
  push @$mutate_operations,
    ...
    $temp_id--,
    LISTING_GROUP_ROOT_TEMPORARY_ID,
    Google::Ads::GoogleAds::V11::Resources::ListingGroupFilterDimension->new({
        productCondition =>
          Google::Ads::GoogleAds::V11::Resources::ProductCondition->new({
            condition => NEW
          })}));
  ...
  push @$mutate_operations,
    ...
    Google::Ads::GoogleAds::V11::Resources::ListingGroupFilterDimension->new({
        productBrand =>
          Google::Ads::GoogleAds::V11::Resources::ProductBrand->new({
            value => "CoolBrand"
          })}));
...
sub create_mutate_operation_for_root {
  ...
  my $asset_group_listing_group_filter =
    Google::Ads::GoogleAds::V11::Resources::AssetGroupListingGroupFilter->new({
      resourceName =>
        Google::Ads::GoogleAds::V11::Utils::ResourceNames::asset_group_listing_group_filter(
