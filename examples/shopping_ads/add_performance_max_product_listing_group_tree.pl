...
use Google::Ads::GoogleAds::V22::Resources::ListingGroupFilterDimension;
use Google::Ads::GoogleAds::V22::Resources::ProductCondition;
use Google::Ads::GoogleAds::V22::Resources::ProductBrand;
use Google::Ads::GoogleAds::V22::Enums::ListingGroupFilterTypeEnum
  qw(SUBDIVISION UNIT_INCLUDED);
use Google::Ads::GoogleAds::V22::Enums::ListingGroupFilterListingSourceEnum
  qw(SHOPPING);
use Google::Ads::GoogleAds::V22::Enums::ListingGroupFilterProductConditionEnum
  qw(NEW USED);
use Google::Ads::GoogleAds::V22::Services::GoogleAdsService::MutateOperation;
use
  Google::Ads::GoogleAds::V22::Services::AssetGroupListingGroupFilterService::AssetGroupListingGroupFilterOperation;
...
sub add_performance_max_product_listing_group_tree {
  ...
  push @$mutate_operations,
    ...
    $temp_id--,
    LISTING_GROUP_ROOT_TEMPORARY_ID,
    Google::Ads::GoogleAds::V22::Resources::ListingGroupFilterDimension->new({
        productCondition =>
          Google::Ads::GoogleAds::V22::Resources::ProductCondition->new({
            condition => NEW
          })}));
  ...
  push @$mutate_operations,
    ...
    Google::Ads::GoogleAds::V22::Resources::ListingGroupFilterDimension->new({
        productBrand =>
          Google::Ads::GoogleAds::V22::Resources::ProductBrand->new({
            value => "CoolBrand"
          })}));
...
sub create_mutate_operation_for_root {
  ...
  my $asset_group_listing_group_filter =
    Google::Ads::GoogleAds::V22::Resources::AssetGroupListingGroupFilter->new({
      resourceName =>
        Google::Ads::GoogleAds::V22::Utils::ResourceNames::asset_group_listing_group_filter(
