...
use Google::Ads::GoogleAds::V1::Common::ShoppingProductAdInfo;
...
use Google::Ads::GoogleAds::V1::Enums::AdGroupTypeEnum qw(SHOPPING_PRODUCT_ADS);
...
sub add_standard_shopping_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V1::Resources::Campaign->new({
      ...
      manualCpc => Google::Ads::GoogleAds::V1::Common::ManualCpc->new(
...
# Call the example.
add_shopping_product_ad($client, $customer_id =~ s/-//gr,
