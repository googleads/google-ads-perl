...
use Google::Ads::GoogleAds::V13::Common::ShoppingProductAdInfo;
use Google::Ads::GoogleAds::V13::Common::ListingGroupInfo;
use Google::Ads::GoogleAds::V13::Enums::BudgetDeliveryMethodEnum   qw(STANDARD);
use Google::Ads::GoogleAds::V13::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V13::Enums::AdGroupTypeEnum
...
use Google::Ads::GoogleAds::V13::Enums::ListingGroupTypeEnum qw(UNIT);
...
sub add_shopping_product_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V13::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V13::Resources::Ad->new({
          shoppingProductAd =>
            Google::Ads::GoogleAds::V13::Common::ShoppingProductAdInfo->new()}
      ),
...
sub add_default_shopping_listing_group {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V13::Resources::AdGroupCriterion->new({
      ...
      listingGroup =>
        Google::Ads::GoogleAds::V13::Common::ListingGroupInfo->new({
          type => UNIT
        }
        ),
      ...
      cpcBidMicros => 500000,
      status       =>
        Google::Ads::GoogleAds::V13::Enums::AdGroupCriterionStatusEnum::ENABLED
    });
