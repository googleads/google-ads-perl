...
use Google::Ads::GoogleAds::V7::Common::ShoppingProductAdInfo;
...
use Google::Ads::GoogleAds::V7::Enums::AdGroupTypeEnum qw(SHOPPING_PRODUCT_ADS);
...
sub add_shopping_product_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V7::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V7::Resources::Ad->new({
          shoppingProductAd =>
            Google::Ads::GoogleAds::V7::Common::ShoppingProductAdInfo->new()}
      ),
