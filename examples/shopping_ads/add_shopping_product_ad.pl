...
use Google::Ads::GoogleAds::V9::Common::ShoppingProductAdInfo;
...
use Google::Ads::GoogleAds::V9::Enums::AdGroupTypeEnum qw(SHOPPING_PRODUCT_ADS);
...
sub add_shopping_product_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V9::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V9::Resources::Ad->new({
          shoppingProductAd =>
            Google::Ads::GoogleAds::V9::Common::ShoppingProductAdInfo->new()}
      ),
