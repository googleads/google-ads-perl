...
use Google::Ads::GoogleAds::V25::Common::ShoppingProductAdInfo;
...
use Google::Ads::GoogleAds::V25::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V25::Enums::AdGroupTypeEnum
...
use Google::Ads::GoogleAds::V25::Enums::ListingGroupTypeEnum qw(UNIT);
