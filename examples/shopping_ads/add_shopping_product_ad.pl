...
use Google::Ads::GoogleAds::V6::Common::ShoppingProductAdInfo;
...
use Google::Ads::GoogleAds::V6::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V6::Enums::AdGroupTypeEnum qw(SHOPPING_PRODUCT_ADS);
...
use Google::Ads::GoogleAds::V6::Enums::ListingGroupTypeEnum qw(UNIT);
...
sub add_shopping_product_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V6::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V6::Resources::Ad->new({
          shoppingProductAd =>
            Google::Ads::GoogleAds::V6::Common::ShoppingProductAdInfo->new()}
      ),
...
sub add_default_shopping_listing_group {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V6::Resources::AdGroupCriterion->new({
      ...
      listingGroup => Google::Ads::GoogleAds::V6::Common::ListingGroupInfo->new(
        {
          type => UNIT
        }
      ),
