...
use Google::Ads::GoogleAds::V15::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V15::Enums::AdGroupTypeEnum
...
use Google::Ads::GoogleAds::V15::Enums::ListingGroupTypeEnum qw(UNIT);
...
sub add_shopping_product_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V15::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V15::Resources::Ad->new({
          shoppingProductAd =>
            Google::Ads::GoogleAds::V15::Common::ShoppingProductAdInfo->new()}
      ),
...
sub add_default_shopping_listing_group {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V15::Resources::AdGroupCriterion->new({
      ...
      listingGroup =>
        Google::Ads::GoogleAds::V15::Common::ListingGroupInfo->new({
          type => UNIT
        }
        ),
