...
use Google::Ads::GoogleAds::V19::Common::ShoppingProductAdInfo;
...
use Google::Ads::GoogleAds::V19::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V19::Enums::AdGroupTypeEnum
...
use Google::Ads::GoogleAds::V19::Enums::ListingGroupTypeEnum qw(UNIT);
...
sub add_shopping_product_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V19::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V19::Resources::Ad->new({
          shoppingProductAd =>
            Google::Ads::GoogleAds::V19::Common::ShoppingProductAdInfo->new()}
      ),
