...
use Google::Ads::GoogleAds::V22::Enums::AdvertisingChannelTypeEnum qw(SHOPPING);
use Google::Ads::GoogleAds::V22::Enums::AdGroupTypeEnum
...
use Google::Ads::GoogleAds::V22::Enums::ListingGroupTypeEnum qw(UNIT);
...
sub add_shopping_product_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V22::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V22::Resources::Ad->new({
          shoppingProductAd =>
            Google::Ads::GoogleAds::V22::Common::ShoppingProductAdInfo->new()}
      ),
