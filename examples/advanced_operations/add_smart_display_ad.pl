...
sub create_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V10::Resources::AdGroup->new({
    ...
    status   => Google::Ads::GoogleAds::V10::Enums::AdGroupStatusEnum::PAUSED
  });
...
sub create_responsive_display_ad {
  ...
  my $marketing_image_asset_resource_name =
    ...
    ? Google::Ads::GoogleAds::V10::Utils::ResourceNames::asset($customer_id,
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V10::Resources::AdGroupAd->new({
      ...
      status => Google::Ads::GoogleAds::V10::Enums::AdGroupAdStatusEnum::PAUSED,
