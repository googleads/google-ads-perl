...
sub create_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V9::Resources::AdGroup->new({
    ...
    status   => Google::Ads::GoogleAds::V9::Enums::AdGroupStatusEnum::PAUSED
  });

  # Create an ad group operation.
  my $ad_group_operation =
    Google::Ads::GoogleAds::V9::Services::AdGroupService::AdGroupOperation->new(
    {
      create => $ad_group
    });
...
sub create_responsive_display_ad {
  ...
  my $marketing_image_asset_resource_name =
    ...
    ? Google::Ads::GoogleAds::V9::Utils::ResourceNames::asset($customer_id,
