...
use Google::Ads::GoogleAds::V24::Resources::TextGuidelines;
use Google::Ads::GoogleAds::V24::Resources::MessagingRestriction;
...
use Google::Ads::GoogleAds::V24::Enums::MessagingRestrictionTypeEnum
...
sub create_performance_max_campaign_operation {
  ...
  my $text_guidelines =
    Google::Ads::GoogleAds::V24::Resources::TextGuidelines->new({
      termExclusions        => ["cheap", "free"],
      messagingRestrictions => [
        Google::Ads::GoogleAds::V24::Resources::MessagingRestriction->new({
