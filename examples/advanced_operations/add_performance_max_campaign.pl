...
use Google::Ads::GoogleAds::V14::Resources::AssetGroupSignal;
...
use Google::Ads::GoogleAds::V14::Common::AudienceInfo;
...
use
  Google::Ads::GoogleAds::V14::Services::AssetGroupSignalService::AssetGroupSignalOperation;
    ...
    new({
      assetGroupSignalOperation =>
        ...
        ->new({
          ...
          create =>
            Google::Ads::GoogleAds::V14::Resources::AssetGroupSignal->new({
              assetGroup =>
                Google::Ads::GoogleAds::V14::Utils::ResourceNames::asset_group(
                $customer_id, ASSET_GROUP_TEMPORARY_ID
                ),
              audience =>
                Google::Ads::GoogleAds::V14::Common::AudienceInfo->new({
                  audience =>
                    Google::Ads::GoogleAds::V14::Utils::ResourceNames::audience(
