...
use Google::Ads::GoogleAds::V11::Resources::AssetGroupSignal;
...
use Google::Ads::GoogleAds::V11::Common::AudienceInfo;
...
use
  Google::Ads::GoogleAds::V11::Services::AssetGroupSignalService::AssetGroupSignalOperation;
    ...
    new({
      assetGroupSignalOperation =>
        ...
        ->new({
          ...
          create =>
            Google::Ads::GoogleAds::V11::Resources::AssetGroupSignal->new({
              assetGroup =>
                Google::Ads::GoogleAds::V11::Utils::ResourceNames::asset_group(
                $customer_id, ASSET_GROUP_TEMPORARY_ID
                ),
              audience =>
                Google::Ads::GoogleAds::V11::Common::AudienceInfo->new({
                  audience =>
                    Google::Ads::GoogleAds::V11::Utils::ResourceNames::audience(
