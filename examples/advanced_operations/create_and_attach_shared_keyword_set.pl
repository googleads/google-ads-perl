...
use Google::Ads::GoogleAds::V20::Enums::SharedSetTypeEnum qw(NEGATIVE_KEYWORDS);
use Google::Ads::GoogleAds::V20::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V20::Services::SharedSetService::SharedSetOperation;
use
  Google::Ads::GoogleAds::V20::Services::SharedCriterionService::SharedCriterionOperation;
use
  Google::Ads::GoogleAds::V20::Services::CampaignSharedSetService::CampaignSharedSetOperation;
...
sub create_and_attach_shared_keyword_set {
  ...
  my $shared_set = Google::Ads::GoogleAds::V20::Resources::SharedSet->new({
    name => "API Negative keyword list - " . uniqid(),
    type => NEGATIVE_KEYWORDS
  });

  my $shared_set_operation =
    Google::Ads::GoogleAds::V20::Services::SharedSetService::SharedSetOperation
    ->new({
      create => $shared_set
    });
  ...
  foreach my $keyword (@$keywords) {
    my $shared_criterion =
      Google::Ads::GoogleAds::V20::Resources::SharedCriterion->new({
  ...
  my $campaign_shared_set =
    Google::Ads::GoogleAds::V20::Resources::CampaignSharedSet->new({
