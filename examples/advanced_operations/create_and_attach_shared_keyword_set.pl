...
use Google::Ads::GoogleAds::V11::Resources::SharedSet;
use Google::Ads::GoogleAds::V11::Resources::SharedCriterion;
use Google::Ads::GoogleAds::V11::Resources::CampaignSharedSet;
use Google::Ads::GoogleAds::V11::Common::KeywordInfo;
use Google::Ads::GoogleAds::V11::Enums::SharedSetTypeEnum qw(NEGATIVE_KEYWORDS);
use Google::Ads::GoogleAds::V11::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V11::Services::SharedSetService::SharedSetOperation;
use
...
sub create_and_attach_shared_keyword_set {
  ...
  my $shared_set = Google::Ads::GoogleAds::V11::Resources::SharedSet->new({
