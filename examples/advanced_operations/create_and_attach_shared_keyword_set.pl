...
use Google::Ads::GoogleAds::V21::Enums::SharedSetTypeEnum qw(NEGATIVE_KEYWORDS);
use Google::Ads::GoogleAds::V21::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V21::Services::SharedSetService::SharedSetOperation;
use
...
sub create_and_attach_shared_keyword_set {
  ...
  my $shared_set = Google::Ads::GoogleAds::V21::Resources::SharedSet->new({
  ...
  foreach my $keyword (@$keywords) {
    my $shared_criterion =
      Google::Ads::GoogleAds::V21::Resources::SharedCriterion->new({
  ...
  my $campaign_shared_set =
    Google::Ads::GoogleAds::V21::Resources::CampaignSharedSet->new({
