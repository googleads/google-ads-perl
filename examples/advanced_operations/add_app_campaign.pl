...
use Google::Ads::GoogleAds::V9::Resources::AppCampaignSetting;
use Google::Ads::GoogleAds::V9::Resources::SelectiveOptimization;
...
use Google::Ads::GoogleAds::V9::Enums::AdvertisingChannelSubTypeEnum
  qw(APP_CAMPAIGN);
use Google::Ads::GoogleAds::V9::Enums::AppCampaignAppStoreEnum
  qw(GOOGLE_APP_STORE);
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V9::Resources::Campaign->new({
      ...
      targetCpa => Google::Ads::GoogleAds::V9::Common::TargetCpa->new({
          targetCpaMicros => 1000000
        }
      ),
      # Configure the App campaign setting.
      appCampaignSetting =>
        Google::Ads::GoogleAds::V9::Resources::AppCampaignSetting->new({
      ...
      #   Google::Ads::GoogleAds::V9::Resources::SelectiveOptimization->new({
      #     conversionActions =>
...
sub create_app_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V9::Resources::AdGroupAd->new({
      ...
      ad     => Google::Ads::GoogleAds::V9::Resources::Ad->new({
          appAd => Google::Ads::GoogleAds::V9::Common::AppAdInfo->new({
              headlines => [
