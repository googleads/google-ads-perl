...
use Google::Ads::GoogleAds::V16::Resources::AppCampaignSetting;
use Google::Ads::GoogleAds::V16::Resources::SelectiveOptimization;
...
use Google::Ads::GoogleAds::V16::Common::AppAdInfo;
...
use Google::Ads::GoogleAds::V16::Enums::AdvertisingChannelTypeEnum
  qw(MULTI_CHANNEL);
use Google::Ads::GoogleAds::V16::Enums::AdvertisingChannelSubTypeEnum
  qw(APP_CAMPAIGN);
use Google::Ads::GoogleAds::V16::Enums::AppCampaignAppStoreEnum
  qw(GOOGLE_APP_STORE);
use Google::Ads::GoogleAds::V16::Enums::AppCampaignBiddingStrategyGoalTypeEnum
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V16::Resources::Campaign->new({
      ...
      targetCpa => Google::Ads::GoogleAds::V16::Common::TargetCpa->new({
          targetCpaMicros => 1000000
        }
      ),
      # Configure the App campaign setting.
      appCampaignSetting =>
        Google::Ads::GoogleAds::V16::Resources::AppCampaignSetting->new({
      ...
      #   Google::Ads::GoogleAds::V16::Resources::SelectiveOptimization->new({
      #     conversionActions =>
...
sub set_campaign_targeting_criteria {
  ...
  foreach my $language_id (1000, 1003) {
    my $campaign_criterion =
      Google::Ads::GoogleAds::V16::Resources::CampaignCriterion->new({
        campaign => $campaign_resource_name,
        language => Google::Ads::GoogleAds::V16::Common::LanguageInfo->new({
            languageConstant =>
...
sub create_app_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V16::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V16::Resources::Ad->new({
          appAd => Google::Ads::GoogleAds::V16::Common::AppAdInfo->new({
              headlines => [
...
sub create_ad_text_asset {
  ...
  return Google::Ads::GoogleAds::V16::Common::AdTextAsset->new({
    text => $text
  });
}
