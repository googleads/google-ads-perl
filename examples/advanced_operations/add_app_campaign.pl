...
use Google::Ads::GoogleAds::V25::Resources::AppCampaignSetting;
use Google::Ads::GoogleAds::V25::Resources::SelectiveOptimization;
...
use Google::Ads::GoogleAds::V25::Common::TargetCpa;
use Google::Ads::GoogleAds::V25::Common::LocationInfo;
use Google::Ads::GoogleAds::V25::Common::LanguageInfo;
use Google::Ads::GoogleAds::V25::Common::AppAdInfo;
use Google::Ads::GoogleAds::V25::Common::AdImageAsset;
...
use Google::Ads::GoogleAds::V25::Enums::AdvertisingChannelTypeEnum
  qw(MULTI_CHANNEL);
use Google::Ads::GoogleAds::V25::Enums::AdvertisingChannelSubTypeEnum
  qw(APP_CAMPAIGN);
use Google::Ads::GoogleAds::V25::Enums::AppCampaignAppStoreEnum
  qw(GOOGLE_APP_STORE);
use Google::Ads::GoogleAds::V25::Enums::AppCampaignBiddingStrategyGoalTypeEnum
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V25::Resources::Campaign->new({
      ...
      targetCpa => Google::Ads::GoogleAds::V25::Common::TargetCpa->new({
          targetCpaMicros => 1000000
        }
      ),
      # Configure the App campaign setting.
      appCampaignSetting =>
        Google::Ads::GoogleAds::V25::Resources::AppCampaignSetting->new({
      ...
      #   Google::Ads::GoogleAds::V25::Resources::SelectiveOptimization->new({
      #     conversionActions =>
      #       ["INSERT_CONVERSION_ACTION_RESOURCE_NAME(s)_HERE"]}
      #   ),
      #
      # Optional: Set the start and end datetimes for the campaign, beginning one day
      # from now and ending a year from now.
      startDateTime =>
        strftime("%Y%m%d 00:00:00", localtime(time + 60 * 60 * 24)),
      endDateTime =>
        strftime("%Y%m%d 23:59:59", localtime(time + 60 * 60 * 24 * 365)),
    });
...
sub set_campaign_targeting_criteria {
  ...
  foreach my $language_id (1000, 1003) {
    my $campaign_criterion =
      Google::Ads::GoogleAds::V25::Resources::CampaignCriterion->new({
        campaign => $campaign_resource_name,
        language => Google::Ads::GoogleAds::V25::Common::LanguageInfo->new({
            languageConstant =>
...
sub create_app_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V25::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V25::Resources::Ad->new({
          appAd => Google::Ads::GoogleAds::V25::Common::AppAdInfo->new({
              headlines => [
...
sub create_ad_text_asset {
  ...
  return Google::Ads::GoogleAds::V25::Common::AdTextAsset->new({
    text => $text
  });
}
