...
use Google::Ads::GoogleAds::V12::Resources::AppCampaignSetting;
use Google::Ads::GoogleAds::V12::Resources::SelectiveOptimization;
...
use Google::Ads::GoogleAds::V12::Enums::BudgetDeliveryMethodEnum qw(STANDARD);
use Google::Ads::GoogleAds::V12::Enums::CampaignStatusEnum       qw(PAUSED);
use Google::Ads::GoogleAds::V12::Enums::AdvertisingChannelTypeEnum
  qw(MULTI_CHANNEL);
use Google::Ads::GoogleAds::V12::Enums::AdvertisingChannelSubTypeEnum
  qw(APP_CAMPAIGN);
use Google::Ads::GoogleAds::V12::Enums::AppCampaignAppStoreEnum
  qw(GOOGLE_APP_STORE);
use Google::Ads::GoogleAds::V12::Enums::AppCampaignBiddingStrategyGoalTypeEnum
  qw(OPTIMIZE_INSTALLS_TARGET_INSTALL_COST);
use Google::Ads::GoogleAds::V12::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V12::Enums::AdGroupAdStatusEnum;
use
...
sub create_campaign {
  ...
  # Create a campaign.
  my $campaign = Google::Ads::GoogleAds::V12::Resources::Campaign->new({
      ...
      targetCpa => Google::Ads::GoogleAds::V12::Common::TargetCpa->new({
          targetCpaMicros => 1000000
        }
      ),
      # Configure the App campaign setting.
      appCampaignSetting =>
        Google::Ads::GoogleAds::V12::Resources::AppCampaignSetting->new({
      ...
      #   Google::Ads::GoogleAds::V12::Resources::SelectiveOptimization->new({
      #     conversionActions =>
...
sub set_campaign_targeting_criteria {
  ...
  foreach my $location_id (21137, 2484) {
    my $campaign_criterion =
      Google::Ads::GoogleAds::V12::Resources::CampaignCriterion->new({
        ...
        location => Google::Ads::GoogleAds::V12::Common::LocationInfo->new({
            geoTargetConstant =>
  ...
  foreach my $language_id (1000, 1003) {
    my $campaign_criterion =
      Google::Ads::GoogleAds::V12::Resources::CampaignCriterion->new({
        campaign => $campaign_resource_name,
        language => Google::Ads::GoogleAds::V12::Common::LanguageInfo->new({
            languageConstant =>
...
sub create_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V12::Resources::AdGroup->new({
    name   => "Earth to Mars Cruises #" . uniqid(),
    status => Google::Ads::GoogleAds::V12::Enums::AdGroupStatusEnum::ENABLED,
    campaign => $campaign_resource_name
  });
...
sub create_app_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V12::Resources::AdGroupAd->new({
      ...
      status  =>
        Google::Ads::GoogleAds::V12::Enums::AdGroupAdStatusEnum::ENABLED,
      ad => Google::Ads::GoogleAds::V12::Resources::Ad->new({
          appAd => Google::Ads::GoogleAds::V12::Common::AppAdInfo->new({
              headlines => [
...
sub create_ad_text_asset {
  ...
  return Google::Ads::GoogleAds::V12::Common::AdTextAsset->new({
    text => $text
  });
}
