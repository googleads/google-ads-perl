...
use Google::Ads::GoogleAds::V19::Resources::AppCampaignSetting;
use Google::Ads::GoogleAds::V19::Resources::SelectiveOptimization;
...
use Google::Ads::GoogleAds::V19::Common::TargetCpa;
use Google::Ads::GoogleAds::V19::Common::LocationInfo;
use Google::Ads::GoogleAds::V19::Common::LanguageInfo;
use Google::Ads::GoogleAds::V19::Common::AppAdInfo;
use Google::Ads::GoogleAds::V19::Common::AdImageAsset;
...
use Google::Ads::GoogleAds::V19::Enums::AdvertisingChannelSubTypeEnum
  qw(APP_CAMPAIGN);
use Google::Ads::GoogleAds::V19::Enums::AppCampaignAppStoreEnum
  qw(GOOGLE_APP_STORE);
use Google::Ads::GoogleAds::V19::Enums::AppCampaignBiddingStrategyGoalTypeEnum
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V19::Resources::Campaign->new({
      ...
      targetCpa => Google::Ads::GoogleAds::V19::Common::TargetCpa->new({
          targetCpaMicros => 1000000
        }
      ),
      # Configure the App campaign setting.
      appCampaignSetting =>
        Google::Ads::GoogleAds::V19::Resources::AppCampaignSetting->new({
      ...
      #   Google::Ads::GoogleAds::V19::Resources::SelectiveOptimization->new({
      #     conversionActions =>
...
sub set_campaign_targeting_criteria {
  ...
  foreach my $language_id (1000, 1003) {
    my $campaign_criterion =
      Google::Ads::GoogleAds::V19::Resources::CampaignCriterion->new({
        campaign => $campaign_resource_name,
        language => Google::Ads::GoogleAds::V19::Common::LanguageInfo->new({
            languageConstant =>
...
sub create_app_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V19::Resources::AdGroupAd->new({
      ...
      status  =>
        Google::Ads::GoogleAds::V19::Enums::AdGroupAdStatusEnum::ENABLED,
      ad => Google::Ads::GoogleAds::V19::Resources::Ad->new({
          appAd => Google::Ads::GoogleAds::V19::Common::AppAdInfo->new({
              headlines => [
              ...
              # images => [
              #   Google::Ads::GoogleAds::V19::Common::AdImageAsset->new({
...
sub create_ad_text_asset {
  ...
  return Google::Ads::GoogleAds::V19::Common::AdTextAsset->new({
    text => $text
  });
}
