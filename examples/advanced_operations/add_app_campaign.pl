...
use Google::Ads::GoogleAds::V11::Resources::AppCampaignSetting;
use Google::Ads::GoogleAds::V11::Resources::SelectiveOptimization;
...
use Google::Ads::GoogleAds::V11::Enums::AdvertisingChannelSubTypeEnum
  qw(APP_CAMPAIGN);
use Google::Ads::GoogleAds::V11::Enums::AppCampaignAppStoreEnum
  qw(GOOGLE_APP_STORE);
use Google::Ads::GoogleAds::V11::Enums::AppCampaignBiddingStrategyGoalTypeEnum
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V11::Resources::Campaign->new({
      ...
      targetCpa => Google::Ads::GoogleAds::V11::Common::TargetCpa->new({
          targetCpaMicros => 1000000
        }
      ),
      # Configure the App campaign setting.
      appCampaignSetting =>
        Google::Ads::GoogleAds::V11::Resources::AppCampaignSetting->new({
      ...
      #   Google::Ads::GoogleAds::V11::Resources::SelectiveOptimization->new({
      #     conversionActions =>
...
sub set_campaign_targeting_criteria {
  ...
  foreach my $location_id (21137, 2484) {
    my $campaign_criterion =
      Google::Ads::GoogleAds::V11::Resources::CampaignCriterion->new({
        ...
        location => Google::Ads::GoogleAds::V11::Common::LocationInfo->new({
            geoTargetConstant =>
  ...
  foreach my $language_id (1000, 1003) {
    my $campaign_criterion =
      Google::Ads::GoogleAds::V11::Resources::CampaignCriterion->new({
        campaign => $campaign_resource_name,
        language => Google::Ads::GoogleAds::V11::Common::LanguageInfo->new({
            languageConstant =>
...
sub create_app_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V11::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V11::Resources::Ad->new({
          appAd => Google::Ads::GoogleAds::V11::Common::AppAdInfo->new({
              headlines => [
