...
use Google::Ads::GoogleAds::V17::Resources::DynamicSearchAdsSetting;
...
use Google::Ads::GoogleAds::V17::Common::ExpandedDynamicSearchAdInfo;
...
use Google::Ads::GoogleAds::V17::Enums::AdGroupTypeEnum qw(SEARCH_DYNAMIC_ADS);
...
sub add_web_page_criterion {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V17::Resources::AdGroupCriterion->new({
      adGroup => $ad_group_resource_name,
      status  =>
        Google::Ads::GoogleAds::V17::Enums::AdGroupCriterionStatusEnum::PAUSED,
      cpcBidMicros => 10000000,
      webpage      => Google::Ads::GoogleAds::V17::Common::WebpageInfo->new({
