...
use Google::Ads::GoogleAds::V24::Resources::DynamicSearchAdsSetting;
...
use Google::Ads::GoogleAds::V24::Enums::AdGroupTypeEnum qw(SEARCH_DYNAMIC_ADS);
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V24::Resources::Campaign->new({
      ...
      dynamicSearchAdsSetting =>
        Google::Ads::GoogleAds::V24::Resources::DynamicSearchAdsSetting->new({
...
sub create_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V24::Resources::AdGroup->new({
    ...
    status   => Google::Ads::GoogleAds::V24::Enums::AdGroupStatusEnum::PAUSED,
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V24::Resources::AdGroupAd->new({
      ...
      ad     => Google::Ads::GoogleAds::V24::Resources::Ad->new({
          expandedDynamicSearchAd =>
            Google::Ads::GoogleAds::V24::Common::ExpandedDynamicSearchAdInfo->
            new({
