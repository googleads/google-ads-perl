...
use Google::Ads::GoogleAds::V10::Resources::DynamicSearchAdsSetting;
...
use Google::Ads::GoogleAds::V10::Common::ExpandedDynamicSearchAdInfo;
...
use Google::Ads::GoogleAds::V10::Enums::AdGroupTypeEnum qw(SEARCH_DYNAMIC_ADS);
use Google::Ads::GoogleAds::V10::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V10::Enums::AdGroupCriterionStatusEnum;
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V10::Resources::Campaign->new({
      ...
      dynamicSearchAdsSetting =>
        Google::Ads::GoogleAds::V10::Resources::DynamicSearchAdsSetting->new({
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V10::Resources::AdGroupAd->new({
      ...
      ad     => Google::Ads::GoogleAds::V10::Resources::Ad->new({
          expandedDynamicSearchAd =>
            Google::Ads::GoogleAds::V10::Common::ExpandedDynamicSearchAdInfo->
            new({
...
sub add_web_page_criterion {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V10::Resources::AdGroupCriterion->new({
      adGroup => $ad_group_resource_name,
      status  =>
        Google::Ads::GoogleAds::V10::Enums::AdGroupCriterionStatusEnum::PAUSED,
      cpcBidMicros => 10000000,
      webpage      => Google::Ads::GoogleAds::V10::Common::WebpageInfo->new({
