...
use Google::Ads::GoogleAds::V25::Resources::DynamicSearchAdsSetting;
...
use Google::Ads::GoogleAds::V25::Common::ExpandedDynamicSearchAdInfo;
use Google::Ads::GoogleAds::V25::Common::WebpageInfo;
use Google::Ads::GoogleAds::V25::Common::WebpageConditionInfo;
...
use Google::Ads::GoogleAds::V25::Enums::AdGroupTypeEnum qw(SEARCH_DYNAMIC_ADS);
use Google::Ads::GoogleAds::V25::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V25::Enums::AdGroupCriterionStatusEnum;
use Google::Ads::GoogleAds::V25::Enums::WebpageConditionOperandEnum
  qw(URL PAGE_TITLE);
...
sub add_web_page_criterion {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V25::Resources::AdGroupCriterion->new({
      adGroup => $ad_group_resource_name,
      status  =>
        Google::Ads::GoogleAds::V25::Enums::AdGroupCriterionStatusEnum::PAUSED,
      cpcBidMicros => 10000000,
      webpage      => Google::Ads::GoogleAds::V25::Common::WebpageInfo->new({
          criterionName => "Special Offers",
          conditions    => [
            Google::Ads::GoogleAds::V25::Common::WebpageConditionInfo->new({
                operand  => URL,
