...
use Google::Ads::GoogleAds::V9::Resources::DynamicSearchAdsSetting;
...
use Google::Ads::GoogleAds::V9::Common::ExpandedDynamicSearchAdInfo;
...
use Google::Ads::GoogleAds::V9::Enums::AdGroupTypeEnum qw(SEARCH_DYNAMIC_ADS);
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V9::Resources::Campaign->new({
      ...
      dynamicSearchAdsSetting =>
        Google::Ads::GoogleAds::V9::Resources::DynamicSearchAdsSetting->new({
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V9::Resources::AdGroupAd->new({
      ...
      ad      => Google::Ads::GoogleAds::V9::Resources::Ad->new({
          expandedDynamicSearchAd =>
            Google::Ads::GoogleAds::V9::Common::ExpandedDynamicSearchAdInfo->
            new({
...
sub add_web_page_criterion {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V9::Resources::AdGroupCriterion->new({
      adGroup => $ad_group_resource_name,
      status  =>
        Google::Ads::GoogleAds::V9::Enums::AdGroupCriterionStatusEnum::PAUSED,
      cpcBidMicros => 10000000,
      webpage      => Google::Ads::GoogleAds::V9::Common::WebpageInfo->new({
