...
use Google::Ads::GoogleAds::V5::Resources::DynamicSearchAdsSetting;
...
use Google::Ads::GoogleAds::V5::Enums::AdGroupTypeEnum qw(SEARCH_DYNAMIC_ADS);
use Google::Ads::GoogleAds::V5::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V5::Enums::AdGroupCriterionStatusEnum;
use Google::Ads::GoogleAds::V5::Enums::WebpageConditionOperandEnum
  qw(URL PAGE_TITLE);
use
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V5::Resources::Campaign->new({
      ...
      dynamicSearchAdsSetting =>
        Google::Ads::GoogleAds::V5::Resources::DynamicSearchAdsSetting->new({
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V5::Resources::AdGroupAd->new({
      ...
      ad      => Google::Ads::GoogleAds::V5::Resources::Ad->new({
          expandedDynamicSearchAd =>
            Google::Ads::GoogleAds::V5::Common::ExpandedDynamicSearchAdInfo->
            new({
...
sub add_web_page_criterion {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V5::Resources::AdGroupCriterion->new({
      adGroup => $ad_group_resource_name,
      status =>
        Google::Ads::GoogleAds::V5::Enums::AdGroupCriterionStatusEnum::PAUSED,
      cpcBidMicros => 10000000,
      webpage      => Google::Ads::GoogleAds::V5::Common::WebpageInfo->new({
          criterionName => "Special Offers",
          conditions    => [
            Google::Ads::GoogleAds::V5::Common::WebpageConditionInfo->new({
                operand  => URL,
