...
use Google::Ads::GoogleAds::V2::Resources::DynamicSearchAdsSetting;
...
use Google::Ads::GoogleAds::V2::Enums::AdGroupTypeEnum qw(SEARCH_DYNAMIC_ADS);
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V2::Resources::Campaign->new({
      ...
      dynamicSearchAdsSetting =>
        Google::Ads::GoogleAds::V2::Resources::DynamicSearchAdsSetting->new({
...
sub create_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V2::Resources::AdGroup->new({
    ...
    status   => Google::Ads::GoogleAds::V2::Enums::AdGroupStatusEnum::PAUSED,
...
sub add_web_page_criterion {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V2::Resources::AdGroupCriterion->new({
      adGroup => $ad_group_resource_name,
      status =>
        Google::Ads::GoogleAds::V2::Enums::AdGroupCriterionStatusEnum::PAUSED,
      cpcBidMicros => 10000000,
      webpage      => Google::Ads::GoogleAds::V2::Common::WebpageInfo->new({
