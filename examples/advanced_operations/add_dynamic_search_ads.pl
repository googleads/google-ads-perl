...
use Google::Ads::GoogleAds::V14::Resources::DynamicSearchAdsSetting;
...
use Google::Ads::GoogleAds::V14::Enums::AdvertisingChannelTypeEnum qw(SEARCH);
use Google::Ads::GoogleAds::V14::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V14::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V14::Enums::AdGroupTypeEnum qw(SEARCH_DYNAMIC_ADS);
use Google::Ads::GoogleAds::V14::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V14::Enums::AdGroupCriterionStatusEnum;
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V14::Resources::Campaign->new({
      ...
      manualCpc      => Google::Ads::GoogleAds::V14::Common::ManualCpc->new(),
      campaignBudget => $campaign_budget_resource_name,
      # Enable the campaign for DSAs.
      dynamicSearchAdsSetting =>
        Google::Ads::GoogleAds::V14::Resources::DynamicSearchAdsSetting->new({
...
sub create_ad_group {
  ...
  my $ad_group = Google::Ads::GoogleAds::V14::Resources::AdGroup->new({
    ...
    status   => Google::Ads::GoogleAds::V14::Enums::AdGroupStatusEnum::PAUSED,
...
sub create_expanded_dsa {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V14::Resources::AdGroupAd->new({
      ...
      status => Google::Ads::GoogleAds::V14::Enums::AdGroupAdStatusEnum::PAUSED,
      ad     => Google::Ads::GoogleAds::V14::Resources::Ad->new({
          expandedDynamicSearchAd =>
            Google::Ads::GoogleAds::V14::Common::ExpandedDynamicSearchAdInfo->
            new({
...
sub add_web_page_criterion {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V14::Resources::AdGroupCriterion->new({
      adGroup => $ad_group_resource_name,
      status  =>
        Google::Ads::GoogleAds::V14::Enums::AdGroupCriterionStatusEnum::PAUSED,
      cpcBidMicros => 10000000,
      webpage      => Google::Ads::GoogleAds::V14::Common::WebpageInfo->new({
