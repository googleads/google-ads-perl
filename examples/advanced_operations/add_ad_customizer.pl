...
use Google::Ads::GoogleAds::V20::Resources::AttributeFieldMapping;
use Google::Ads::GoogleAds::V20::Resources::Ad;
use Google::Ads::GoogleAds::V20::Resources::AdGroupAd;
use Google::Ads::GoogleAds::V20::Resources::AdGroupCustomizer;
...
use Google::Ads::GoogleAds::V20::Enums::CustomizerAttributeTypeEnum
  qw(TEXT PRICE);
...
use
  Google::Ads::GoogleAds::V20::Services::AdGroupCustomizerService::AdGroupCustomizerOperation;
use
...
sub link_customizer_attributes {
  ...
  my $marsCustomizer =
    Google::Ads::GoogleAds::V20::Resources::AdGroupCustomizer->new({
