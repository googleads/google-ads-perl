...
use Google::Ads::GoogleAds::V15::Resources::AdGroupCustomizer;
use Google::Ads::GoogleAds::V15::Resources::CustomizerAttribute;
use Google::Ads::GoogleAds::V15::Common::AdTextAsset;
use Google::Ads::GoogleAds::V15::Common::CustomizerValue;
use Google::Ads::GoogleAds::V15::Common::ResponsiveSearchAdInfo;
use Google::Ads::GoogleAds::V15::Enums::CustomizerAttributeTypeEnum
  qw(TEXT PRICE);
use Google::Ads::GoogleAds::V15::Enums::ServedAssetFieldTypeEnum qw(HEADLINE_1);
use Google::Ads::GoogleAds::V15::Services::AdGroupAdService::AdGroupAdOperation;
use
  Google::Ads::GoogleAds::V15::Services::AdGroupCustomizerService::AdGroupCustomizerOperation;
use
  Google::Ads::GoogleAds::V15::Services::CustomizerAttributeService::CustomizerAttributeOperation;
...
sub create_text_customizer_attribute {
  ...
  my $text_attribute =
    Google::Ads::GoogleAds::V15::Resources::CustomizerAttribute->new({
...
sub link_customizer_attributes {
  ...
  my $marsCustomizer =
    Google::Ads::GoogleAds::V15::Resources::AdGroupCustomizer->new({
      customizerAttribute => $text_customizer_attribute_resource_name,
      value => Google::Ads::GoogleAds::V15::Common::CustomizerValue->new({
          type        => TEXT,
          stringValue => "Mars"
        }
      ),
...
sub create_ad_with_customizations {
  ...
  my $responsive_search_ad_info =
    Google::Ads::GoogleAds::V15::Common::ResponsiveSearchAdInfo->new({
      headlines => [
...
"Buy your tickets to {CUSTOMIZER.$string_customizer_name:Venus} now!"
  ...
  my $ad = Google::Ads::GoogleAds::V15::Resources::Ad->new({
