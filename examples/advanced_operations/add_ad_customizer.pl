...
use Google::Ads::GoogleAds::V19::Resources::AttributeFieldMapping;
use Google::Ads::GoogleAds::V19::Resources::Ad;
use Google::Ads::GoogleAds::V19::Resources::AdGroupAd;
use Google::Ads::GoogleAds::V19::Resources::AdGroupCustomizer;
...
use Google::Ads::GoogleAds::V19::Enums::CustomizerAttributeTypeEnum
  qw(TEXT PRICE);
use Google::Ads::GoogleAds::V19::Enums::ServedAssetFieldTypeEnum qw(HEADLINE_1);
use Google::Ads::GoogleAds::V19::Services::AdGroupAdService::AdGroupAdOperation;
use
  Google::Ads::GoogleAds::V19::Services::AdGroupCustomizerService::AdGroupCustomizerOperation;
use
  Google::Ads::GoogleAds::V19::Services::CustomizerAttributeService::CustomizerAttributeOperation;
...
sub create_text_customizer_attribute {
  ...
  my $text_attribute =
    Google::Ads::GoogleAds::V19::Resources::CustomizerAttribute->new({
...
sub link_customizer_attributes {
  ...
  my $marsCustomizer =
    Google::Ads::GoogleAds::V19::Resources::AdGroupCustomizer->new({
      customizerAttribute => $text_customizer_attribute_resource_name,
      value => Google::Ads::GoogleAds::V19::Common::CustomizerValue->new({
          type        => TEXT,
          stringValue => "Mars"
        }
      ),
...
sub create_ad_with_customizations {
  ...
  my $responsive_search_ad_info =
    Google::Ads::GoogleAds::V19::Common::ResponsiveSearchAdInfo->new({
      headlines => [
...
"Buy your tickets to {CUSTOMIZER.$string_customizer_name:Venus} now!"
  ...
  my $ad = Google::Ads::GoogleAds::V19::Resources::Ad->new({
