...
use Google::Ads::GoogleAds::V12::Enums::CustomizerAttributeTypeEnum
  qw(TEXT PRICE);
use Google::Ads::GoogleAds::V12::Enums::ServedAssetFieldTypeEnum qw(HEADLINE_1);
use Google::Ads::GoogleAds::V12::Services::AdGroupAdService::AdGroupAdOperation;
use
  Google::Ads::GoogleAds::V12::Services::AdGroupCustomizerService::AdGroupCustomizerOperation;
use
...
sub link_customizer_attributes {
  ...
  my $marsCustomizer =
    Google::Ads::GoogleAds::V12::Resources::AdGroupCustomizer->new({
