...
use Google::Ads::GoogleAds::V25::Resources::AttributeFieldMapping;
use Google::Ads::GoogleAds::V25::Resources::Ad;
use Google::Ads::GoogleAds::V25::Resources::AdGroupAd;
use Google::Ads::GoogleAds::V25::Resources::AdGroupCustomizer;
...
use Google::Ads::GoogleAds::V25::Enums::CustomizerAttributeTypeEnum
  qw(TEXT PRICE);
...
use
  Google::Ads::GoogleAds::V25::Services::AdGroupCustomizerService::AdGroupCustomizerOperation;
use
...
sub link_customizer_attributes {
  ...
  my $marsCustomizer =
    Google::Ads::GoogleAds::V25::Resources::AdGroupCustomizer->new({
