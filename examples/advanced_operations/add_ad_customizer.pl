...
use Google::Ads::GoogleAds::V9::Enums::AdCustomizerPlaceholderFieldEnum;
use Google::Ads::GoogleAds::V9::Enums::PlaceholderTypeEnum qw(AD_CUSTOMIZER);
...
use
  Google::Ads::GoogleAds::V9::Services::FeedItemTargetService::FeedItemTargetOperation;
...
sub create_ad_customizer_mapping {
  ...
  my $name_field_mapping =
    Google::Ads::GoogleAds::V9::Resources::AttributeFieldMapping->new({
      ...
      adCustomizerField =>
        Google::Ads::GoogleAds::V9::Enums::AdCustomizerPlaceholderFieldEnum::STRING,
    });
  ...
  my $price_field_mapping =
    Google::Ads::GoogleAds::V9::Resources::AttributeFieldMapping->new({
      ...
      adCustomizerField =>
        Google::Ads::GoogleAds::V9::Enums::AdCustomizerPlaceholderFieldEnum::PRICE,
    });
  ...
  my $date_field_mapping =
    Google::Ads::GoogleAds::V9::Resources::AttributeFieldMapping->new({
      ...
      adCustomizerField =>
        Google::Ads::GoogleAds::V9::Enums::AdCustomizerPlaceholderFieldEnum::DATE,
    });
...
sub create_feed_item_targets {
  ...
  for (my $i = 0 ; $i < scalar @$feed_item_resource_names ; $i++) {
    ...
    my $feed_item_target =
      Google::Ads::GoogleAds::V9::Resources::FeedItemTarget->new({
