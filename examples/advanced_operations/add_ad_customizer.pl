...
use Google::Ads::GoogleAds::V11::Resources::FeedItemTarget;
...
use Google::Ads::GoogleAds::V11::Enums::AdCustomizerPlaceholderFieldEnum;
use Google::Ads::GoogleAds::V11::Enums::PlaceholderTypeEnum qw(AD_CUSTOMIZER);
...
use
  Google::Ads::GoogleAds::V11::Services::FeedItemTargetService::FeedItemTargetOperation;
...
sub create_ad_customizer_mapping {
  ...
  my $name_field_mapping =
    Google::Ads::GoogleAds::V11::Resources::AttributeFieldMapping->new({
      ...
      adCustomizerField =>
        Google::Ads::GoogleAds::V11::Enums::AdCustomizerPlaceholderFieldEnum::STRING,
    });
  ...
  my $price_field_mapping =
    Google::Ads::GoogleAds::V11::Resources::AttributeFieldMapping->new({
      ...
      adCustomizerField =>
        Google::Ads::GoogleAds::V11::Enums::AdCustomizerPlaceholderFieldEnum::PRICE,
    });
  ...
  my $date_field_mapping =
    Google::Ads::GoogleAds::V11::Resources::AttributeFieldMapping->new({
      ...
      adCustomizerField =>
        Google::Ads::GoogleAds::V11::Enums::AdCustomizerPlaceholderFieldEnum::DATE,
    });
...
sub create_feed_item_targets {
  ...
  for (my $i = 0 ; $i < scalar @$feed_item_resource_names ; $i++) {
    ...
    my $feed_item_target =
      Google::Ads::GoogleAds::V11::Resources::FeedItemTarget->new({
