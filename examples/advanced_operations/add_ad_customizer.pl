...
use Google::Ads::GoogleAds::V16::Resources::AdGroupCustomizer;
...
use Google::Ads::GoogleAds::V16::Enums::CustomizerAttributeTypeEnum
  qw(TEXT PRICE);
...
use
  Google::Ads::GoogleAds::V16::Services::AdGroupCustomizerService::AdGroupCustomizerOperation;
use
...
sub link_customizer_attributes {
  ...
  my $marsCustomizer =
    Google::Ads::GoogleAds::V16::Resources::AdGroupCustomizer->new({
