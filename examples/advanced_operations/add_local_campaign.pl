...
use Google::Ads::GoogleAds::V10::Resources::LocalCampaignSetting;
use Google::Ads::GoogleAds::V10::Resources::OptimizationGoalSetting;
...
use Google::Ads::GoogleAds::V10::Common::LocalAdInfo;
use Google::Ads::GoogleAds::V10::Common::AdTextAsset;
use Google::Ads::GoogleAds::V10::Common::AdImageAsset;
use Google::Ads::GoogleAds::V10::Common::AdVideoAsset;
use Google::Ads::GoogleAds::V10::Common::ImageAsset;
use Google::Ads::GoogleAds::V10::Common::YoutubeVideoAsset;
...
use Google::Ads::GoogleAds::V10::Enums::AdvertisingChannelTypeEnum qw(LOCAL);
use Google::Ads::GoogleAds::V10::Enums::AdvertisingChannelSubTypeEnum
  qw(LOCAL_CAMPAIGN);
use Google::Ads::GoogleAds::V10::Enums::LocationSourceTypeEnum
  qw(GOOGLE_MY_BUSINESS);
use Google::Ads::GoogleAds::V10::Enums::OptimizationGoalTypeEnum
...
use Google::Ads::GoogleAds::V10::Enums::AssetTypeEnum qw(IMAGE YOUTUBE_VIDEO);
use
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V10::Resources::Campaign->new({
      ...
      maximizeConversionValue =>
        Google::Ads::GoogleAds::V10::Common::MaximizeConversionValue->new(
        {targetRoas => 3.5}
        ),
      # Configure the Local campaign setting.
      localCampaignSetting =>
        Google::Ads::GoogleAds::V10::Resources::LocalCampaignSetting->new({
      ...
      optimizationGoalSetting =>
        Google::Ads::GoogleAds::V10::Resources::OptimizationGoalSetting->new({
...
sub create_local_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V10::Resources::AdGroupAd->new({
      ...
      status  =>
        Google::Ads::GoogleAds::V10::Enums::AdGroupAdStatusEnum::ENABLED,
      ad => Google::Ads::GoogleAds::V10::Resources::Ad->new({
          finalUrls => ["https://www.example.com"],
          localAd   => Google::Ads::GoogleAds::V10::Common::LocalAdInfo->new({
              headlines => [
              ...
              marketingImages => [
                Google::Ads::GoogleAds::V10::Common::AdImageAsset->new({
              ...
              videos => [
                Google::Ads::GoogleAds::V10::Common::AdVideoAsset->new({
...
sub create_ad_text_asset {
  ...
  return Google::Ads::GoogleAds::V10::Common::AdTextAsset->new({
    text => $text
  });
}
...
sub create_image_asset {
  ...
  my $asset = Google::Ads::GoogleAds::V10::Resources::Asset->new({
      name       => $image_name,
      type       => IMAGE,
      imageAsset => Google::Ads::GoogleAds::V10::Common::ImageAsset->new({
...
sub create_youtube_video_asset {
  ...
  my $asset = Google::Ads::GoogleAds::V10::Resources::Asset->new({
      ...
      type              => YOUTUBE_VIDEO,
      youtubeVideoAsset =>
        Google::Ads::GoogleAds::V10::Common::YoutubeVideoAsset->new({
