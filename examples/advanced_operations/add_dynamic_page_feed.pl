...
use Google::Ads::GoogleAds::V3::Enums::DsaPageFeedCriterionFieldEnum
  qw(PAGE_URL LABEL);
use Google::Ads::GoogleAds::V3::Enums::FeedMappingCriterionTypeEnum
  qw(DSA_PAGE_FEED);
...
sub create_feed {
  ...
  my $url_attribute = Google::Ads::GoogleAds::V3::Resources::FeedAttribute->new(
    {
      type => URL_LIST,
      name => "Page URL"
    });
