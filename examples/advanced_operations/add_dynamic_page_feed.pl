...
use Google::Ads::GoogleAds::V8::Enums::DsaPageFeedCriterionFieldEnum
  qw(PAGE_URL LABEL);
use Google::Ads::GoogleAds::V8::Enums::FeedMappingCriterionTypeEnum
  qw(DSA_PAGE_FEED);
...
sub create_feed {
  ...
  my $url_attribute = Google::Ads::GoogleAds::V8::Resources::FeedAttribute->new(
    {
      type => URL_LIST,
      name => "Page URL"
    });
...
sub add_dsa_target {
  ...
  my $web_page_info = Google::Ads::GoogleAds::V8::Common::WebpageInfo->new({
