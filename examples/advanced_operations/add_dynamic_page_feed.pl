...
use Google::Ads::GoogleAds::V4::Enums::DsaPageFeedCriterionFieldEnum
  qw(PAGE_URL LABEL);
use Google::Ads::GoogleAds::V4::Enums::FeedMappingCriterionTypeEnum
  qw(DSA_PAGE_FEED);
...
sub create_feed {
  ...
  my $url_attribute = Google::Ads::GoogleAds::V4::Resources::FeedAttribute->new(
    {
      type => URL_LIST,
      name => "Page URL"
    });
...
sub add_dsa_target {
  ...
  my $ad_group_resource_name =
    Google::Ads::GoogleAds::V4::Utils::ResourceNames::ad_group($customer_id,
    $ad_group_id);
  ...
  my $web_page_info = Google::Ads::GoogleAds::V4::Common::WebpageInfo->new({
