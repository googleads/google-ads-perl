...
use Google::Ads::GoogleAds::V10::Resources::AdGroupBidModifier;
use Google::Ads::GoogleAds::V10::Common::DeviceInfo;
use Google::Ads::GoogleAds::V10::Enums::DeviceEnum qw(MOBILE);
use
  Google::Ads::GoogleAds::V10::Services::AdGroupBidModifierService::AdGroupBidModifierOperation;
...
sub add_ad_group_bid_modifier {
  ...
  my $ad_group_bid_modifier =
    Google::Ads::GoogleAds::V10::Resources::AdGroupBidModifier->new({
      adGroup => Google::Ads::GoogleAds::V10::Utils::ResourceNames::ad_group(
        $customer_id, $ad_group_id
      ),
      bidModifier => $bid_modifier_value,
      device      => Google::Ads::GoogleAds::V10::Common::DeviceInfo->new({
          type => MOBILE
        })});
