...
use Google::Ads::GoogleAds::V9::Common::DeviceInfo;
use Google::Ads::GoogleAds::V9::Enums::DeviceEnum qw(MOBILE);
use
...
sub add_ad_group_bid_modifier {
  ...
  my $ad_group_bid_modifier =
    Google::Ads::GoogleAds::V9::Resources::AdGroupBidModifier->new({
      ...
      device      => Google::Ads::GoogleAds::V9::Common::DeviceInfo->new({
          type => MOBILE
        })});
