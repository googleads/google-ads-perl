...
use Google::Ads::GoogleAds::V13::Resources::PhoneNumber;
use Google::Ads::GoogleAds::V13::Resources::SmartCampaignSetting;
use Google::Ads::GoogleAds::V13::Common::AdScheduleInfo;
use Google::Ads::GoogleAds::V13::Common::KeywordThemeInfo;
use Google::Ads::GoogleAds::V13::Common::LocationInfo;
use Google::Ads::GoogleAds::V13::Common::SmartCampaignAdInfo;
use Google::Ads::GoogleAds::V13::Common::AdTextAsset;
use Google::Ads::GoogleAds::V13::Enums::AdGroupTypeEnum qw(SMART_CAMPAIGN_ADS);
use Google::Ads::GoogleAds::V13::Enums::AdTypeEnum      qw(SMART_CAMPAIGN_AD);
use Google::Ads::GoogleAds::V13::Enums::AdvertisingChannelTypeEnum qw(SMART);
use Google::Ads::GoogleAds::V13::Enums::AdvertisingChannelSubTypeEnum;
use Google::Ads::GoogleAds::V13::Enums::BudgetTypeEnum;
use Google::Ads::GoogleAds::V13::Enums::CampaignStatusEnum       qw(PAUSED);
use Google::Ads::GoogleAds::V13::Enums::DayOfWeekEnum            qw(MONDAY);
use Google::Ads::GoogleAds::V13::Enums::MinuteOfHourEnum         qw(ZERO);
use Google::Ads::GoogleAds::V13::Enums::ProximityRadiusUnitsEnum qw(MILES);
...
use
  Google::Ads::GoogleAds::V13::Services::SmartCampaignSettingService::SmartCampaignSettingOperation;
use
...
sub _map_keyword_themes_to_keyword_infos {
  ...
  foreach my $keyword_theme (@$keyword_themes) {
    if (defined $keyword_theme->{keywordThemeConstant}) {
      push @$keyword_theme_infos,
        Google::Ads::GoogleAds::V13::Common::KeywordThemeInfo->new({
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V13::Resources::CampaignBudget->new({
              ...
              type =>
                Google::Ads::GoogleAds::V13::Enums::BudgetTypeEnum::SMART_CAMPAIGN,
        ...
        ->new({
          create => Google::Ads::GoogleAds::V13::Resources::Campaign->new({
              ...
              advertisingChannelSubType =>
                Google::Ads::GoogleAds::V13::Enums::AdvertisingChannelSubTypeEnum::SMART_CAMPAIGN,
  ...
  return
    ...
    new({
      adGroupOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V13::Resources::AdGroup->new({
  ...
  my $mutate_operation =
    ...
    new({
      adGroupAdOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V13::Resources::AdGroupAd->new({
              adGroup =>
                # Set the ad group ID to a temporary ID.
                Google::Ads::GoogleAds::V13::Utils::ResourceNames::ad_group(
                $customer_id, AD_GROUP_TEMPORARY_ID
              ...
              ad => Google::Ads::GoogleAds::V13::Resources::Ad->new({
                  ...
                  smartCampaignAd =>
                    Google::Ads::GoogleAds::V13::Common::SmartCampaignAdInfo->
                    new({
                      headlines    => [],
                      descriptions => []})})})})});
