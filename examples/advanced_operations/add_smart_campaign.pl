...
use Google::Ads::GoogleAds::V18::Resources::PhoneNumber;
...
use Google::Ads::GoogleAds::V18::Enums::AdGroupTypeEnum qw(SMART_CAMPAIGN_ADS);
use Google::Ads::GoogleAds::V18::Enums::AdTypeEnum      qw(SMART_CAMPAIGN_AD);
use Google::Ads::GoogleAds::V18::Enums::AdvertisingChannelTypeEnum qw(SMART);
use Google::Ads::GoogleAds::V18::Enums::AdvertisingChannelSubTypeEnum;
use Google::Ads::GoogleAds::V18::Enums::BudgetTypeEnum;
use Google::Ads::GoogleAds::V18::Enums::CampaignStatusEnum       qw(PAUSED);
use Google::Ads::GoogleAds::V18::Enums::DayOfWeekEnum            qw(MONDAY);
use Google::Ads::GoogleAds::V18::Enums::MinuteOfHourEnum         qw(ZERO);
use Google::Ads::GoogleAds::V18::Enums::ProximityRadiusUnitsEnum qw(MILES);
...
use Google::Ads::GoogleAds::V18::Services::GoogleAdsService::MutateOperation;
use
  Google::Ads::GoogleAds::V18::Services::KeywordThemeConstantService::SuggestKeywordThemeConstantsRequest;
use
  Google::Ads::GoogleAds::V18::Services::SmartCampaignSettingService::SmartCampaignSettingOperation;
use
...
sub _map_keyword_themes_to_keyword_infos {
  ...
  foreach my $keyword_theme (@$keyword_themes) {
    if (defined $keyword_theme->{keywordThemeConstant}) {
      push @$keyword_theme_infos,
        Google::Ads::GoogleAds::V18::Common::KeywordThemeInfo->new({
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V18::Resources::CampaignBudget->new({
              ...
              type =>
                Google::Ads::GoogleAds::V18::Enums::BudgetTypeEnum::SMART_CAMPAIGN,
        ...
        ->new({
          create => Google::Ads::GoogleAds::V18::Resources::Campaign->new({
              ...
              advertisingChannelSubType =>
                Google::Ads::GoogleAds::V18::Enums::AdvertisingChannelSubTypeEnum::SMART_CAMPAIGN,
  ...
  return
    ...
    new({
      adGroupOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V18::Resources::AdGroup->new({
              # Set the ad group ID to a temporary ID.
              resourceName =>
                Google::Ads::GoogleAds::V18::Utils::ResourceNames::ad_group(
...
sub _create_ad_group_ad_operation {
  ...
  my $mutate_operation =
    ...
    new({
      adGroupAdOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V18::Resources::AdGroupAd->new({
              adGroup =>
                # Set the ad group ID to a temporary ID.
                Google::Ads::GoogleAds::V18::Utils::ResourceNames::ad_group(
                $customer_id, AD_GROUP_TEMPORARY_ID
              ...
              ad => Google::Ads::GoogleAds::V18::Resources::Ad->new({
                  ...
                  smartCampaignAd =>
                    Google::Ads::GoogleAds::V18::Common::SmartCampaignAdInfo->
                    new({
                      headlines    => [],
                      descriptions => []})})})})});
  ...
  for (my $i = 0 ; $i < $num_missing_headlines ; $i++) {
    push @{$smart_campaign_ad->{headlines}},
      Google::Ads::GoogleAds::V18::Common::AdTextAsset->new({
