...
use Google::Ads::GoogleAds::V15::Resources::PhoneNumber;
use Google::Ads::GoogleAds::V15::Resources::SmartCampaignSetting;
use Google::Ads::GoogleAds::V15::Common::AdScheduleInfo;
use Google::Ads::GoogleAds::V15::Common::KeywordThemeInfo;
use Google::Ads::GoogleAds::V15::Common::LocationInfo;
use Google::Ads::GoogleAds::V15::Common::SmartCampaignAdInfo;
use Google::Ads::GoogleAds::V15::Common::AdTextAsset;
use Google::Ads::GoogleAds::V15::Enums::AdGroupTypeEnum qw(SMART_CAMPAIGN_ADS);
use Google::Ads::GoogleAds::V15::Enums::AdTypeEnum      qw(SMART_CAMPAIGN_AD);
use Google::Ads::GoogleAds::V15::Enums::AdvertisingChannelTypeEnum qw(SMART);
use Google::Ads::GoogleAds::V15::Enums::AdvertisingChannelSubTypeEnum;
use Google::Ads::GoogleAds::V15::Enums::BudgetTypeEnum;
use Google::Ads::GoogleAds::V15::Enums::CampaignStatusEnum       qw(PAUSED);
use Google::Ads::GoogleAds::V15::Enums::DayOfWeekEnum            qw(MONDAY);
use Google::Ads::GoogleAds::V15::Enums::MinuteOfHourEnum         qw(ZERO);
use Google::Ads::GoogleAds::V15::Enums::ProximityRadiusUnitsEnum qw(MILES);
use Google::Ads::GoogleAds::V15::Services::AdGroupService::AdGroupOperation;
use Google::Ads::GoogleAds::V15::Services::AdGroupAdService::AdGroupAdOperation;
use
  Google::Ads::GoogleAds::V15::Services::CampaignBudgetService::CampaignBudgetOperation;
use Google::Ads::GoogleAds::V15::Services::CampaignService::CampaignOperation;
use
...
use
  Google::Ads::GoogleAds::V15::Services::KeywordThemeConstantService::SuggestKeywordThemeConstantsRequest;
use
  Google::Ads::GoogleAds::V15::Services::SmartCampaignSettingService::SmartCampaignSettingOperation;
use
  Google::Ads::GoogleAds::V15::Services::SmartCampaignSuggestService::BusinessContext;
use
  Google::Ads::GoogleAds::V15::Services::SmartCampaignSuggestService::KeywordTheme;
use
  Google::Ads::GoogleAds::V15::Services::SmartCampaignSuggestService::LocationList;
use
  Google::Ads::GoogleAds::V15::Services::SmartCampaignSuggestService::SmartCampaignSuggestionInfo;
use
  Google::Ads::GoogleAds::V15::Services::SmartCampaignSuggestService::SuggestKeywordThemesRequest;
use
  Google::Ads::GoogleAds::V15::Services::SmartCampaignSuggestService::SuggestSmartCampaignAdRequest;
use
  Google::Ads::GoogleAds::V15::Services::SmartCampaignSuggestService::SuggestSmartCampaignBudgetOptionsRequest;
...
sub _get_free_form_keyword_theme_info {
  ...
  return Google::Ads::GoogleAds::V15::Common::KeywordThemeInfo->new({
...
sub _map_keyword_themes_to_keyword_infos {
  ...
  foreach my $keyword_theme (@$keyword_themes) {
    if (defined $keyword_theme->{keywordThemeConstant}) {
      push @$keyword_theme_infos,
        Google::Ads::GoogleAds::V15::Common::KeywordThemeInfo->new({
...
sub _get_smart_campaign_suggestion_info {
  ...
  my $suggestion_info =
    ...
    ->new({
      ...
      #
      # proximity => Google::Ads::GoogleAds::V15::Common::ProximityInfo->new({
      #     address => Google::Ads::GoogleAds::V15::Common::AddressInfo->new({
  ...
  push @{$suggestion_info->{locationList}{locations}},
    Google::Ads::GoogleAds::V15::Common::LocationInfo->new({
  ...
  push @{$suggestion_info->{adSchedules}},
    Google::Ads::GoogleAds::V15::Common::AdScheduleInfo->new({
  ...
  return
    ...
    new({
      campaignBudgetOperation =>
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V15::Resources::CampaignBudget->new({
              name => "Smart campaign budget #" . uniqid(),
              # A budget used for Smart campaigns must have the type SMART_CAMPAIGN.
              type =>
                Google::Ads::GoogleAds::V15::Enums::BudgetTypeEnum::SMART_CAMPAIGN,
              ...
              resourceName =>
                Google::Ads::GoogleAds::V15::Utils::ResourceNames::campaign_budget(
...
sub _create_smart_campaign_operation {
  ...
  return
    ...
    new({
      campaignOperation =>
        Google::Ads::GoogleAds::V15::Services::CampaignService::CampaignOperation
        ->new({
          create => Google::Ads::GoogleAds::V15::Resources::Campaign->new({
              ...
              advertisingChannelSubType =>
                Google::Ads::GoogleAds::V15::Enums::AdvertisingChannelSubTypeEnum::SMART_CAMPAIGN,
...
sub _create_ad_group_operation {
  ...
  return
    ...
    new({
      adGroupOperation =>
        Google::Ads::GoogleAds::V15::Services::AdGroupService::AdGroupOperation
        ->new({
          create => Google::Ads::GoogleAds::V15::Resources::AdGroup->new({
              # Set the ad group ID to a temporary ID.
              resourceName =>
                Google::Ads::GoogleAds::V15::Utils::ResourceNames::ad_group(
...
sub _create_ad_group_ad_operation {
  ...
  my $mutate_operation =
    ...
    new({
      adGroupAdOperation =>
        Google::Ads::GoogleAds::V15::Services::AdGroupAdService::AdGroupAdOperation
        ->new({
          create => Google::Ads::GoogleAds::V15::Resources::AdGroupAd->new({
              adGroup =>
                # Set the ad group ID to a temporary ID.
                Google::Ads::GoogleAds::V15::Utils::ResourceNames::ad_group(
                $customer_id, AD_GROUP_TEMPORARY_ID
                ),
              ad => Google::Ads::GoogleAds::V15::Resources::Ad->new({
                  # Set the type to SMART_CAMPAIGN_AD.
                  type            => SMART_CAMPAIGN_AD,
                  smartCampaignAd =>
                    Google::Ads::GoogleAds::V15::Common::SmartCampaignAdInfo->
                    new({
                      headlines    => [],
                      descriptions => []})})})})});
  ...
  for (my $i = 0 ; $i < $num_missing_headlines ; $i++) {
    push @{$smart_campaign_ad->{headlines}},
      Google::Ads::GoogleAds::V15::Common::AdTextAsset->new({
