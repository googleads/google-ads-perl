...
use Google::Ads::GoogleAds::V25::Resources::PhoneNumber;
use Google::Ads::GoogleAds::V25::Resources::SmartCampaignSetting;
use Google::Ads::GoogleAds::V25::Common::AdScheduleInfo;
use Google::Ads::GoogleAds::V25::Common::KeywordThemeInfo;
use Google::Ads::GoogleAds::V25::Common::LocationInfo;
use Google::Ads::GoogleAds::V25::Common::SmartCampaignAdInfo;
use Google::Ads::GoogleAds::V25::Common::AdTextAsset;
use Google::Ads::GoogleAds::V25::Enums::AdGroupTypeEnum qw(SMART_CAMPAIGN_ADS);
use Google::Ads::GoogleAds::V25::Enums::AdTypeEnum      qw(SMART_CAMPAIGN_AD);
use Google::Ads::GoogleAds::V25::Enums::AdvertisingChannelTypeEnum qw(SMART);
use Google::Ads::GoogleAds::V25::Enums::AdvertisingChannelSubTypeEnum;
use Google::Ads::GoogleAds::V25::Enums::BudgetTypeEnum;
use Google::Ads::GoogleAds::V25::Enums::CampaignStatusEnum       qw(PAUSED);
use Google::Ads::GoogleAds::V25::Enums::DayOfWeekEnum            qw(MONDAY);
use Google::Ads::GoogleAds::V25::Enums::MinuteOfHourEnum         qw(ZERO);
use Google::Ads::GoogleAds::V25::Enums::ProximityRadiusUnitsEnum qw(MILES);
...
sub _map_keyword_themes_to_keyword_infos {
  ...
  foreach my $keyword_theme (@$keyword_themes) {
    if (defined $keyword_theme->{keywordThemeConstant}) {
      push @$keyword_theme_infos,
        Google::Ads::GoogleAds::V25::Common::KeywordThemeInfo->new({
