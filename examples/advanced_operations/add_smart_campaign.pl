...
use Google::Ads::GoogleAds::V19::Resources::PhoneNumber;
use Google::Ads::GoogleAds::V19::Resources::SmartCampaignSetting;
use Google::Ads::GoogleAds::V19::Common::AdScheduleInfo;
use Google::Ads::GoogleAds::V19::Common::KeywordThemeInfo;
use Google::Ads::GoogleAds::V19::Common::LocationInfo;
use Google::Ads::GoogleAds::V19::Common::SmartCampaignAdInfo;
use Google::Ads::GoogleAds::V19::Common::AdTextAsset;
use Google::Ads::GoogleAds::V19::Enums::AdGroupTypeEnum qw(SMART_CAMPAIGN_ADS);
use Google::Ads::GoogleAds::V19::Enums::AdTypeEnum      qw(SMART_CAMPAIGN_AD);
use Google::Ads::GoogleAds::V19::Enums::AdvertisingChannelTypeEnum qw(SMART);
use Google::Ads::GoogleAds::V19::Enums::AdvertisingChannelSubTypeEnum;
use Google::Ads::GoogleAds::V19::Enums::BudgetTypeEnum;
use Google::Ads::GoogleAds::V19::Enums::CampaignStatusEnum       qw(PAUSED);
use Google::Ads::GoogleAds::V19::Enums::DayOfWeekEnum            qw(MONDAY);
use Google::Ads::GoogleAds::V19::Enums::MinuteOfHourEnum         qw(ZERO);
use Google::Ads::GoogleAds::V19::Enums::ProximityRadiusUnitsEnum qw(MILES);
...
use Google::Ads::GoogleAds::V19::Services::GoogleAdsService::MutateOperation;
use
  Google::Ads::GoogleAds::V19::Services::KeywordThemeConstantService::SuggestKeywordThemeConstantsRequest;
use
  Google::Ads::GoogleAds::V19::Services::SmartCampaignSettingService::SmartCampaignSettingOperation;
use
  Google::Ads::GoogleAds::V19::Services::SmartCampaignSuggestService::BusinessContext;
use
  Google::Ads::GoogleAds::V19::Services::SmartCampaignSuggestService::KeywordTheme;
use
  Google::Ads::GoogleAds::V19::Services::SmartCampaignSuggestService::LocationList;
use
  Google::Ads::GoogleAds::V19::Services::SmartCampaignSuggestService::SmartCampaignSuggestionInfo;
use
  Google::Ads::GoogleAds::V19::Services::SmartCampaignSuggestService::SuggestKeywordThemesRequest;
use
  Google::Ads::GoogleAds::V19::Services::SmartCampaignSuggestService::SuggestSmartCampaignAdRequest;
use
  Google::Ads::GoogleAds::V19::Services::SmartCampaignSuggestService::SuggestSmartCampaignBudgetOptionsRequest;
...
sub _get_free_form_keyword_theme_info {
  ...
  return Google::Ads::GoogleAds::V19::Common::KeywordThemeInfo->new({
...
sub _map_keyword_themes_to_keyword_infos {
  ...
  foreach my $keyword_theme (@$keyword_themes) {
    if (defined $keyword_theme->{keywordThemeConstant}) {
      push @$keyword_theme_infos,
        Google::Ads::GoogleAds::V19::Common::KeywordThemeInfo->new({
...
sub _get_smart_campaign_suggestion_info {
  ...
  push @{$suggestion_info->{locationList}{locations}},
    Google::Ads::GoogleAds::V19::Common::LocationInfo->new({
  ...
  push @{$suggestion_info->{adSchedules}},
    Google::Ads::GoogleAds::V19::Common::AdScheduleInfo->new({
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V19::Resources::CampaignBudget->new({
              ...
              type =>
                Google::Ads::GoogleAds::V19::Enums::BudgetTypeEnum::SMART_CAMPAIGN,
        ...
        ->new({
          create => Google::Ads::GoogleAds::V19::Resources::Campaign->new({
              ...
              advertisingChannelSubType =>
                Google::Ads::GoogleAds::V19::Enums::AdvertisingChannelSubTypeEnum::SMART_CAMPAIGN,
...
sub _create_smart_campaign_setting_operation {
  ...
  my $smart_campaign_setting =
    Google::Ads::GoogleAds::V19::Resources::SmartCampaignSetting->new({
      # Set a temporary ID in the campaign setting's resource name to associate it
      # with the campaign created in the previous step.
      resourceName =>
        Google::Ads::GoogleAds::V19::Utils::ResourceNames::smart_campaign_setting(
        $customer_id, SMART_CAMPAIGN_TEMPORARY_ID
        ),
  ...
  return
    ...
    new({
      adGroupOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V19::Resources::AdGroup->new({
...
sub _create_ad_group_ad_operation {
  ...
  my $mutate_operation =
    ...
    new({
      adGroupAdOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V19::Resources::AdGroupAd->new({
              adGroup =>
                # Set the ad group ID to a temporary ID.
                Google::Ads::GoogleAds::V19::Utils::ResourceNames::ad_group(
                $customer_id, AD_GROUP_TEMPORARY_ID
              ...
              ad => Google::Ads::GoogleAds::V19::Resources::Ad->new({
                  ...
                  smartCampaignAd =>
                    Google::Ads::GoogleAds::V19::Common::SmartCampaignAdInfo->
                    new({
                      headlines    => [],
                      descriptions => []})})})})});
  ...
  for (my $i = 0 ; $i < $num_missing_headlines ; $i++) {
    push @{$smart_campaign_ad->{headlines}},
      Google::Ads::GoogleAds::V19::Common::AdTextAsset->new({
