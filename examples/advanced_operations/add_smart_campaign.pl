...
use Google::Ads::GoogleAds::V24::Resources::PhoneNumber;
...
use Google::Ads::GoogleAds::V24::Enums::AdGroupTypeEnum qw(SMART_CAMPAIGN_ADS);
use Google::Ads::GoogleAds::V24::Enums::AdTypeEnum      qw(SMART_CAMPAIGN_AD);
use Google::Ads::GoogleAds::V24::Enums::AdvertisingChannelTypeEnum qw(SMART);
use Google::Ads::GoogleAds::V24::Enums::AdvertisingChannelSubTypeEnum;
use Google::Ads::GoogleAds::V24::Enums::BudgetTypeEnum;
use Google::Ads::GoogleAds::V24::Enums::CampaignStatusEnum       qw(PAUSED);
use Google::Ads::GoogleAds::V24::Enums::DayOfWeekEnum            qw(MONDAY);
use Google::Ads::GoogleAds::V24::Enums::MinuteOfHourEnum         qw(ZERO);
use Google::Ads::GoogleAds::V24::Enums::ProximityRadiusUnitsEnum qw(MILES);
...
use Google::Ads::GoogleAds::V24::Services::AdGroupAdService::AdGroupAdOperation;
use
...
use Google::Ads::GoogleAds::V24::Services::GoogleAdsService::MutateOperation;
use
  Google::Ads::GoogleAds::V24::Services::KeywordThemeConstantService::SuggestKeywordThemeConstantsRequest;
use
  Google::Ads::GoogleAds::V24::Services::SmartCampaignSettingService::SmartCampaignSettingOperation;
use
  Google::Ads::GoogleAds::V24::Services::SmartCampaignSuggestService::BusinessContext;
use
  Google::Ads::GoogleAds::V24::Services::SmartCampaignSuggestService::KeywordTheme;
use
  Google::Ads::GoogleAds::V24::Services::SmartCampaignSuggestService::LocationList;
use
  Google::Ads::GoogleAds::V24::Services::SmartCampaignSuggestService::SmartCampaignSuggestionInfo;
use
  Google::Ads::GoogleAds::V24::Services::SmartCampaignSuggestService::SuggestKeywordThemesRequest;
use
  Google::Ads::GoogleAds::V24::Services::SmartCampaignSuggestService::SuggestSmartCampaignAdRequest;
use
  Google::Ads::GoogleAds::V24::Services::SmartCampaignSuggestService::SuggestSmartCampaignBudgetOptionsRequest;
...
sub _get_free_form_keyword_theme_info {
  ...
  return Google::Ads::GoogleAds::V24::Common::KeywordThemeInfo->new({
...
sub _map_keyword_themes_to_keyword_infos {
  ...
  foreach my $keyword_theme (@$keyword_themes) {
    if (defined $keyword_theme->{keywordThemeConstant}) {
      push @$keyword_theme_infos,
        Google::Ads::GoogleAds::V24::Common::KeywordThemeInfo->new({
...
sub _get_smart_campaign_suggestion_info {
  ...
  push @{$suggestion_info->{adSchedules}},
    Google::Ads::GoogleAds::V24::Common::AdScheduleInfo->new({
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V24::Resources::CampaignBudget->new({
              ...
              type =>
                Google::Ads::GoogleAds::V24::Enums::BudgetTypeEnum::SMART_CAMPAIGN,
  ...
  return
    ...
    new({
      campaignOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V24::Resources::Campaign->new({
              ...
              advertisingChannelSubType =>
                Google::Ads::GoogleAds::V24::Enums::AdvertisingChannelSubTypeEnum::SMART_CAMPAIGN,
  ...
  return
    ...
    new({
      adGroupOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V24::Resources::AdGroup->new({
              # Set the ad group ID to a temporary ID.
              resourceName =>
                Google::Ads::GoogleAds::V24::Utils::ResourceNames::ad_group(
  ...
  my $mutate_operation =
    ...
    new({
      adGroupAdOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V24::Resources::AdGroupAd->new({
              adGroup =>
                # Set the ad group ID to a temporary ID.
                Google::Ads::GoogleAds::V24::Utils::ResourceNames::ad_group(
                $customer_id, AD_GROUP_TEMPORARY_ID
              ...
              ad => Google::Ads::GoogleAds::V24::Resources::Ad->new({
                  ...
                  smartCampaignAd =>
                    Google::Ads::GoogleAds::V24::Common::SmartCampaignAdInfo->
                    new({
                      headlines    => [],
                      descriptions => []})})})})});
