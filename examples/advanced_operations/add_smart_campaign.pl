...
use Google::Ads::GoogleAds::V14::Resources::PhoneNumber;
use Google::Ads::GoogleAds::V14::Resources::SmartCampaignSetting;
use Google::Ads::GoogleAds::V14::Common::AdScheduleInfo;
use Google::Ads::GoogleAds::V14::Common::KeywordThemeInfo;
use Google::Ads::GoogleAds::V14::Common::LocationInfo;
use Google::Ads::GoogleAds::V14::Common::SmartCampaignAdInfo;
use Google::Ads::GoogleAds::V14::Common::AdTextAsset;
use Google::Ads::GoogleAds::V14::Enums::AdGroupTypeEnum qw(SMART_CAMPAIGN_ADS);
use Google::Ads::GoogleAds::V14::Enums::AdTypeEnum      qw(SMART_CAMPAIGN_AD);
use Google::Ads::GoogleAds::V14::Enums::AdvertisingChannelTypeEnum qw(SMART);
use Google::Ads::GoogleAds::V14::Enums::AdvertisingChannelSubTypeEnum;
use Google::Ads::GoogleAds::V14::Enums::BudgetTypeEnum;
use Google::Ads::GoogleAds::V14::Enums::CampaignStatusEnum       qw(PAUSED);
use Google::Ads::GoogleAds::V14::Enums::DayOfWeekEnum            qw(MONDAY);
use Google::Ads::GoogleAds::V14::Enums::MinuteOfHourEnum         qw(ZERO);
use Google::Ads::GoogleAds::V14::Enums::ProximityRadiusUnitsEnum qw(MILES);
...
use Google::Ads::GoogleAds::V14::Services::GoogleAdsService::MutateOperation;
use
  Google::Ads::GoogleAds::V14::Services::KeywordThemeConstantService::SuggestKeywordThemeConstantsRequest;
use
  Google::Ads::GoogleAds::V14::Services::SmartCampaignSettingService::SmartCampaignSettingOperation;
use
  Google::Ads::GoogleAds::V14::Services::SmartCampaignSuggestService::BusinessContext;
use
  Google::Ads::GoogleAds::V14::Services::SmartCampaignSuggestService::KeywordTheme;
use
  Google::Ads::GoogleAds::V14::Services::SmartCampaignSuggestService::LocationList;
use
  Google::Ads::GoogleAds::V14::Services::SmartCampaignSuggestService::SmartCampaignSuggestionInfo;
use
  Google::Ads::GoogleAds::V14::Services::SmartCampaignSuggestService::SuggestKeywordThemesRequest;
use
  Google::Ads::GoogleAds::V14::Services::SmartCampaignSuggestService::SuggestSmartCampaignAdRequest;
use
  Google::Ads::GoogleAds::V14::Services::SmartCampaignSuggestService::SuggestSmartCampaignBudgetOptionsRequest;
...
sub _get_free_form_keyword_theme_info {
  ...
  return Google::Ads::GoogleAds::V14::Common::KeywordThemeInfo->new({
...
sub _map_keyword_themes_to_keyword_infos {
  ...
  foreach my $keyword_theme (@$keyword_themes) {
    if (defined $keyword_theme->{keywordThemeConstant}) {
      push @$keyword_theme_infos,
        Google::Ads::GoogleAds::V14::Common::KeywordThemeInfo->new({
...
sub _get_smart_campaign_suggestion_info {
  ...
  push @{$suggestion_info->{locationList}{locations}},
    Google::Ads::GoogleAds::V14::Common::LocationInfo->new({
  ...
  push @{$suggestion_info->{adSchedules}},
    Google::Ads::GoogleAds::V14::Common::AdScheduleInfo->new({
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V14::Resources::CampaignBudget->new({
              ...
              type =>
                Google::Ads::GoogleAds::V14::Enums::BudgetTypeEnum::SMART_CAMPAIGN,
        ...
        ->new({
          create => Google::Ads::GoogleAds::V14::Resources::Campaign->new({
              ...
              advertisingChannelSubType =>
                Google::Ads::GoogleAds::V14::Enums::AdvertisingChannelSubTypeEnum::SMART_CAMPAIGN,
  ...
  return
    ...
    new({
      adGroupOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V14::Resources::AdGroup->new({
              # Set the ad group ID to a temporary ID.
              resourceName =>
                Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_group(
...
sub _create_ad_group_ad_operation {
  ...
  my $mutate_operation =
    ...
    new({
      adGroupAdOperation =>
        ...
        ->new({
          create => Google::Ads::GoogleAds::V14::Resources::AdGroupAd->new({
              adGroup =>
                # Set the ad group ID to a temporary ID.
                Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_group(
                $customer_id, AD_GROUP_TEMPORARY_ID
              ...
              ad => Google::Ads::GoogleAds::V14::Resources::Ad->new({
                  ...
                  smartCampaignAd =>
                    Google::Ads::GoogleAds::V14::Common::SmartCampaignAdInfo->
                    new({
                      headlines    => [],
                      descriptions => []})})})})});
  ...
  for (my $i = 0 ; $i < $num_missing_headlines ; $i++) {
    push @{$smart_campaign_ad->{headlines}},
      Google::Ads::GoogleAds::V14::Common::AdTextAsset->new({
