...
use Google::Ads::GoogleAds::V8::Enums::SeasonalityEventScopeEnum qw(CHANNEL);
use Google::Ads::GoogleAds::V8::Enums::AdvertisingChannelTypeEnum qw(SEARCH);
use
  Google::Ads::GoogleAds::V8::Services::BiddingSeasonalityAdjustmentService::BiddingSeasonalityAdjustmentOperation;
...
sub add_bidding_seasonality_adjustment {
  ...
  my $seasonality_adjustment =
    Google::Ads::GoogleAds::V8::Resources::BiddingSeasonalityAdjustment->new({
