...
use
  Google::Ads::GoogleAds::V14::Services::BiddingSeasonalityAdjustmentService::BiddingSeasonalityAdjustmentOperation;
...
sub add_bidding_seasonality_adjustment {
  ...
  my $seasonality_adjustment =
    Google::Ads::GoogleAds::V14::Resources::BiddingSeasonalityAdjustment->new({
