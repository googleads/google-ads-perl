...
use Google::Ads::GoogleAds::V19::Resources::BiddingSeasonalityAdjustment;
use Google::Ads::GoogleAds::V19::Enums::SeasonalityEventScopeEnum  qw(CHANNEL);
use Google::Ads::GoogleAds::V19::Enums::AdvertisingChannelTypeEnum qw(SEARCH);
use
  Google::Ads::GoogleAds::V19::Services::BiddingSeasonalityAdjustmentService::BiddingSeasonalityAdjustmentOperation;
...
sub add_bidding_seasonality_adjustment {
  ...
  my $seasonality_adjustment =
    Google::Ads::GoogleAds::V19::Resources::BiddingSeasonalityAdjustment->new({
