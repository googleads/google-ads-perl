...
use Google::Ads::GoogleAds::V9::Resources::BiddingSeasonalityAdjustment;
use Google::Ads::GoogleAds::V9::Enums::SeasonalityEventScopeEnum qw(CHANNEL);
use Google::Ads::GoogleAds::V9::Enums::AdvertisingChannelTypeEnum qw(SEARCH);
use
  Google::Ads::GoogleAds::V9::Services::BiddingSeasonalityAdjustmentService::BiddingSeasonalityAdjustmentOperation;
...
sub add_bidding_seasonality_adjustment {
  ...
  my $seasonality_adjustment =
    Google::Ads::GoogleAds::V9::Resources::BiddingSeasonalityAdjustment->new({
