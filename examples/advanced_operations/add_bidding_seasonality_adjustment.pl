...
use Google::Ads::GoogleAds::V13::Resources::BiddingSeasonalityAdjustment;
use Google::Ads::GoogleAds::V13::Enums::SeasonalityEventScopeEnum  qw(CHANNEL);
use Google::Ads::GoogleAds::V13::Enums::AdvertisingChannelTypeEnum qw(SEARCH);
use
  Google::Ads::GoogleAds::V13::Services::BiddingSeasonalityAdjustmentService::BiddingSeasonalityAdjustmentOperation;
...
sub add_bidding_seasonality_adjustment {
  ...
  my $seasonality_adjustment =
    Google::Ads::GoogleAds::V13::Resources::BiddingSeasonalityAdjustment->new({
