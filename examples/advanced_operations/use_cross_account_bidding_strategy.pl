...
use Google::Ads::GoogleAds::V24::Resources::BiddingStrategy;
...
use
  Google::Ads::GoogleAds::V24::Services::BiddingStrategyService::BiddingStrategyOperation;
...
sub _create_bidding_strategy {
  ...
  my $portfolio_bidding_strategy =
    Google::Ads::GoogleAds::V24::Resources::BiddingStrategy->new({
