...
use Google::Ads::GoogleAds::V9::Resources::BiddingStrategy;
use Google::Ads::GoogleAds::V9::Resources::Campaign;
use Google::Ads::GoogleAds::V9::Common::TargetSpend;
use
  Google::Ads::GoogleAds::V9::Services::GoogleAdsService::SearchGoogleAdsStreamRequest;
use
  Google::Ads::GoogleAds::V9::Services::BiddingStrategyService::BiddingStrategyOperation;
...
sub _create_bidding_strategy {
  ...
  my $portfolio_bidding_strategy =
    Google::Ads::GoogleAds::V9::Resources::BiddingStrategy->new({
      name        => "Maximize clicks #" . uniqid(),
      targetSpend => Google::Ads::GoogleAds::V9::Common::TargetSpend->new(),
