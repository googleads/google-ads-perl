...
use Google::Ads::GoogleAds::V22::Resources::AssetSet;
use Google::Ads::GoogleAds::V22::Resources::AssetSetAsset;
use Google::Ads::GoogleAds::V22::Resources::CampaignAssetSet;
use Google::Ads::GoogleAds::V22::Resources::AdGroupCriterion;
use Google::Ads::GoogleAds::V22::Common::PageFeedAsset;
use Google::Ads::GoogleAds::V22::Common::WebpageConditionInfo;
use Google::Ads::GoogleAds::V22::Common::WebpageInfo;
use Google::Ads::GoogleAds::V22::Enums::AssetSetTypeEnum qw(PAGE_FEED);
use Google::Ads::GoogleAds::V22::Enums::WebpageConditionOperandEnum
  qw(CUSTOM_LABEL);
use Google::Ads::GoogleAds::V22::Services::AssetService::AssetOperation;
use Google::Ads::GoogleAds::V22::Services::AssetSetService::AssetSetOperation;
use
  Google::Ads::GoogleAds::V22::Services::AssetSetAssetService::AssetSetAssetOperation;
use
  Google::Ads::GoogleAds::V22::Services::CampaignAssetSetService::CampaignAssetSetOperation;
use
...
sub create_assets {
  ...
  foreach my $url (@$urls) {
    my $page_feed_asset =
      Google::Ads::GoogleAds::V22::Common::PageFeedAsset->new({
...
sub create_asset_set {
  ...
  # a campaign.
  my $asset_set = Google::Ads::GoogleAds::V22::Resources::AssetSet->new({
  ...
  my $operation =
    Google::Ads::GoogleAds::V22::Services::AssetSetService::AssetSetOperation->
    new({
      create => $asset_set
    });
...
sub add_assets_to_asset_set {
  ...
  foreach my $asset_resource_name (@$asset_resource_names) {
    my $asset_set_asset =
      Google::Ads::GoogleAds::V22::Resources::AssetSetAsset->new({
...
sub link_asset_set_to_campaign {
  ...
  my $campaign_asset_set =
    Google::Ads::GoogleAds::V22::Resources::CampaignAssetSet->new({
...
sub add_dsa_target {
  ...
  my $webpage_condition_info =
    Google::Ads::GoogleAds::V22::Common::WebpageConditionInfo->new({
  ...
  my $webpage_info = Google::Ads::GoogleAds::V22::Common::WebpageInfo->new({
