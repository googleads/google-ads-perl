...
use Google::Ads::GoogleAds::V24::Resources::CampaignAssetSet;
use Google::Ads::GoogleAds::V24::Resources::AdGroupCriterion;
use Google::Ads::GoogleAds::V24::Common::PageFeedAsset;
use Google::Ads::GoogleAds::V24::Common::WebpageConditionInfo;
use Google::Ads::GoogleAds::V24::Common::WebpageInfo;
use Google::Ads::GoogleAds::V24::Enums::AssetSetTypeEnum qw(PAGE_FEED);
use Google::Ads::GoogleAds::V24::Enums::WebpageConditionOperandEnum
  qw(CUSTOM_LABEL);
...
use
  Google::Ads::GoogleAds::V24::Services::CampaignAssetSetService::CampaignAssetSetOperation;
use
...
sub create_assets {
  ...
  foreach my $url (@$urls) {
    my $page_feed_asset =
      Google::Ads::GoogleAds::V24::Common::PageFeedAsset->new({
    ...
    my $asset = Google::Ads::GoogleAds::V24::Resources::Asset->new({
...
sub create_asset_set {
  ...
  # a campaign.
  my $asset_set = Google::Ads::GoogleAds::V24::Resources::AssetSet->new({
...
sub add_assets_to_asset_set {
  ...
  foreach my $asset_resource_name (@$asset_resource_names) {
    my $asset_set_asset =
      Google::Ads::GoogleAds::V24::Resources::AssetSetAsset->new({
...
sub link_asset_set_to_campaign {
  ...
  my $campaign_asset_set =
    Google::Ads::GoogleAds::V24::Resources::CampaignAssetSet->new({
...
sub add_dsa_target {
  ...
  my $webpage_info = Google::Ads::GoogleAds::V24::Common::WebpageInfo->new({
