...
use Google::Ads::GoogleAds::V25::Resources::CampaignAssetSet;
use Google::Ads::GoogleAds::V25::Resources::AdGroupCriterion;
use Google::Ads::GoogleAds::V25::Common::PageFeedAsset;
use Google::Ads::GoogleAds::V25::Common::WebpageConditionInfo;
use Google::Ads::GoogleAds::V25::Common::WebpageInfo;
use Google::Ads::GoogleAds::V25::Enums::AssetSetTypeEnum qw(PAGE_FEED);
...
sub add_dsa_target {
  ...
  my $webpage_info = Google::Ads::GoogleAds::V25::Common::WebpageInfo->new({
