...
use Google::Ads::GoogleAds::V10::Resources::AssetSet;
use Google::Ads::GoogleAds::V10::Resources::AssetSetAsset;
use Google::Ads::GoogleAds::V10::Resources::CampaignAssetSet;
use Google::Ads::GoogleAds::V10::Resources::AdGroupCriterion;
use Google::Ads::GoogleAds::V10::Common::PageFeedAsset;
use Google::Ads::GoogleAds::V10::Common::WebpageConditionInfo;
use Google::Ads::GoogleAds::V10::Common::WebpageInfo;
use Google::Ads::GoogleAds::V10::Enums::AssetSetTypeEnum qw(PAGE_FEED);
...
use Google::Ads::GoogleAds::V10::Services::AssetSetService::AssetSetOperation;
use
  Google::Ads::GoogleAds::V10::Services::AssetSetAssetService::AssetSetAssetOperation;
use
  Google::Ads::GoogleAds::V10::Services::CampaignAssetSetService::CampaignAssetSetOperation;
use
...
sub create_assets {
  ...
  foreach my $url (@$urls) {
    my $page_feed_asset =
      Google::Ads::GoogleAds::V10::Common::PageFeedAsset->new({
...
sub create_asset_set {
  ...
  # a campaign.
  my $asset_set = Google::Ads::GoogleAds::V10::Resources::AssetSet->new({
  ...
  my $operation =
    Google::Ads::GoogleAds::V10::Services::AssetSetService::AssetSetOperation->
    new({
      create => $asset_set
    });
...
sub add_assets_to_asset_set {
  my ($api_client, $customer_id, $asset_resource_names,
    $asset_set_resource_name) = @_;

  # [START add_asset_set_asset]
  my $operations = [];
  foreach my $asset_resource_name (@$asset_resource_names) {
    my $asset_set_asset =
      Google::Ads::GoogleAds::V10::Resources::AssetSetAsset->new({
...
sub link_asset_set_to_campaign {
  ...
  my $campaign_asset_set =
    Google::Ads::GoogleAds::V10::Resources::CampaignAssetSet->new({
...
sub add_dsa_target {
  ...
  my $webpage_info = Google::Ads::GoogleAds::V10::Common::WebpageInfo->new({
