...
use Google::Ads::GoogleAds::V14::Resources::CampaignAssetSet;
use Google::Ads::GoogleAds::V14::Resources::AdGroupCriterion;
use Google::Ads::GoogleAds::V14::Common::PageFeedAsset;
use Google::Ads::GoogleAds::V14::Common::WebpageConditionInfo;
use Google::Ads::GoogleAds::V14::Common::WebpageInfo;
use Google::Ads::GoogleAds::V14::Enums::AssetSetTypeEnum qw(PAGE_FEED);
use Google::Ads::GoogleAds::V14::Enums::WebpageConditionOperandEnum
  qw(CUSTOM_LABEL);
...
use
  Google::Ads::GoogleAds::V14::Services::CampaignAssetSetService::CampaignAssetSetOperation;
use
  Google::Ads::GoogleAds::V14::Services::AdGroupCriterionService::AdGroupCriterionOperation;
...
sub create_assets {
  ...
  foreach my $url (@$urls) {
    my $page_feed_asset =
      Google::Ads::GoogleAds::V14::Common::PageFeedAsset->new({
...
sub create_asset_set {
  ...
  # a campaign.
  my $asset_set = Google::Ads::GoogleAds::V14::Resources::AssetSet->new({
...
sub add_assets_to_asset_set {
  ...
  foreach my $asset_resource_name (@$asset_resource_names) {
    my $asset_set_asset =
      Google::Ads::GoogleAds::V14::Resources::AssetSetAsset->new({
...
sub link_asset_set_to_campaign {
  ...
  my $campaign_asset_set =
    Google::Ads::GoogleAds::V14::Resources::CampaignAssetSet->new({
...
sub add_dsa_target {
  ...
  my $ad_group_resource_name =
    Google::Ads::GoogleAds::V14::Utils::ResourceNames::ad_group($customer_id,
    $ad_group_id);
  ...
  my $webpage_condition_info =
    Google::Ads::GoogleAds::V14::Common::WebpageConditionInfo->new({
  ...
  my $webpage_info = Google::Ads::GoogleAds::V14::Common::WebpageInfo->new({
      criterionName => "Test Criterion",
      conditions    => [$webpage_condition_info]});

  # Create the ad group criterion.
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V14::Resources::AdGroupCriterion->new({
