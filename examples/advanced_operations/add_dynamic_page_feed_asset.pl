...
use Google::Ads::GoogleAds::V18::Enums::AssetSetTypeEnum qw(PAGE_FEED);
use Google::Ads::GoogleAds::V18::Enums::WebpageConditionOperandEnum
  qw(CUSTOM_LABEL);
...
use
  Google::Ads::GoogleAds::V18::Services::CampaignAssetSetService::CampaignAssetSetOperation;
use
...
sub create_assets {
  ...
  foreach my $url (@$urls) {
    my $page_feed_asset =
      Google::Ads::GoogleAds::V18::Common::PageFeedAsset->new({
    ...
    my $asset = Google::Ads::GoogleAds::V18::Resources::Asset->new({
      pageFeedAsset => $page_feed_asset
    });

    push @$asset_operations,
      Google::Ads::GoogleAds::V18::Services::AssetService::AssetOperation->new({
        create => $asset
      });
  }
...
sub create_asset_set {
  ...
  # a campaign.
  my $asset_set = Google::Ads::GoogleAds::V18::Resources::AssetSet->new({
...
sub add_assets_to_asset_set {
  ...
  foreach my $asset_resource_name (@$asset_resource_names) {
    my $asset_set_asset =
      Google::Ads::GoogleAds::V18::Resources::AssetSetAsset->new({
...
sub link_asset_set_to_campaign {
  ...
  my $campaign_asset_set =
    Google::Ads::GoogleAds::V18::Resources::CampaignAssetSet->new({
...
sub add_dsa_target {
  ...
  my $ad_group_resource_name =
    Google::Ads::GoogleAds::V18::Utils::ResourceNames::ad_group($customer_id,
    $ad_group_id);
  ...
  my $webpage_condition_info =
    Google::Ads::GoogleAds::V18::Common::WebpageConditionInfo->new({
  ...
  my $webpage_info = Google::Ads::GoogleAds::V18::Common::WebpageInfo->new({
