...
use Google::Ads::GoogleAds::V24::Common::AdMediaBundleAsset;
use Google::Ads::GoogleAds::V24::Common::DisplayUploadAdInfo;
use Google::Ads::GoogleAds::V24::Common::MediaBundleAsset;
use Google::Ads::GoogleAds::V24::Enums::AdGroupAdStatusEnum qw(PAUSED);
use Google::Ads::GoogleAds::V24::Enums::DisplayUploadProductTypeEnum
  qw(HTML5_UPLOAD_AD);
use Google::Ads::GoogleAds::V24::Enums::AssetTypeEnum qw(MEDIA_BUNDLE);
...
sub create_media_bundle_asset {
  ...
  my $asset = Google::Ads::GoogleAds::V24::Resources::Asset->new({
      ...
      type             => MEDIA_BUNDLE,
      mediaBundleAsset =>
        Google::Ads::GoogleAds::V24::Common::MediaBundleAsset->new({
          data => $bundle_content
        })});
