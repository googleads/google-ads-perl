...
sub create_media_bundle_asset {
  ...
  my $asset = Google::Ads::GoogleAds::V19::Resources::Asset->new({
      ...
      type             => MEDIA_BUNDLE,
      mediaBundleAsset =>
        Google::Ads::GoogleAds::V19::Common::MediaBundleAsset->new({
          data => $bundle_content
        })});
...
sub create_display_upload_ad_group_ad {
  ...
  my $display_upload_ad_info =
    Google::Ads::GoogleAds::V19::Common::DisplayUploadAdInfo->new({
      displayUploadProductType => HTML5_UPLOAD_AD,
      mediaBundle              =>
        Google::Ads::GoogleAds::V19::Common::AdMediaBundleAsset->new({
