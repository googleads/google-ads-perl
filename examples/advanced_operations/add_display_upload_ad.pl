...
use Google::Ads::GoogleAds::V10::Common::AdMediaBundleAsset;
use Google::Ads::GoogleAds::V10::Common::DisplayUploadAdInfo;
use Google::Ads::GoogleAds::V10::Common::MediaBundleAsset;
use Google::Ads::GoogleAds::V10::Enums::AdGroupAdStatusEnum qw(PAUSED);
use Google::Ads::GoogleAds::V10::Enums::DisplayUploadProductTypeEnum
  qw(HTML5_UPLOAD_AD);
use Google::Ads::GoogleAds::V10::Enums::AssetTypeEnum qw(MEDIA_BUNDLE);
...
sub create_media_bundle_asset {
  ...
  my $asset = Google::Ads::GoogleAds::V10::Resources::Asset->new({
      ...
      type             => MEDIA_BUNDLE,
      mediaBundleAsset =>
        Google::Ads::GoogleAds::V10::Common::MediaBundleAsset->new({
          data => $bundle_content
        })});
...
sub create_display_upload_ad_group_ad {
  ...
  my $display_upload_ad_info =
    Google::Ads::GoogleAds::V10::Common::DisplayUploadAdInfo->new({
      displayUploadProductType => HTML5_UPLOAD_AD,
      mediaBundle              =>
        Google::Ads::GoogleAds::V10::Common::AdMediaBundleAsset->new({
          asset => $ad_asset_resource_name,
        })});

  # Create a display upload ad.
  my $display_upload_ad = Google::Ads::GoogleAds::V10::Resources::Ad->new({
    name      => "Ad for HTML5",
