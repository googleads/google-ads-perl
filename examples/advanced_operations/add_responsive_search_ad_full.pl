...
use Google::Ads::GoogleAds::V24::Resources::CustomizerAttribute;
use Google::Ads::GoogleAds::V24::Resources::CustomerCustomizer;
...
use Google::Ads::GoogleAds::V24::Common::CustomizerValue;
use Google::Ads::GoogleAds::V24::Common::ImageDimension;
use Google::Ads::GoogleAds::V24::Common::KeywordInfo;
use Google::Ads::GoogleAds::V24::Common::LocationInfo;
use Google::Ads::GoogleAds::V24::Common::ResponsiveSearchAdInfo;
use Google::Ads::GoogleAds::V24::Common::TargetSpend;
...
use Google::Ads::GoogleAds::V24::Enums::CustomizerAttributeTypeEnum qw(PRICE);
use Google::Ads::GoogleAds::V24::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V24::Enums::AdGroupCriterionStatusEnum;
use Google::Ads::GoogleAds::V24::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V24::Enums::AdGroupTypeEnum    qw(SEARCH_STANDARD);
use Google::Ads::GoogleAds::V24::Enums::AssetTypeEnum      qw(IMAGE);
use Google::Ads::GoogleAds::V24::Enums::CampaignStatusEnum qw(PAUSED);
use Google::Ads::GoogleAds::V24::Enums::KeywordMatchTypeEnum
  qw(BROAD EXACT PHRASE);
use Google::Ads::GoogleAds::V24::Enums::MimeTypeEnum             qw(IMAGE_PNG);
use Google::Ads::GoogleAds::V24::Enums::ServedAssetFieldTypeEnum qw(HEADLINE_1);
...
use
  Google::Ads::GoogleAds::V24::Services::CustomizerAttributeService::CustomizerAttributeOperation;
use
  Google::Ads::GoogleAds::V24::Services::CustomerCustomizerService::CustomerCustomizerOperation;
use
...
sub create_customizer_attribute {
  ...
  my $customizer_attribute =
    Google::Ads::GoogleAds::V24::Resources::CustomizerAttribute->new({
...
sub link_customizer_attribute_to_customer {
  ...
  my $customer_customizer =
    Google::Ads::GoogleAds::V24::Resources::CustomerCustomizer->new({
      ...
      value => Google::Ads::GoogleAds::V24::Common::CustomizerValue->new({
          type        => PRICE,
          stringValue => "100USD"
        })});
...
sub create_ad_text_asset {
  ...
  my $ad_text_asset = Google::Ads::GoogleAds::V24::Common::AdTextAsset->new({
    text => $text
  });
...
sub create_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V24::Resources::Campaign->new({
      ...
      targetSpend => Google::Ads::GoogleAds::V24::Common::TargetSpend->new(),
...
sub add_keywords {
  ...
  foreach my $keyword (keys %$keywords) {
    my $keyword_info = Google::Ads::GoogleAds::V24::Common::KeywordInfo->new({
    ...
    my $ad_group_criterion =
      Google::Ads::GoogleAds::V24::Resources::AdGroupCriterion->new({
        adGroup => $ad_group_resource_name,
        status  =>
          Google::Ads::GoogleAds::V24::Enums::AdGroupCriterionStatusEnum::ENABLED,
