...
use Google::Ads::GoogleAds::V17::Common::ImageDimension;
...
use Google::Ads::GoogleAds::V17::Enums::CustomizerAttributeTypeEnum qw(PRICE);
...
use Google::Ads::GoogleAds::V17::Enums::KeywordMatchTypeEnum
  qw(BROAD EXACT PHRASE);
use Google::Ads::GoogleAds::V17::Enums::MimeTypeEnum             qw(IMAGE_PNG);
...
use
  Google::Ads::GoogleAds::V17::Services::CustomerCustomizerService::CustomerCustomizerOperation;
use
...
sub link_customizer_attribute_to_customer {
  ...
  my $customer_customizer =
    Google::Ads::GoogleAds::V17::Resources::CustomerCustomizer->new({
...
sub create_ad_text_asset {
  ...
  my $ad_text_asset = Google::Ads::GoogleAds::V17::Common::AdTextAsset->new({
    text => $text
  });
