...
use
  Google::Ads::GoogleAds::V12::Services::BiddingStrategyService::BiddingStrategyOperation;
use
...
sub create_bidding_strategy {
  ...
  my $portfolio_bidding_strategy =
    Google::Ads::GoogleAds::V12::Resources::BiddingStrategy->new({
      name        => "Maximize Clicks #" . uniqid(),
      targetSpend => Google::Ads::GoogleAds::V12::Common::TargetSpend->new({
