...
use Google::Ads::GoogleAds::V7::Resources::BiddingStrategy;
...
use Google::Ads::GoogleAds::V7::Common::TargetSpend;
...
use
  Google::Ads::GoogleAds::V7::Services::BiddingStrategyService::BiddingStrategyOperation;
use
...
sub create_bidding_strategy {
  ...
  my $portfolio_bidding_strategy =
    Google::Ads::GoogleAds::V7::Resources::BiddingStrategy->new({
      name        => "Maximize Clicks #" . uniqid(),
      targetSpend => Google::Ads::GoogleAds::V7::Common::TargetSpend->new({
