...
use Google::Ads::GoogleAds::V19::Resources::BiddingStrategy;
...
use Google::Ads::GoogleAds::V19::Common::TargetSpend;
...
use
  Google::Ads::GoogleAds::V19::Services::BiddingStrategyService::BiddingStrategyOperation;
use
...
sub create_bidding_strategy {
  ...
  my $portfolio_bidding_strategy =
    Google::Ads::GoogleAds::V19::Resources::BiddingStrategy->new({
