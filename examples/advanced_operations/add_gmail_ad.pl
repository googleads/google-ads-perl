...
use Google::Ads::GoogleAds::V4::Enums::MediaTypeEnum qw(IMAGE);
use Google::Ads::GoogleAds::V4::Enums::MimeTypeEnum qw(IMAGE_PNG IMAGE_JPEG);
use Google::Ads::GoogleAds::V4::Services::AdGroupAdService::AdGroupAdOperation;
use Google::Ads::GoogleAds::V4::Services::MediaFileService::MediaFileOperation;
...
sub add_gmail_ad {
  ...
  my $gmail_ad_info = Google::Ads::GoogleAds::V4::Common::GmailAdInfo->new({
      # Set the teaser information.
      teaser => Google::Ads::GoogleAds::V4::Common::GmailTeaser->new({
          headline     => "Dream",
  ...
  my $ad = Google::Ads::GoogleAds::V4::Resources::Ad->new({
...
sub add_media_files {
  ...
  my $logo_media_file = Google::Ads::GoogleAds::V4::Resources::MediaFile->new({
      type  => IMAGE,
      image => Google::Ads::GoogleAds::V4::Resources::MediaImage->new({
  ...
  my $logo_media_file_operation =
    Google::Ads::GoogleAds::V4::Services::MediaFileService::MediaFileOperation
    ->new({
  ...
  my $marketing_media_file =
    Google::Ads::GoogleAds::V4::Resources::MediaFile->new({
      type  => IMAGE,
      image => Google::Ads::GoogleAds::V4::Resources::MediaImage->new({
