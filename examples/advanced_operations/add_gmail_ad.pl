...
use Google::Ads::GoogleAds::V5::Enums::MimeTypeEnum qw(IMAGE_PNG IMAGE_JPEG);
...
sub add_gmail_ad {
  ...
  my $gmail_ad_info = Google::Ads::GoogleAds::V5::Common::GmailAdInfo->new({
      # Set the teaser information.
      teaser => Google::Ads::GoogleAds::V5::Common::GmailTeaser->new({
          headline     => "Dream",
...
sub add_media_files {
  ...
  my $logo_media_file = Google::Ads::GoogleAds::V5::Resources::MediaFile->new({
      type  => IMAGE,
      image => Google::Ads::GoogleAds::V5::Resources::MediaImage->new({
  ...
  my $marketing_media_file =
    Google::Ads::GoogleAds::V5::Resources::MediaFile->new({
      type  => IMAGE,
      image => Google::Ads::GoogleAds::V5::Resources::MediaImage->new({
