...
use Google::Ads::GoogleAds::V3::Common::GmailAdInfo;
use Google::Ads::GoogleAds::V3::Common::GmailTeaser;
use Google::Ads::GoogleAds::V3::Enums::AdGroupAdStatusEnum qw(PAUSED);
use Google::Ads::GoogleAds::V3::Enums::MediaTypeEnum qw(IMAGE);
use Google::Ads::GoogleAds::V3::Enums::MimeTypeEnum qw(IMAGE_PNG IMAGE_JPEG);
...
sub add_gmail_ad {
  ...
  my $gmail_ad_info = Google::Ads::GoogleAds::V3::Common::GmailAdInfo->new({
      # Set the teaser information.
      teaser => Google::Ads::GoogleAds::V3::Common::GmailTeaser->new({
          headline     => "Dream",
...
sub add_media_files {
  ...
  my $logo_media_file = Google::Ads::GoogleAds::V3::Resources::MediaFile->new({
      type  => IMAGE,
  ...
  my $marketing_media_file =
    Google::Ads::GoogleAds::V3::Resources::MediaFile->new({
      type  => IMAGE,
      image => Google::Ads::GoogleAds::V3::Resources::MediaImage->new({
