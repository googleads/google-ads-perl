...
use Google::Ads::GoogleAds::V10::Resources::BiddingDataExclusion;
...
use
  Google::Ads::GoogleAds::V10::Services::BiddingDataExclusionService::BiddingDataExclusionOperation;
...
sub add_bidding_data_exclusion {
  ...
  my $data_exclusion =
    Google::Ads::GoogleAds::V10::Resources::BiddingDataExclusion->new({
