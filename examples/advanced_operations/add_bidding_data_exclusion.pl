...
use
  Google::Ads::GoogleAds::V18::Services::BiddingDataExclusionService::BiddingDataExclusionOperation;
...
sub add_bidding_data_exclusion {
  ...
  my $data_exclusion =
    Google::Ads::GoogleAds::V18::Resources::BiddingDataExclusion->new({
