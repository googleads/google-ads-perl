...
use Google::Ads::GoogleAds::V13::Resources::BiddingDataExclusion;
...
use
  Google::Ads::GoogleAds::V13::Services::BiddingDataExclusionService::BiddingDataExclusionOperation;
...
sub add_bidding_data_exclusion {
  ...
  my $data_exclusion =
    Google::Ads::GoogleAds::V13::Resources::BiddingDataExclusion->new({
