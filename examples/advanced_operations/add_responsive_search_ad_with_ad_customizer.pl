...
use Google::Ads::GoogleAds::V15::Resources::CustomerCustomizer;
...
use Google::Ads::GoogleAds::V15::Enums::CustomizerAttributeTypeEnum qw(PRICE);
...
use
  Google::Ads::GoogleAds::V15::Services::CustomerCustomizerService::CustomerCustomizerOperation;
...
sub link_customizer_attribute_to_customer {
  ...
  my $customer_customizer =
    Google::Ads::GoogleAds::V15::Resources::CustomerCustomizer->new({
