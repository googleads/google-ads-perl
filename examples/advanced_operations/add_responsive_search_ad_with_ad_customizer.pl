...
use Google::Ads::GoogleAds::V11::Resources::CustomerCustomizer;
...
use Google::Ads::GoogleAds::V11::Enums::CustomizerAttributeTypeEnum qw(PRICE);
...
use
  Google::Ads::GoogleAds::V11::Services::CustomerCustomizerService::CustomerCustomizerOperation;
...
sub link_customizer_attribute_to_customer {
  ...
  my $customer_customizer =
    Google::Ads::GoogleAds::V11::Resources::CustomerCustomizer->new({
