...
use Google::Ads::GoogleAds::V9::Resources::CustomizerAttribute;
use Google::Ads::GoogleAds::V9::Resources::CustomerCustomizer;
use Google::Ads::GoogleAds::V9::Resources::Ad;
use Google::Ads::GoogleAds::V9::Resources::AdGroupAd;
use Google::Ads::GoogleAds::V9::Common::CustomizerValue;
use Google::Ads::GoogleAds::V9::Common::ResponsiveSearchAdInfo;
use Google::Ads::GoogleAds::V9::Common::TextAsset;
use Google::Ads::GoogleAds::V9::Enums::CustomizerAttributeTypeEnum qw(PRICE);
use Google::Ads::GoogleAds::V9::Enums::AdGroupAdStatusEnum qw(PAUSED);
use
  Google::Ads::GoogleAds::V9::Services::CustomizerAttributeService::CustomizerAttributeOperation;
use
  Google::Ads::GoogleAds::V9::Services::CustomerCustomizerService::CustomerCustomizerOperation;
...
sub create_customizer_attribute {
  ...
  my $customizer_attribute =
    Google::Ads::GoogleAds::V9::Resources::CustomizerAttribute->new({
...
sub link_customizer_attribute_to_customer {
  ...
  my $customer_customizer =
    Google::Ads::GoogleAds::V9::Resources::CustomerCustomizer->new({
      ...
      value => Google::Ads::GoogleAds::V9::Common::CustomizerValue->new({
          type        => PRICE,
          stringValue => "100USD"
        })});
...
sub create_responsive_search_ad_with_customization {
  ...
  my $ad = Google::Ads::GoogleAds::V9::Resources::Ad->new({
      responsiveSearchAd =>
        Google::Ads::GoogleAds::V9::Common::ResponsiveSearchAdInfo->new({
          headlines => [
            Google::Ads::GoogleAds::V9::Common::TextAsset->new({
                text => "Cruise to Mars"
              }
            ),
            Google::Ads::GoogleAds::V9::Common::TextAsset->new({
