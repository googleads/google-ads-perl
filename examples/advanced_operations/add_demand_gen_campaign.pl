...
use Google::Ads::GoogleAds::V24::Resources::DemandGenAdGroupSettings;
use Google::Ads::GoogleAds::V24::Resources::DemandGenChannelControls;
use Google::Ads::GoogleAds::V24::Resources::DemandGenSelectedChannels;
...
use Google::Ads::GoogleAds::V24::Common::AdVideoAsset;
use Google::Ads::GoogleAds::V24::Common::DemandGenVideoResponsiveAdInfo;
use Google::Ads::GoogleAds::V24::Common::ImageAsset;
use Google::Ads::GoogleAds::V24::Common::YoutubeVideoAsset;
...
sub add_demand_gen_campaign {
  ...
  my $ad_group_resource_name =
    Google::Ads::GoogleAds::V24::Utils::ResourceNames::ad_group($customer_id,
  ...
  my $campaign_operation =
    ...
    new({
      create => Google::Ads::GoogleAds::V24::Resources::Campaign->new({
          ...
          targetCpa => Google::Ads::GoogleAds::V24::Common::TargetCpa->new({
    ...
    new({
      create => Google::Ads::GoogleAds::V24::Resources::AdGroup->new({
          ...
          demandGenAdGroupSettings =>
            Google::Ads::GoogleAds::V24::Resources::DemandGenAdGroupSettings->
            new({
              channelControls =>
                Google::Ads::GoogleAds::V24::Resources::DemandGenChannelControls
                ->new({
                  selectedChannels =>
                    Google::Ads::GoogleAds::V24::Resources::DemandGenSelectedChannels
                    ->new({
                      gmail           => "false",
                      discover        => "false",
                      display         => "false",
      ...
      create => Google::Ads::GoogleAds::V24::Resources::AdGroupAd->new({
          ...
          ad      => Google::Ads::GoogleAds::V24::Resources::Ad->new({
              ...
              demandGenVideoResponsiveAd =>
                Google::Ads::GoogleAds::V24::Common::DemandGenVideoResponsiveAdInfo
                ->new({
                  businessName =>
                  ...
                  videos => [
                    Google::Ads::GoogleAds::V24::Common::AdVideoAsset->new({
