...
use Google::Ads::GoogleAds::V25::Resources::DemandGenAdGroupSettings;
use Google::Ads::GoogleAds::V25::Resources::DemandGenChannelControls;
use Google::Ads::GoogleAds::V25::Resources::DemandGenSelectedChannels;
...
use Google::Ads::GoogleAds::V25::Common::AdVideoAsset;
use Google::Ads::GoogleAds::V25::Common::DemandGenVideoResponsiveAdInfo;
use Google::Ads::GoogleAds::V25::Common::ImageAsset;
use Google::Ads::GoogleAds::V25::Common::YoutubeVideoAsset;
    ...
    new({
      create => Google::Ads::GoogleAds::V25::Resources::AdGroup->new({
          ...
          demandGenAdGroupSettings =>
            Google::Ads::GoogleAds::V25::Resources::DemandGenAdGroupSettings->
            new({
              channelControls =>
                Google::Ads::GoogleAds::V25::Resources::DemandGenChannelControls
                ->new({
                  selectedChannels =>
                    Google::Ads::GoogleAds::V25::Resources::DemandGenSelectedChannels
                    ->new({
                      gmail           => "false",
                      discover        => "false",
                      display         => "false",
      ...
      create => Google::Ads::GoogleAds::V25::Resources::AdGroupAd->new({
          ...
          ad      => Google::Ads::GoogleAds::V25::Resources::Ad->new({
              ...
              demandGenVideoResponsiveAd =>
                Google::Ads::GoogleAds::V25::Common::DemandGenVideoResponsiveAdInfo
                ->new({
                  businessName =>
                  ...
                  videos => [
                    Google::Ads::GoogleAds::V25::Common::AdVideoAsset->new({
  ...
  my $asset_operation =
    Google::Ads::GoogleAds::V25::Services::AssetService::AssetOperation->new({
      create => Google::Ads::GoogleAds::V25::Resources::Asset->new({
          ...
          imageAsset   => Google::Ads::GoogleAds::V25::Common::ImageAsset->new({
              data => $image_content
            }
          ),
  ...
  my $asset_operation =
    Google::Ads::GoogleAds::V25::Services::AssetService::AssetOperation->new({
      create => Google::Ads::GoogleAds::V25::Resources::Asset->new({
          ...
          name              => $asset_name,
          youtubeVideoAsset =>
            Google::Ads::GoogleAds::V25::Common::YoutubeVideoAsset->new({
