...
use Google::Ads::GoogleAds::V25::Enums::PolicyApprovalStatusEnum
  qw(DISAPPROVED);
use
  Google::Ads::GoogleAds::V25::Services::GoogleAdsService::SearchGoogleAdsRequest;
use Google::Ads::GoogleAds::V25::Services::GoogleAdsService::SearchSettings;
...
sub get_all_disapproved_ads {
  ...
  my $search_request =
    ...
    ->new({
      ...
      query          => $search_query,
      searchSettings =>
        Google::Ads::GoogleAds::V25::Services::GoogleAdsService::SearchSettings
        ->new({
