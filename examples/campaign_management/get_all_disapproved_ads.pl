...
use Google::Ads::GoogleAds::V21::Enums::PolicyApprovalStatusEnum
  qw(DISAPPROVED);
use
  Google::Ads::GoogleAds::V21::Services::GoogleAdsService::SearchGoogleAdsRequest;
use Google::Ads::GoogleAds::V21::Services::GoogleAdsService::SearchSettings;
...
sub get_all_disapproved_ads {
  ...
  my $search_request =
    ...
    ->new({
      ...
      query          => $search_query,
      searchSettings =>
        Google::Ads::GoogleAds::V21::Services::GoogleAdsService::SearchSettings
        ->new({
