...
use
  Google::Ads::GoogleAds::V18::Services::CampaignLabelService::CampaignLabelOperation;
...
sub add_campaign_labels {
  ...
  my $label_resource_name =
    Google::Ads::GoogleAds::V18::Utils::ResourceNames::label($customer_id,
    $label_id);
  ...
  foreach my $campaign_id (@$campaign_ids) {
    ...
    my $campaign_label =
      Google::Ads::GoogleAds::V18::Resources::CampaignLabel->new({
