...
use Google::Ads::GoogleAds::V16::Resources::AdParameter;
use
  Google::Ads::GoogleAds::V16::Services::AdParameterService::AdParameterOperation;
...
sub set_ad_parameters {
  ...
  my $ad_parameter_1 = Google::Ads::GoogleAds::V16::Resources::AdParameter->new(
    {
  ...
  my $ad_parameter_2 = Google::Ads::GoogleAds::V16::Resources::AdParameter->new(
    {
      adGroupCriterion => $ad_group_criterion_resource_name,
      parameterIndex   => 2,
      insertionText    => "\$40"
