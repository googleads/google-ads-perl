...
use Google::Ads::GoogleAds::V1::Resources::AdParameter;
use
  Google::Ads::GoogleAds::V1::Services::AdParameterService::AdParameterOperation;
...
sub set_ad_parameters {
  ...
  my $ad_parameter_1 = Google::Ads::GoogleAds::V1::Resources::AdParameter->new({
  ...
  my $ad_parameter_2 = Google::Ads::GoogleAds::V1::Resources::AdParameter->new({
    adGroupCriterion => $ad_group_criterion_resource_name,
    parameterIndex   => 2,
    insertionText    => "\$40"
  });
  ...
  my $ad_parameter_response = $client->AdParameterService()->mutate({
...
# Call the example.
set_ad_parameters($client, $customer_id =~ s/-//gr, $ad_group_id,
  $criterion_id);
