...
use Google::Ads::GoogleAds::V16::Enums::ExperimentStatusEnum qw(SETUP);
use Google::Ads::GoogleAds::V16::Enums::ExperimentTypeEnum   qw(SEARCH_CUSTOM);
use Google::Ads::GoogleAds::V16::Enums::ResponseContentTypeEnum
  qw(MUTABLE_RESOURCE);
use Google::Ads::GoogleAds::V16::Resources::Campaign;
use Google::Ads::GoogleAds::V16::Resources::Experiment;
use Google::Ads::GoogleAds::V16::Resources::ExperimentArm;
...
sub modify_draft_campaign {
  ...
  my $updated_campaign = Google::Ads::GoogleAds::V16::Resources::Campaign->new({
