...
use Google::Ads::GoogleAds::V17::Enums::ExperimentStatusEnum qw(SETUP);
use Google::Ads::GoogleAds::V17::Enums::ExperimentTypeEnum   qw(SEARCH_CUSTOM);
use Google::Ads::GoogleAds::V17::Enums::ResponseContentTypeEnum
  qw(MUTABLE_RESOURCE);
use Google::Ads::GoogleAds::V17::Resources::Campaign;
use Google::Ads::GoogleAds::V17::Resources::Experiment;
use Google::Ads::GoogleAds::V17::Resources::ExperimentArm;
...
use
  Google::Ads::GoogleAds::V17::Services::ExperimentArmService::ExperimentArmOperation;
...
sub modify_draft_campaign {
  ...
  my $updated_campaign = Google::Ads::GoogleAds::V17::Resources::Campaign->new({
