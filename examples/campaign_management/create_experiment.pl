...
use Google::Ads::GoogleAds::V19::Enums::ExperimentStatusEnum qw(SETUP);
use Google::Ads::GoogleAds::V19::Enums::ExperimentTypeEnum   qw(SEARCH_CUSTOM);
use Google::Ads::GoogleAds::V19::Enums::ResponseContentTypeEnum
  qw(MUTABLE_RESOURCE);
use Google::Ads::GoogleAds::V19::Resources::Campaign;
use Google::Ads::GoogleAds::V19::Resources::Experiment;
use Google::Ads::GoogleAds::V19::Resources::ExperimentArm;
use Google::Ads::GoogleAds::V19::Services::CampaignService::CampaignOperation;
use
  Google::Ads::GoogleAds::V19::Services::ExperimentService::ExperimentOperation;
use
  Google::Ads::GoogleAds::V19::Services::ExperimentArmService::ExperimentArmOperation;
...
sub create_experiment_resource {
  ...
  my $experiment = Google::Ads::GoogleAds::V19::Resources::Experiment->new({
    # Name must be unique.
...
sub create_experiment_arms {
  ...
  push @$operations,
    Google::Ads::GoogleAds::V19::Services::ExperimentArmService::ExperimentArmOperation
    ->new({
      create => Google::Ads::GoogleAds::V19::Resources::ExperimentArm->new({
...
sub modify_draft_campaign {
  ...
  my $updated_campaign = Google::Ads::GoogleAds::V19::Resources::Campaign->new({
