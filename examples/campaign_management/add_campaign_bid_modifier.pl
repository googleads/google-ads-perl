...
use Google::Ads::GoogleAds::V10::Enums::InteractionTypeEnum qw(CALLS);
use Google::Ads::GoogleAds::V10::Enums::ResponseContentTypeEnum
  qw(MUTABLE_RESOURCE);
use
  Google::Ads::GoogleAds::V10::Services::CampaignBidModifierService::CampaignBidModifierOperation;
