...
use Google::Ads::GoogleAds::V14::Common::InteractionTypeInfo;
use Google::Ads::GoogleAds::V14::Enums::InteractionTypeEnum qw(CALLS);
use Google::Ads::GoogleAds::V14::Enums::ResponseContentTypeEnum
  qw(MUTABLE_RESOURCE);
use
  Google::Ads::GoogleAds::V14::Services::CampaignBidModifierService::CampaignBidModifierOperation;
