...
use Google::Ads::GoogleAds::V13::Resources::CampaignBidModifier;
use Google::Ads::GoogleAds::V13::Common::InteractionTypeInfo;
use Google::Ads::GoogleAds::V13::Enums::InteractionTypeEnum qw(CALLS);
use Google::Ads::GoogleAds::V13::Enums::ResponseContentTypeEnum
  qw(MUTABLE_RESOURCE);
use
  Google::Ads::GoogleAds::V13::Services::CampaignBidModifierService::CampaignBidModifierOperation;
