...
use Google::Ads::GoogleAds::V10::Resources::CampaignDraft;
use
  Google::Ads::GoogleAds::V10::Services::CampaignDraftService::CampaignDraftOperation;
...
sub add_campaign_draft {
  ...
  my $campaign_draft =
    Google::Ads::GoogleAds::V10::Resources::CampaignDraft->new({
      baseCampaign =>
