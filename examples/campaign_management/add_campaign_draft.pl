...
use Google::Ads::GoogleAds::V9::Resources::CampaignDraft;
use
  Google::Ads::GoogleAds::V9::Services::CampaignDraftService::CampaignDraftOperation;
...
sub add_campaign_draft {
  ...
  my $campaign_draft =
    Google::Ads::GoogleAds::V9::Resources::CampaignDraft->new({
      baseCampaign =>
