...
use Google::Ads::GoogleAds::V8::Enums::CampaignExperimentTrafficSplitTypeEnum
  qw(RANDOM_QUERY);
...
sub create_campaign_experiment {
  ...
  my $campaign_experiment =
    Google::Ads::GoogleAds::V8::Resources::CampaignExperiment->new({
      campaignDraft =>
        Google::Ads::GoogleAds::V8::Utils::ResourceNames::campaign_draft(
