...
use Google::Ads::GoogleAds::V7::Resources::CampaignExperiment;
use Google::Ads::GoogleAds::V7::Enums::CampaignExperimentTrafficSplitTypeEnum
  qw(RANDOM_QUERY);
...
sub create_campaign_experiment {
  ...
  my $campaign_experiment =
    Google::Ads::GoogleAds::V7::Resources::CampaignExperiment->new({
      campaignDraft =>
        Google::Ads::GoogleAds::V7::Utils::ResourceNames::campaign_draft(
