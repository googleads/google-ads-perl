...
use Google::Ads::GoogleAds::V22::Services::BatchJobService::BatchJobOperation;
...
sub create_batch_job {
  ...
  my $batch_job_operation =
    Google::Ads::GoogleAds::V22::Services::BatchJobService::BatchJobOperation->
    new({create => Google::Ads::GoogleAds::V22::Resources::BatchJob->new({})});
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V22::Resources::AdGroupAd->new({
        ...
        ad => Google::Ads::GoogleAds::V22::Resources::Ad->new({
            ...
            expandedTextAd =>
              Google::Ads::GoogleAds::V22::Common::ExpandedTextAdInfo->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status  =>
          Google::Ads::GoogleAds::V22::Enums::AdGroupAdStatusEnum::PAUSED
      });
