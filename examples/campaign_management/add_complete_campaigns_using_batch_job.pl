...
use Google::Ads::GoogleAds::V16::Resources::BatchJob;
...
use Google::Ads::GoogleAds::V16::Common::ExpandedTextAdInfo;
...
use Google::Ads::GoogleAds::V16::Services::BatchJobService::BatchJobOperation;
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V16::Resources::AdGroupAd->new({
        ...
        ad => Google::Ads::GoogleAds::V16::Resources::Ad->new({
            ...
            expandedTextAd =>
              Google::Ads::GoogleAds::V16::Common::ExpandedTextAdInfo->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status  =>
          Google::Ads::GoogleAds::V16::Enums::AdGroupAdStatusEnum::PAUSED
      });
