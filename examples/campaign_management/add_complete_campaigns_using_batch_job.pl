...
use Google::Ads::GoogleAds::V4::Services::BatchJobService::BatchJobOperation;
use Google::Ads::GoogleAds::V4::Services::GoogleAdsService::MutateOperation;
use
...
sub create_batch_job {
  ...
  my $batch_job_operation =
    Google::Ads::GoogleAds::V4::Services::BatchJobService::BatchJobOperation->
    new({create => Google::Ads::GoogleAds::V4::Resources::BatchJob->new({})});
...
sub build_all_operations {
  ...
  push @$mutate_operations,
    Google::Ads::GoogleAds::V4::Services::GoogleAdsService::MutateOperation->
    new({
...
sub build_campaign_budget_operation {
  ...
  return
    Google::Ads::GoogleAds::V4::Services::CampaignBudgetService::CampaignBudgetOperation
    ->new({
      create => Google::Ads::GoogleAds::V4::Resources::CampaignBudget->new({
  ...
  foreach my $campaign_operation (@$campaign_operations) {
    for (my $i = 0 ; $i < NUMBER_OF_AD_GROUPS_TO_ADD ; $i++) {
      ...
      my $ad_group    = Google::Ads::GoogleAds::V4::Resources::AdGroup->new({
          # Create a resource name using the temporary ID.
          resourceName =>
            Google::Ads::GoogleAds::V4::Utils::ResourceNames::ad_group(
...
sub build_ad_group_ad_operations {
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V4::Resources::AdGroupAd->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status =>
          Google::Ads::GoogleAds::V4::Enums::AdGroupAdStatusEnum::PAUSED
      });
