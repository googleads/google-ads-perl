...
use Google::Ads::GoogleAds::V6::Enums::AdGroupTypeEnum qw(SEARCH_STANDARD);
use Google::Ads::GoogleAds::V6::Enums::AdGroupCriterionStatusEnum;
use Google::Ads::GoogleAds::V6::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V6::Services::BatchJobService::BatchJobOperation;
...
sub build_campaign_budget_operation {
  ...
  return
    Google::Ads::GoogleAds::V6::Services::CampaignBudgetService::CampaignBudgetOperation
    ->new({
      create => Google::Ads::GoogleAds::V6::Resources::CampaignBudget->new({
    ...
    for (my $i = 0 ; $i < NUMBER_OF_KEYWORDS_TO_ADD ; $i++) {
      ...
      my $ad_group_criterion =
        Google::Ads::GoogleAds::V6::Resources::AdGroupCriterion->new({
          ...
          status =>
            Google::Ads::GoogleAds::V6::Enums::AdGroupCriterionStatusEnum::ENABLED
        });
...
sub build_ad_group_ad_operations {
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V6::Resources::AdGroupAd->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status =>
          Google::Ads::GoogleAds::V6::Enums::AdGroupAdStatusEnum::PAUSED
      });
