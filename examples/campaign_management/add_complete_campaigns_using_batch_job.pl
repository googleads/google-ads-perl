...
use Google::Ads::GoogleAds::V5::Enums::AdGroupTypeEnum qw(SEARCH_STANDARD);
use Google::Ads::GoogleAds::V5::Enums::AdGroupCriterionStatusEnum;
use Google::Ads::GoogleAds::V5::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V5::Services::BatchJobService::BatchJobOperation;
use Google::Ads::GoogleAds::V5::Services::GoogleAdsService::MutateOperation;
use
...
sub create_batch_job {
  ...
  my $batch_job_operation =
    Google::Ads::GoogleAds::V5::Services::BatchJobService::BatchJobOperation->
    new({create => Google::Ads::GoogleAds::V5::Resources::BatchJob->new({})});
...
sub build_all_operations {
  ...
  push @$mutate_operations,
    Google::Ads::GoogleAds::V5::Services::GoogleAdsService::MutateOperation->
    new({
...
sub build_campaign_budget_operation {
  ...
  return
    Google::Ads::GoogleAds::V5::Services::CampaignBudgetService::CampaignBudgetOperation
    ->new({
      create => Google::Ads::GoogleAds::V5::Resources::CampaignBudget->new({
...
sub build_ad_group_ad_operations {
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V5::Resources::AdGroupAd->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status =>
          Google::Ads::GoogleAds::V5::Enums::AdGroupAdStatusEnum::PAUSED
      });
