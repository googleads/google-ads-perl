...
use Google::Ads::GoogleAds::V12::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V12::Enums::AdGroupTypeEnum qw(SEARCH_STANDARD);
use Google::Ads::GoogleAds::V12::Enums::AdGroupCriterionStatusEnum;
use Google::Ads::GoogleAds::V12::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V12::Services::BatchJobService::BatchJobOperation;
...
sub create_batch_job {
  ...
  my $batch_job_operation =
    Google::Ads::GoogleAds::V12::Services::BatchJobService::BatchJobOperation->
    new({create => Google::Ads::GoogleAds::V12::Resources::BatchJob->new({})});
  ...
  foreach my $campaign_operation (@$campaign_operations) {
    ...
    my $campaign_criterion =
      Google::Ads::GoogleAds::V12::Resources::CampaignCriterion->new({
        keyword => Google::Ads::GoogleAds::V12::Common::KeywordInfo->new({
            text      => "venus",
            matchType => BROAD
          }
        ),
    ...
    for (my $i = 0 ; $i < NUMBER_OF_KEYWORDS_TO_ADD ; $i++) {
      ...
      my $ad_group_criterion =
        Google::Ads::GoogleAds::V12::Resources::AdGroupCriterion->new({
          ...
          status  =>
            Google::Ads::GoogleAds::V12::Enums::AdGroupCriterionStatusEnum::ENABLED
        });
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V12::Resources::AdGroupAd->new({
        ...
        ad => Google::Ads::GoogleAds::V12::Resources::Ad->new({
            ...
            expandedTextAd =>
              Google::Ads::GoogleAds::V12::Common::ExpandedTextAdInfo->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status  =>
          Google::Ads::GoogleAds::V12::Enums::AdGroupAdStatusEnum::PAUSED
      });
