...
use Google::Ads::GoogleAds::V15::Resources::BatchJob;
...
use Google::Ads::GoogleAds::V15::Enums::AdvertisingChannelTypeEnum qw(SEARCH);
use Google::Ads::GoogleAds::V15::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V15::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V15::Enums::AdGroupTypeEnum qw(SEARCH_STANDARD);
use Google::Ads::GoogleAds::V15::Enums::AdGroupCriterionStatusEnum;
use Google::Ads::GoogleAds::V15::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V15::Services::BatchJobService::BatchJobOperation;
...
use
  Google::Ads::GoogleAds::V15::Services::AdGroupCriterionService::AdGroupCriterionOperation;
...
sub create_batch_job {
  ...
  my $batch_job_operation =
    Google::Ads::GoogleAds::V15::Services::BatchJobService::BatchJobOperation->
    new({create => Google::Ads::GoogleAds::V15::Resources::BatchJob->new({})});
...
sub build_campaign_operations {
  ...
  for (my $i = 0 ; $i < NUMBER_OF_CAMPAIGNS_TO_ADD ; $i++) {
    ...
    my $campaign    = Google::Ads::GoogleAds::V15::Resources::Campaign->new({
        # Create a resource name using the temporary ID.
        resourceName =>
  ...
  foreach my $campaign_operation (@$campaign_operations) {
    ...
    my $campaign_criterion =
      Google::Ads::GoogleAds::V15::Resources::CampaignCriterion->new({
        keyword => Google::Ads::GoogleAds::V15::Common::KeywordInfo->new({
            text      => "venus",
            matchType => BROAD
          }
        ),
...
sub build_ad_group_operations {
  ...
  foreach my $campaign_operation (@$campaign_operations) {
    for (my $i = 0 ; $i < NUMBER_OF_AD_GROUPS_TO_ADD ; $i++) {
      ...
      my $ad_group    = Google::Ads::GoogleAds::V15::Resources::AdGroup->new({
          # Create a resource name using the temporary ID.
          resourceName =>
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    for (my $i = 0 ; $i < NUMBER_OF_KEYWORDS_TO_ADD ; $i++) {
      ...
      my $ad_group_criterion =
        Google::Ads::GoogleAds::V15::Resources::AdGroupCriterion->new({
          keyword => Google::Ads::GoogleAds::V15::Common::KeywordInfo->new({
              text      => $keyword_text,
              matchType => BROAD
            }
          ...
          status  =>
            Google::Ads::GoogleAds::V15::Enums::AdGroupCriterionStatusEnum::ENABLED
        });
...
sub build_ad_group_ad_operations {
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V15::Resources::AdGroupAd->new({
        # Create the expanded text ad info.
        ad => Google::Ads::GoogleAds::V15::Resources::Ad->new({
            # Set the expanded text ad info on an ad.
            expandedTextAd =>
              Google::Ads::GoogleAds::V15::Common::ExpandedTextAdInfo->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status  =>
          Google::Ads::GoogleAds::V15::Enums::AdGroupAdStatusEnum::PAUSED
      });
