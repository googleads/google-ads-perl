...
use Google::Ads::GoogleAds::V10::Resources::BatchJob;
...
use Google::Ads::GoogleAds::V10::Enums::AdGroupTypeEnum qw(SEARCH_STANDARD);
use Google::Ads::GoogleAds::V10::Enums::AdGroupCriterionStatusEnum;
use Google::Ads::GoogleAds::V10::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V10::Services::BatchJobService::BatchJobOperation;
...
sub create_batch_job {
  ...
  my $batch_job_operation =
    Google::Ads::GoogleAds::V10::Services::BatchJobService::BatchJobOperation->
    new({create => Google::Ads::GoogleAds::V10::Resources::BatchJob->new({})});
    ...
    for (my $i = 0 ; $i < NUMBER_OF_KEYWORDS_TO_ADD ; $i++) {
      ...
      my $ad_group_criterion =
        Google::Ads::GoogleAds::V10::Resources::AdGroupCriterion->new({
          ...
          status  =>
            Google::Ads::GoogleAds::V10::Enums::AdGroupCriterionStatusEnum::ENABLED
        });
...
sub build_ad_group_ad_operations {
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V10::Resources::AdGroupAd->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status  =>
          Google::Ads::GoogleAds::V10::Enums::AdGroupAdStatusEnum::PAUSED
      });
