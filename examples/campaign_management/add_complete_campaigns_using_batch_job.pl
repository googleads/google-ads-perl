...
use Google::Ads::GoogleAds::V25::Resources::BatchJob;
...
use Google::Ads::GoogleAds::V25::Common::ExpandedTextAdInfo;
...
use Google::Ads::GoogleAds::V25::Services::BatchJobService::BatchJobOperation;
  ...
  foreach my $ad_group_operation (@$ad_group_operations) {
    ...
    my $ad_group_ad = Google::Ads::GoogleAds::V25::Resources::AdGroupAd->new({
        ...
        ad => Google::Ads::GoogleAds::V25::Resources::Ad->new({
            ...
            expandedTextAd =>
              Google::Ads::GoogleAds::V25::Common::ExpandedTextAdInfo->new({
        ...
        adGroup => $ad_group_operation->{create}{resourceName},
        status  =>
          Google::Ads::GoogleAds::V25::Enums::AdGroupAdStatusEnum::PAUSED
      });
