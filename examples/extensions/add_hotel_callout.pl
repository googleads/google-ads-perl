...
use Google::Ads::GoogleAds::V14::Enums::AssetFieldTypeEnum qw(HOTEL_CALLOUT);
...
sub add_extension_assets {
  ...
  push @$hotel_callout_assets,
    Google::Ads::GoogleAds::V14::Common::HotelCalloutAsset->new({
      text         => "Activities",
...
sub link_assets_to_account {
    ...
    my $hotel_callout_asset_resource_name (@$hotel_callout_asset_resource_names)
  {
    push @$operations,
      Google::Ads::GoogleAds::V14::Services::CustomerAssetService::CustomerAssetOperation
      ->new({
        create => Google::Ads::GoogleAds::V14::Resources::CustomerAsset->new({
