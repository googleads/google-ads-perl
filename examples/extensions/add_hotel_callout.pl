...
use Google::Ads::GoogleAds::V5::Enums::ExtensionTypeEnum qw(HOTEL_CALLOUT);
use
...
use
  Google::Ads::GoogleAds::V5::Services::AdGroupExtensionSettingService::AdGroupExtensionSettingOperation;
use
...
sub add_extension_feed_item {
  ...
  my $hotel_callout_feed_item =
    Google::Ads::GoogleAds::V5::Common::HotelCalloutFeedItem->new({
      text         => $callout_text,
...
sub add_extension_to_ad_group {
  ...
  my $ad_group_extension_setting =
    Google::Ads::GoogleAds::V5::Resources::AdGroupExtensionSetting->new({
      extensionType => HOTEL_CALLOUT,
