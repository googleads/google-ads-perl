...
use Google::Ads::GoogleAds::V13::Common::HotelCalloutAsset;
use Google::Ads::GoogleAds::V13::Enums::AssetFieldTypeEnum qw(HOTEL_CALLOUT);
...
sub add_extension_assets {
  ...
  push @$hotel_callout_assets,
    Google::Ads::GoogleAds::V13::Common::HotelCalloutAsset->new({
      text         => "Activities",
