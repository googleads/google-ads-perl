...
use Google::Ads::GoogleAds::V10::Common::HotelCalloutAsset;
use Google::Ads::GoogleAds::V10::Enums::AssetFieldTypeEnum qw(HOTEL_CALLOUT);
...
sub add_extension_assets {
  ...
  push @$hotel_callout_assets,
    Google::Ads::GoogleAds::V10::Common::HotelCalloutAsset->new({
      text         => "Activities",
