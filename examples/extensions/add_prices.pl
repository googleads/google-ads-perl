...
use Google::Ads::GoogleAds::V7::Common::PriceFeedItem;
use Google::Ads::GoogleAds::V7::Common::PriceOffer;
use Google::Ads::GoogleAds::V7::Common::Money;
use Google::Ads::GoogleAds::V7::Common::AdScheduleInfo;
use Google::Ads::GoogleAds::V7::Enums::ExtensionTypeEnum qw(PRICE);
use Google::Ads::GoogleAds::V7::Enums::PriceExtensionTypeEnum qw(SERVICES);
use Google::Ads::GoogleAds::V7::Enums::PriceExtensionPriceQualifierEnum
  qw(FROM);
use Google::Ads::GoogleAds::V7::Enums::PriceExtensionPriceUnitEnum
  qw(PER_HOUR PER_MONTH);
use Google::Ads::GoogleAds::V7::Enums::DayOfWeekEnum qw(SATURDAY SUNDAY);
...
sub create_extension_feed_item {
  ...
  my $price_feed_item = Google::Ads::GoogleAds::V7::Common::PriceFeedItem->new({
    type => SERVICES,
...
sub create_price_offer {
  ...
  my $price_offer = Google::Ads::GoogleAds::V7::Common::PriceOffer->new({
      header      => $header,
      description => $description,
      finalUrls   => [$final_url],
      price       => Google::Ads::GoogleAds::V7::Common::Money->new({
