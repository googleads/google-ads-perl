...
use Google::Ads::GoogleAds::V12::Common::PriceAsset;
use Google::Ads::GoogleAds::V12::Common::PriceOffering;
use Google::Ads::GoogleAds::V12::Common::Money;
use Google::Ads::GoogleAds::V12::Enums::PriceExtensionTypeEnum qw(SERVICES);
use Google::Ads::GoogleAds::V12::Enums::PriceExtensionPriceQualifierEnum
  qw(FROM);
use Google::Ads::GoogleAds::V12::Enums::PriceExtensionPriceUnitEnum
  qw(PER_HOUR PER_MONTH);
use Google::Ads::GoogleAds::V12::Enums::AssetFieldTypeEnum qw(PRICE);
use Google::Ads::GoogleAds::V12::Services::AssetService::AssetOperation;
use
  Google::Ads::GoogleAds::V12::Services::CustomerAssetService::CustomerAssetOperation;
...
sub create_price_asset {
  ...
  my $price_asset = Google::Ads::GoogleAds::V12::Common::PriceAsset->new({
      type => SERVICES,
...
sub add_extension_to_account {
  ...
  my $customer_asset =
    Google::Ads::GoogleAds::V12::Resources::CustomerAsset->new({
...
sub create_price_offering {
  ...
  my $price_offering = Google::Ads::GoogleAds::V12::Common::PriceOffering->new({
      header      => $header,
      description => $description,
      finalUrl    => $final_url,
      price       => Google::Ads::GoogleAds::V12::Common::Money->new({
