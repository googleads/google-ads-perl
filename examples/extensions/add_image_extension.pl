...
use Google::Ads::GoogleAds::V12::Enums::ExtensionTypeEnum qw(IMAGE);
use
...
sub create_image_extension {
  ...
  my $image_feed_item = Google::Ads::GoogleAds::V12::Common::ImageFeedItem->new(
    {
      imageAsset => Google::Ads::GoogleAds::V12::Utils::ResourceNames::asset(
