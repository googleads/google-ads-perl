...
use Google::Ads::GoogleAds::V15::Common::ImageFeedItem;
use Google::Ads::GoogleAds::V15::Enums::ExtensionTypeEnum qw(IMAGE);
use
...
sub create_image_extension {
  ...
  my $image_feed_item = Google::Ads::GoogleAds::V15::Common::ImageFeedItem->new(
    {
      imageAsset => Google::Ads::GoogleAds::V15::Utils::ResourceNames::asset(
