...
use Google::Ads::GoogleAds::V6::Common::ImageFeedItem;
use Google::Ads::GoogleAds::V6::Enums::ExtensionTypeEnum qw(IMAGE);
use
...
sub create_image_extension {
  ...
  my $image_feed_item = Google::Ads::GoogleAds::V6::Common::ImageFeedItem->new({
      imageAsset => Google::Ads::GoogleAds::V6::Utils::ResourceNames::asset(
