...
use Google::Ads::GoogleAds::V11::Resources::CustomerAsset;
use Google::Ads::GoogleAds::V11::Common::CallAsset;
...
use Google::Ads::GoogleAds::V11::Enums::CallConversionReportingStateEnum
  qw(USE_RESOURCE_LEVEL_CALL_CONVERSION_ACTION);
use Google::Ads::GoogleAds::V11::Enums::AssetFieldTypeEnum qw(CALL);
use Google::Ads::GoogleAds::V11::Services::AssetService::AssetOperation;
use
  Google::Ads::GoogleAds::V11::Services::CustomerAssetService::CustomerAssetOperation;
...
sub add_extension_asset {
  ...
  my $call_asset = Google::Ads::GoogleAds::V11::Common::CallAsset->new({
...
sub link_asset_to_account {
  ...
  my $customer_asset_operation =
    Google::Ads::GoogleAds::V11::Services::CustomerAssetService::CustomerAssetOperation
    ->new({
      create => Google::Ads::GoogleAds::V11::Resources::CustomerAsset->new({
