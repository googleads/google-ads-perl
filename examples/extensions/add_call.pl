...
use Google::Ads::GoogleAds::V15::Common::CallAsset;
...
use Google::Ads::GoogleAds::V15::Enums::CallConversionReportingStateEnum
  qw(USE_RESOURCE_LEVEL_CALL_CONVERSION_ACTION);
use Google::Ads::GoogleAds::V15::Enums::AssetFieldTypeEnum qw(CALL);
use Google::Ads::GoogleAds::V15::Services::AssetService::AssetOperation;
use
  Google::Ads::GoogleAds::V15::Services::CustomerAssetService::CustomerAssetOperation;
...
sub add_call {
  ...
  # Create the asset for the call extensions.
  my $asset_resource_name =
    add_extension_asset($api_client, $customer_id, $phone_country,
...
sub add_extension_asset {
  my ($api_client, $customer_id, $phone_country,
    $phone_number, $conversion_action_id)
    = @_;

  # Create the call asset.
  my $call_asset = Google::Ads::GoogleAds::V15::Common::CallAsset->new({
...
sub link_asset_to_account {
  ...
  my $customer_asset_operation =
    Google::Ads::GoogleAds::V15::Services::CustomerAssetService::CustomerAssetOperation
    ->new({
      create => Google::Ads::GoogleAds::V15::Resources::CustomerAsset->new({
