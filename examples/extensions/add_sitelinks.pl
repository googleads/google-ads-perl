...
sub add_sitelinks {
  ...
  my $campaign_resource_name =
    Google::Ads::GoogleAds::V12::Utils::ResourceNames::campaign($customer_id,
    $campaign_id);
...
sub create_extension_feed_items {
  ...
  my $extension_feed_item_1 =
    Google::Ads::GoogleAds::V12::Resources::ExtensionFeedItem->new({
      extensionType    => SITELINK,
  ...
  my $extension_feed_item_3 =
    Google::Ads::GoogleAds::V12::Resources::ExtensionFeedItem->new({
      ...
      targetedCampaign => $campaign_resource_name,
      device           => MOBILE,
      targetedKeyword  => Google::Ads::GoogleAds::V12::Common::KeywordInfo->new(
        {
          text      => "free wifi",
          matchType => BROAD
        })});
...
sub create_sitelink_feed_item {
  ...
  return Google::Ads::GoogleAds::V12::Common::SitelinkFeedItem->new({
...
sub create_ad_schedule_info {
  ...
  return Google::Ads::GoogleAds::V12::Common::AdScheduleInfo->new({
    dayOfWeek   => $day,
