...
use Google::Ads::GoogleAds::V11::Enums::FeedItemTargetDeviceEnum qw(MOBILE);
use Google::Ads::GoogleAds::V11::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V11::Enums::DayOfWeekEnum
...
sub create_extension_feed_items {
  ...
  my $extension_feed_item_3 =
    Google::Ads::GoogleAds::V11::Resources::ExtensionFeedItem->new({
      ...
      targetedCampaign => $campaign_resource_name,
      device           => MOBILE,
      targetedKeyword  => Google::Ads::GoogleAds::V11::Common::KeywordInfo->new(
        {
          text      => "free wifi",
          matchType => BROAD
        })});
...
sub create_sitelink_feed_item {
  ...
  return Google::Ads::GoogleAds::V11::Common::SitelinkFeedItem->new({
...
sub create_ad_schedule_info {
  ...
  return Google::Ads::GoogleAds::V11::Common::AdScheduleInfo->new({
    dayOfWeek   => $day,
