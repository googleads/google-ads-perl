...
use Google::Ads::GoogleAds::V5::Enums::ExtensionTypeEnum qw(SITELINK);
use Google::Ads::GoogleAds::V5::Enums::FeedItemTargetDeviceEnum qw(MOBILE);
use Google::Ads::GoogleAds::V5::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V5::Enums::DayOfWeekEnum
...
sub create_sitelink_feed_item {
  ...
  return Google::Ads::GoogleAds::V5::Common::SitelinkFeedItem->new({
