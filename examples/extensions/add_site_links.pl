...
use Google::Ads::GoogleAds::V2::Common::SitelinkFeedItem;
use Google::Ads::GoogleAds::V2::Common::AdScheduleInfo;
use Google::Ads::GoogleAds::V2::Enums::ExtensionTypeEnum qw(SITELINK);
use Google::Ads::GoogleAds::V2::Enums::FeedItemTargetDeviceEnum qw(MOBILE);
use Google::Ads::GoogleAds::V2::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V2::Enums::DayOfWeekEnum
...
sub create_extension_feed_items {
  ...
  my $united_states =
    Google::Ads::GoogleAds::V2::Utils::ResourceNames::geo_target_constant(2840);
  ...
  my $extension_feed_item_3 =
    Google::Ads::GoogleAds::V2::Resources::ExtensionFeedItem->new({
      ...
      targetedCampaign => $campaign_resource_name,
      device           => MOBILE,
      targetedKeyword  => Google::Ads::GoogleAds::V2::Common::KeywordInfo->new({
          text      => "free wifi",
          matchType => BROAD
        })});
...
sub create_sitelink_feed_item {
  ...
  return Google::Ads::GoogleAds::V2::Common::SitelinkFeedItem->new({
