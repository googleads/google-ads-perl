...
use Google::Ads::GoogleAds::V7::Resources::PlacesLocationFeedData;
use Google::Ads::GoogleAds::V7::Resources::OAuthInfo;
use Google::Ads::GoogleAds::V7::Resources::CustomerFeed;
use Google::Ads::GoogleAds::V7::Common::MatchingFunction;
use Google::Ads::GoogleAds::V7::Common::Operand;
use Google::Ads::GoogleAds::V7::Common::ConstantOperand;
use Google::Ads::GoogleAds::V7::Enums::FeedOriginEnum qw(GOOGLE);
use Google::Ads::GoogleAds::V7::Enums::PlaceholderTypeEnum qw(LOCATION);
use Google::Ads::GoogleAds::V7::Enums::MatchingFunctionOperatorEnum
  qw(IDENTITY);
use Google::Ads::GoogleAds::V7::Services::FeedService::FeedOperation;
use
  Google::Ads::GoogleAds::V7::Services::CustomerFeedService::CustomerFeedOperation;
...
sub add_google_my_business_location_extensions {
  ...
  my $gmb_feed = Google::Ads::GoogleAds::V7::Resources::Feed->new({
      name => "Google My Business feed #" . uniqid(),
      # Configure the location feed populated from Google My Business Locations.
      placesLocationFeedData =>
        Google::Ads::GoogleAds::V7::Resources::PlacesLocationFeedData->new({
          ...
          # account.
          oauthInfo => Google::Ads::GoogleAds::V7::Resources::OAuthInfo->new({
              httpMethod     => "GET",
              httpRequestUrl =>
  ...
  # placeholder type.
  my $customer_feed = Google::Ads::GoogleAds::V7::Resources::CustomerFeed->new({
      ...
      matchingFunction =>
        Google::Ads::GoogleAds::V7::Common::MatchingFunction->new({
          leftOperands => [
            Google::Ads::GoogleAds::V7::Common::Operand->new({
                constantOperand =>
                  Google::Ads::GoogleAds::V7::Common::ConstantOperand->new({
                    booleanValue => "true"
                  })})
          ],
