...
use Google::Ads::GoogleAds::V5::Resources::PlacesLocationFeedData;
use Google::Ads::GoogleAds::V5::Resources::OAuthInfo;
...
use Google::Ads::GoogleAds::V5::Common::ConstantOperand;
use Google::Ads::GoogleAds::V5::Enums::FeedOriginEnum qw(GOOGLE);
use Google::Ads::GoogleAds::V5::Enums::PlaceholderTypeEnum qw(LOCATION);
use Google::Ads::GoogleAds::V5::Enums::MatchingFunctionOperatorEnum
  qw(IDENTITY);
