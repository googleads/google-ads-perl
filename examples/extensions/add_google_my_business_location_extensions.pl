...
use Google::Ads::GoogleAds::V4::Resources::PlacesLocationFeedData;
use Google::Ads::GoogleAds::V4::Resources::OAuthInfo;
...
use Google::Ads::GoogleAds::V4::Common::ConstantOperand;
use Google::Ads::GoogleAds::V4::Enums::FeedOriginEnum qw(GOOGLE);
use Google::Ads::GoogleAds::V4::Enums::PlaceholderTypeEnum qw(LOCATION);
use Google::Ads::GoogleAds::V4::Enums::MatchingFunctionOperatorEnum
  qw(IDENTITY);
...
sub add_google_my_business_location_extensions {
  ...
  my $gmb_feed = Google::Ads::GoogleAds::V4::Resources::Feed->new({
      name => "Google My Business feed #" . uniqid(),
      # Configure the location feed populated from Google My Business Locations.
      placesLocationFeedData =>
        Google::Ads::GoogleAds::V4::Resources::PlacesLocationFeedData->new({
          ...
          # account.
          oauthInfo => Google::Ads::GoogleAds::V4::Resources::OAuthInfo->new({
              httpMethod => "GET",
              httpRequestUrl =>
  ...
  # placeholder type.
  my $customer_feed = Google::Ads::GoogleAds::V4::Resources::CustomerFeed->new({
      ...
      matchingFunction =>
        Google::Ads::GoogleAds::V4::Common::MatchingFunction->new({
          leftOperands => [
            Google::Ads::GoogleAds::V4::Common::Operand->new({
                constantOperand =>
                  Google::Ads::GoogleAds::V4::Common::ConstantOperand->new({
                    booleanValue => "true"
                  })})
          ],
