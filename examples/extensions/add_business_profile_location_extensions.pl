...
use Google::Ads::GoogleAds::V10::Resources::PlacesLocationFeedData;
use Google::Ads::GoogleAds::V10::Resources::OAuthInfo;
use Google::Ads::GoogleAds::V10::Resources::CustomerFeed;
use Google::Ads::GoogleAds::V10::Common::MatchingFunction;
use Google::Ads::GoogleAds::V10::Common::Operand;
use Google::Ads::GoogleAds::V10::Common::ConstantOperand;
use Google::Ads::GoogleAds::V10::Enums::FeedOriginEnum qw(GOOGLE);
use Google::Ads::GoogleAds::V10::Enums::PlaceholderTypeEnum qw(LOCATION);
use Google::Ads::GoogleAds::V10::Enums::MatchingFunctionOperatorEnum
  qw(IDENTITY);
use Google::Ads::GoogleAds::V10::Services::FeedService::FeedOperation;
use
  Google::Ads::GoogleAds::V10::Services::CustomerFeedService::CustomerFeedOperation;
...
sub add_business_profile_location_extensions {
  ...
  my $business_profile_feed = Google::Ads::GoogleAds::V10::Resources::Feed->new(
    {
      name => "Business Profile feed #" . uniqid(),
      # Configure the location feed populated from Business Profile Locations.
      placesLocationFeedData =>
        Google::Ads::GoogleAds::V10::Resources::PlacesLocationFeedData->new({
          ...
          oauthInfo => Google::Ads::GoogleAds::V10::Resources::OAuthInfo->new({
              httpMethod     => "GET",
              httpRequestUrl =>
  ...
  # placeholder type.
  my $customer_feed = Google::Ads::GoogleAds::V10::Resources::CustomerFeed->new(
    {
      feed             => $feed_resource_name,
      placeholderTypes => LOCATION,
      # Create a matching function that will always evaluate to true.
      matchingFunction =>
        Google::Ads::GoogleAds::V10::Common::MatchingFunction->new({
          leftOperands => [
            Google::Ads::GoogleAds::V10::Common::Operand->new({
                constantOperand =>
                  Google::Ads::GoogleAds::V10::Common::ConstantOperand->new({
                    booleanValue => "true"
                  })})
          ],
