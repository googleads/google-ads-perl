...
use Google::Ads::GoogleAds::V3::Resources::AffiliateLocationFeedData;
use Google::Ads::GoogleAds::V3::Resources::CampaignFeed;
use Google::Ads::GoogleAds::V3::Common::MatchingFunction;
use Google::Ads::GoogleAds::V3::Enums::AffiliateLocationFeedRelationshipTypeEnum
  qw(GENERAL_RETAILER);
use Google::Ads::GoogleAds::V3::Enums::FeedOriginEnum qw(GOOGLE);
use Google::Ads::GoogleAds::V3::Enums::PlaceholderTypeEnum
  qw(AFFILIATE_LOCATION);
use Google::Ads::GoogleAds::V3::Enums::AffiliateLocationPlaceholderFieldEnum
  qw(CHAIN_ID);
use
...
sub create_affiliate_location_extension_feed {
  ...
  my $feed = Google::Ads::GoogleAds::V3::Resources::Feed->new({
      ...
      affiliateLocationFeedData =>
        Google::Ads::GoogleAds::V3::Resources::AffiliateLocationFeedData->new({
          chainIds         => [$chain_id],
