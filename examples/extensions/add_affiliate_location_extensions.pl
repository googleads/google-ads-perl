...
use Google::Ads::GoogleAds::V7::Resources::AffiliateLocationFeedData;
use Google::Ads::GoogleAds::V7::Resources::CampaignFeed;
use Google::Ads::GoogleAds::V7::Common::MatchingFunction;
use Google::Ads::GoogleAds::V7::Enums::AffiliateLocationFeedRelationshipTypeEnum
  qw(GENERAL_RETAILER);
...
use Google::Ads::GoogleAds::V7::Enums::AffiliateLocationPlaceholderFieldEnum
  qw(CHAIN_ID);
use
