...
use Google::Ads::GoogleAds::V9::Resources::AffiliateLocationFeedData;
use Google::Ads::GoogleAds::V9::Resources::CampaignFeed;
use Google::Ads::GoogleAds::V9::Common::MatchingFunction;
use Google::Ads::GoogleAds::V9::Enums::AffiliateLocationFeedRelationshipTypeEnum
  qw(GENERAL_RETAILER);
use Google::Ads::GoogleAds::V9::Enums::FeedOriginEnum qw(GOOGLE);
use Google::Ads::GoogleAds::V9::Enums::PlaceholderTypeEnum
  qw(AFFILIATE_LOCATION);
use Google::Ads::GoogleAds::V9::Enums::AffiliateLocationPlaceholderFieldEnum
  qw(CHAIN_ID);
use
...
use
  Google::Ads::GoogleAds::V9::Services::CampaignFeedService::CampaignFeedOperation;
...
sub create_affiliate_location_extension_feed {
  ...
  my $feed = Google::Ads::GoogleAds::V9::Resources::Feed->new({
      ...
      affiliateLocationFeedData =>
        Google::Ads::GoogleAds::V9::Resources::AffiliateLocationFeedData->new({
          chainIds         => [$chain_id],
...
sub create_campaign_feed {
  ...
  my $campaign_feed = Google::Ads::GoogleAds::V9::Resources::CampaignFeed->new({
