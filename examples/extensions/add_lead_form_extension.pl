...
use Google::Ads::GoogleAds::V15::Common::LeadFormAsset;
use Google::Ads::GoogleAds::V15::Common::LeadFormField;
use Google::Ads::GoogleAds::V15::Common::LeadFormSingleChoiceAnswers;
use Google::Ads::GoogleAds::V15::Common::LeadFormDeliveryMethod;
use Google::Ads::GoogleAds::V15::Common::WebhookDelivery;
use Google::Ads::GoogleAds::V15::Enums::AssetFieldTypeEnum qw(LEAD_FORM);
use Google::Ads::GoogleAds::V15::Enums::LeadFormCallToActionTypeEnum
  qw(BOOK_NOW);
use Google::Ads::GoogleAds::V15::Enums::LeadFormFieldUserInputTypeEnum
  qw(FULL_NAME EMAIL PHONE_NUMBER PREFERRED_CONTACT_TIME TRAVEL_BUDGET);
use Google::Ads::GoogleAds::V15::Enums::LeadFormPostSubmitCallToActionTypeEnum
  qw(VISIT_SITE);
use
  Google::Ads::GoogleAds::V15::Services::CampaignAssetService::CampaignAssetOperation;
...
sub add_lead_form_extension {
  ...
  create_lead_form_extension($api_client, $customer_id, $campaign_id,
...
sub create_lead_form_extension {
  ...
  my $campaign_asset =
    Google::Ads::GoogleAds::V15::Resources::CampaignAsset->new({
...
sub create_lead_form_asset {
  ...
  my $lead_form_asset = Google::Ads::GoogleAds::V15::Resources::Asset->new({
      name          => "Interplanetary Cruise Lead Form #" . uniqid(),
      leadFormAsset => Google::Ads::GoogleAds::V15::Common::LeadFormAsset->new({
          ...
          fields => [
            Google::Ads::GoogleAds::V15::Common::LeadFormField->new({
                inputType => FULL_NAME
              }
            ),
            Google::Ads::GoogleAds::V15::Common::LeadFormField->new({
            ...
            Google::Ads::GoogleAds::V15::Common::LeadFormField->new({
                ...
                singleChoiceAnswers =>
                  Google::Ads::GoogleAds::V15::Common::LeadFormSingleChoiceAnswers
                  ->new({
          ...
          deliveryMethods => [
            Google::Ads::GoogleAds::V15::Common::LeadFormDeliveryMethod->new({
                webhook =>
                  Google::Ads::GoogleAds::V15::Common::WebhookDelivery->new({
...
# Call the example.
add_lead_form_extension($api_client, $customer_id =~ s/-//gr, $campaign_id);
...
add_lead_form_extension.pl [options]

    -help           Show the help message.
    -customer_id    The Google Ads customer ID.
    -campaign_id    ID of the campaign to which lead form extensions are added.
