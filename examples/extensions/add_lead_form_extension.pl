...
use Google::Ads::GoogleAds::V13::Common::LeadFormAsset;
use Google::Ads::GoogleAds::V13::Common::LeadFormField;
use Google::Ads::GoogleAds::V13::Common::LeadFormSingleChoiceAnswers;
use Google::Ads::GoogleAds::V13::Common::LeadFormDeliveryMethod;
use Google::Ads::GoogleAds::V13::Common::WebhookDelivery;
use Google::Ads::GoogleAds::V13::Enums::AssetFieldTypeEnum qw(LEAD_FORM);
use Google::Ads::GoogleAds::V13::Enums::LeadFormCallToActionTypeEnum
  qw(BOOK_NOW);
use Google::Ads::GoogleAds::V13::Enums::LeadFormFieldUserInputTypeEnum
  qw(FULL_NAME EMAIL PHONE_NUMBER PREFERRED_CONTACT_TIME TRAVEL_BUDGET);
use Google::Ads::GoogleAds::V13::Enums::LeadFormPostSubmitCallToActionTypeEnum
  qw(VISIT_SITE);
use
