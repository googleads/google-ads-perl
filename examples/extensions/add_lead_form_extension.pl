...
use Google::Ads::GoogleAds::V10::Common::LeadFormAsset;
use Google::Ads::GoogleAds::V10::Common::LeadFormField;
use Google::Ads::GoogleAds::V10::Common::LeadFormSingleChoiceAnswers;
use Google::Ads::GoogleAds::V10::Common::LeadFormDeliveryMethod;
use Google::Ads::GoogleAds::V10::Common::WebhookDelivery;
use Google::Ads::GoogleAds::V10::Enums::AssetFieldTypeEnum qw(LEAD_FORM);
use Google::Ads::GoogleAds::V10::Enums::LeadFormCallToActionTypeEnum
  qw(BOOK_NOW);
use Google::Ads::GoogleAds::V10::Enums::LeadFormFieldUserInputTypeEnum
  qw(FULL_NAME EMAIL PHONE_NUMBER PREFERRED_CONTACT_TIME TRAVEL_BUDGET);
use Google::Ads::GoogleAds::V10::Enums::LeadFormPostSubmitCallToActionTypeEnum
  qw(VISIT_SITE);
use
  Google::Ads::GoogleAds::V10::Services::CampaignAssetService::CampaignAssetOperation;
...
sub create_lead_form_extension {
  ...
  my $campaign_asset =
    Google::Ads::GoogleAds::V10::Resources::CampaignAsset->new({
...
sub create_lead_form_asset {
  ...
  my $lead_form_asset = Google::Ads::GoogleAds::V10::Resources::Asset->new({
      name          => "Interplanetary Cruise Lead Form #" . uniqid(),
      leadFormAsset => Google::Ads::GoogleAds::V10::Common::LeadFormAsset->new({
          ...
          fields => [
            Google::Ads::GoogleAds::V10::Common::LeadFormField->new({
                inputType => FULL_NAME
              }
            ),
            Google::Ads::GoogleAds::V10::Common::LeadFormField->new({
            ...
            Google::Ads::GoogleAds::V10::Common::LeadFormField->new({
                ...
                singleChoiceAnswers =>
                  Google::Ads::GoogleAds::V10::Common::LeadFormSingleChoiceAnswers
                  ->new({
          ...
          deliveryMethods => [
            Google::Ads::GoogleAds::V10::Common::LeadFormDeliveryMethod->new({
                webhook =>
                  Google::Ads::GoogleAds::V10::Common::WebhookDelivery->new({
  ...
  my $asset_operation =
    Google::Ads::GoogleAds::V10::Services::AssetService::AssetOperation->new({
