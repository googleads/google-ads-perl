...
use Google::Ads::GoogleAds::V10::Common::PromotionAsset;
use Google::Ads::GoogleAds::V10::Enums::ExtensionTypeEnum qw(PROMOTION);
use
  Google::Ads::GoogleAds::V10::Services::AdGroupAssetService::AdGroupAssetOperation;
...
sub create_promotion_asset_from_feed {
  ...
  my $asset = Google::Ads::GoogleAds::V10::Resources::Asset->new({
      ...
      promotionAsset      =>
        Google::Ads::GoogleAds::V10::Common::PromotionAsset->new({
  ...
  if (defined($promotion_feed_item->{percentOff})) {
    ...
    $asset->{promotionAsset}{moneyAmountOff} =
      Google::Ads::GoogleAds::V10::Common::Money->new({
...
sub associate_asset_with_ad_groups {
  ...
  foreach my $ad_group_id (@ad_group_ids) {
    my $ad_group_asset =
      Google::Ads::GoogleAds::V10::Resources::AdGroupAsset->new({
        asset     => $promotion_asset_resource_name,
        fieldType => PROMOTION,
