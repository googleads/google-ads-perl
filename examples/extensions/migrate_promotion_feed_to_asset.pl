...
use Google::Ads::GoogleAds::V12::Resources::AdGroupAsset;
...
use Google::Ads::GoogleAds::V12::Common::PromotionAsset;
use Google::Ads::GoogleAds::V12::Enums::ExtensionTypeEnum qw(PROMOTION);
use
  Google::Ads::GoogleAds::V12::Services::AdGroupAssetService::AdGroupAssetOperation;
...
sub associate_asset_with_ad_groups {
  ...
  foreach my $ad_group_id (@ad_group_ids) {
    my $ad_group_asset =
      Google::Ads::GoogleAds::V12::Resources::AdGroupAsset->new({
        asset     => $promotion_asset_resource_name,
        fieldType => PROMOTION,
