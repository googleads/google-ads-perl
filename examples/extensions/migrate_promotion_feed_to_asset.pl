...
use Google::Ads::GoogleAds::V9::Resources::AdGroupAsset;
use Google::Ads::GoogleAds::V9::Resources::Asset;
use Google::Ads::GoogleAds::V9::Resources::CampaignAsset;
use Google::Ads::GoogleAds::V9::Common::Money;
use Google::Ads::GoogleAds::V9::Common::PromotionAsset;
use Google::Ads::GoogleAds::V9::Enums::ExtensionTypeEnum qw(PROMOTION);
use
  Google::Ads::GoogleAds::V9::Services::AdGroupAssetService::AdGroupAssetOperation;
use Google::Ads::GoogleAds::V9::Services::AssetService::AssetOperation;
use
  Google::Ads::GoogleAds::V9::Services::CampaignAssetService::CampaignAssetOperation;
use
...
sub migrate_promotion_feed_to_asset {
  ...
  my $extension_feed_item_resource_name =
    Google::Ads::GoogleAds::V9::Utils::ResourceNames::extension_feed_item(
...
sub create_promotion_asset_from_feed {
  ...
  my $asset = Google::Ads::GoogleAds::V9::Resources::Asset->new({
      ...
      promotionAsset => Google::Ads::GoogleAds::V9::Common::PromotionAsset->new(
        {
  ...
  if (defined($promotion_feed_item->{percentOff})) {
    ...
    $asset->{promotionAsset}{moneyAmountOff} =
      Google::Ads::GoogleAds::V9::Common::Money->new({
...
sub associate_asset_with_campaigns {
  ...
  foreach my $campaign_id (@campaign_ids) {
    my $campaign_asset =
      Google::Ads::GoogleAds::V9::Resources::CampaignAsset->new({
...
sub associate_asset_with_ad_groups {
  ...
  foreach my $ad_group_id (@ad_group_ids) {
    my $ad_group_asset =
      Google::Ads::GoogleAds::V9::Resources::AdGroupAsset->new({
        asset     => $promotion_asset_resource_name,
        fieldType => PROMOTION,
