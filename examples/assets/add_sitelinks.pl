...
use Google::Ads::GoogleAds::V16::Common::SitelinkAsset;
use Google::Ads::GoogleAds::V16::Enums::AssetFieldTypeEnum qw(SITELINK);
...
sub create_sitelink_assets {
  ...
  my $store_locator_asset =
    Google::Ads::GoogleAds::V16::Common::SitelinkAsset->new({
      description1 => "Get in touch",
      description2 => "Find your local store",
      linkText     => "Store locator"
    });

  my $store_asset = Google::Ads::GoogleAds::V16::Common::SitelinkAsset->new({
  ...
  my $assets = [];
  push @$assets, Google::Ads::GoogleAds::V16::Resources::Asset->new({
  ...
  foreach my $sitelink_asset_resource_name (@$sitelink_asset_resource_names) {
    push @$operations,
      ...
      ->new({
        ...
        create => Google::Ads::GoogleAds::V16::Resources::CampaignAsset->new({
