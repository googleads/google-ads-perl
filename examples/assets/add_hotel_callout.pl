...
use Google::Ads::GoogleAds::V25::Common::HotelCalloutAsset;
use Google::Ads::GoogleAds::V25::Enums::AssetFieldTypeEnum qw(HOTEL_CALLOUT);
...
sub add_hotel_callout_assets {
  ...
  push @$hotel_callout_assets,
    Google::Ads::GoogleAds::V25::Common::HotelCalloutAsset->new({
      text         => "Activities",
