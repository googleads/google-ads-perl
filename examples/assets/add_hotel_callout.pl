...
use Google::Ads::GoogleAds::V16::Common::HotelCalloutAsset;
use Google::Ads::GoogleAds::V16::Enums::AssetFieldTypeEnum qw(HOTEL_CALLOUT);
...
sub add_hotel_callout_assets {
  ...
  push @$hotel_callout_assets,
    Google::Ads::GoogleAds::V16::Common::HotelCalloutAsset->new({
      text         => "Activities",
