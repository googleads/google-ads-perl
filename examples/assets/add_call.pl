...
use Google::Ads::GoogleAds::V16::Common::CallAsset;
...
use Google::Ads::GoogleAds::V16::Enums::CallConversionReportingStateEnum
  qw(USE_RESOURCE_LEVEL_CALL_CONVERSION_ACTION);
use Google::Ads::GoogleAds::V16::Enums::AssetFieldTypeEnum qw(CALL);
...
sub add_call_asset {
  ...
  # Create the call asset.
  my $call_asset = Google::Ads::GoogleAds::V16::Common::CallAsset->new({
...
sub link_asset_to_account {
  ...
  my $customer_asset_operation =
    Google::Ads::GoogleAds::V16::Services::CustomerAssetService::CustomerAssetOperation
    ->new({
      create => Google::Ads::GoogleAds::V16::Resources::CustomerAsset->new({
