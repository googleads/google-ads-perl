...
use Google::Ads::GoogleAds::V24::Common::CallAsset;
...
use Google::Ads::GoogleAds::V24::Enums::CallConversionReportingStateEnum
  qw(USE_RESOURCE_LEVEL_CALL_CONVERSION_ACTION);
use Google::Ads::GoogleAds::V24::Enums::AssetFieldTypeEnum qw(CALL);
...
sub add_call_asset {
  ...
  # Create the call asset.
  my $call_asset = Google::Ads::GoogleAds::V24::Common::CallAsset->new({
