...
use Google::Ads::GoogleAds::V18::Resources::PaymentsAccountInfo;
use
  Google::Ads::GoogleAds::V18::Services::BillingSetupService::BillingSetupOperation;
...
sub create_billing_setup {
  ...
  my $billing_setup =
    Google::Ads::GoogleAds::V18::Resources::BillingSetup->new();
  ...
  if (defined $payments_account_id) {
    ...
    $billing_setup->{paymentsAccount} =
      Google::Ads::GoogleAds::V18::Utils::ResourceNames::payments_account(
    ...
    $billing_setup->{paymentsAccountInfo} =
      Google::Ads::GoogleAds::V18::Resources::PaymentsAccountInfo->new({
