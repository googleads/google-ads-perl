...
use Google::Ads::GoogleAds::V7::Resources::BillingSetup;
use Google::Ads::GoogleAds::V7::Resources::PaymentsAccountInfo;
use
  Google::Ads::GoogleAds::V7::Services::BillingSetupService::BillingSetupOperation;
...
sub create_billing_setup {
  ...
  my $billing_setup =
    Google::Ads::GoogleAds::V7::Resources::BillingSetup->new();
  ...
  if (defined $payments_account_id) {
    ...
    $billing_setup->{paymentsAccount} =
      Google::Ads::GoogleAds::V7::Utils::ResourceNames::payments_account(
    ...
    $billing_setup->{paymentsAccountInfo} =
      Google::Ads::GoogleAds::V7::Resources::PaymentsAccountInfo->new({
