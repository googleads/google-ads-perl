...
use Google::Ads::GoogleAds::V13::Resources::PaymentsAccountInfo;
use
...
sub create_billing_setup {
  ...
  my $billing_setup =
    Google::Ads::GoogleAds::V13::Resources::BillingSetup->new();
  ...
  if (defined $payments_account_id) {
    ...
    $billing_setup->{paymentsAccount} =
      Google::Ads::GoogleAds::V13::Utils::ResourceNames::payments_account(
    ...
    $billing_setup->{paymentsAccountInfo} =
      Google::Ads::GoogleAds::V13::Resources::PaymentsAccountInfo->new({
