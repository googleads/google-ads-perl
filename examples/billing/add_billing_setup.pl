...
use Google::Ads::GoogleAds::V10::Resources::BillingSetup;
use Google::Ads::GoogleAds::V10::Resources::PaymentsAccountInfo;
use
...
sub create_billing_setup {
  ...
  my $billing_setup =
    Google::Ads::GoogleAds::V10::Resources::BillingSetup->new();
  ...
  if (defined $payments_account_id) {
    ...
    $billing_setup->{paymentsAccount} =
      Google::Ads::GoogleAds::V10::Utils::ResourceNames::payments_account(
    ...
    $billing_setup->{paymentsAccountInfo} =
      Google::Ads::GoogleAds::V10::Resources::PaymentsAccountInfo->new({
