...
use Google::Ads::GoogleAds::V24::Resources::AccountBudgetProposal;
use Google::Ads::GoogleAds::V24::Enums::AccountBudgetProposalTypeEnum
  qw(CREATE);
use Google::Ads::GoogleAds::V24::Enums::TimeTypeEnum qw(NOW FOREVER);
use
  Google::Ads::GoogleAds::V24::Services::AccountBudgetProposalService::AccountBudgetProposalOperation;
...
sub add_account_budget_proposal {
  ...
  my $account_budget_proposal =
    Google::Ads::GoogleAds::V24::Resources::AccountBudgetProposal->new({
      billingSetup =>
        Google::Ads::GoogleAds::V24::Utils::ResourceNames::billing_setup(
