...
use Google::Ads::GoogleAds::V5::Enums::AccountBudgetProposalTypeEnum qw(CREATE);
use Google::Ads::GoogleAds::V5::Enums::TimeTypeEnum qw(NOW FOREVER);
use
  Google::Ads::GoogleAds::V5::Services::AccountBudgetProposalService::AccountBudgetProposalOperation;
...
sub add_account_budget_proposal {
  ...
  my $account_budget_proposal =
    Google::Ads::GoogleAds::V5::Resources::AccountBudgetProposal->new({
      billingSetup =>
