...
use Google::Ads::GoogleAds::V4::Resources::AccountBudgetProposal;
use Google::Ads::GoogleAds::V4::Enums::AccountBudgetProposalTypeEnum qw(CREATE);
use Google::Ads::GoogleAds::V4::Enums::TimeTypeEnum qw(NOW FOREVER);
use
  Google::Ads::GoogleAds::V4::Services::AccountBudgetProposalService::AccountBudgetProposalOperation;
...
sub add_account_budget_proposal {
  ...
  my $account_budget_proposal =
    Google::Ads::GoogleAds::V4::Resources::AccountBudgetProposal->new({
      billingSetup =>
        Google::Ads::GoogleAds::V4::Utils::ResourceNames::billing_setup(
