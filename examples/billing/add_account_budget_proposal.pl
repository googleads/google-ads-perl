...
use Google::Ads::GoogleAds::V13::Resources::AccountBudgetProposal;
use Google::Ads::GoogleAds::V13::Enums::AccountBudgetProposalTypeEnum
  qw(CREATE);
use Google::Ads::GoogleAds::V13::Enums::TimeTypeEnum qw(NOW FOREVER);
use
  Google::Ads::GoogleAds::V13::Services::AccountBudgetProposalService::AccountBudgetProposalOperation;
...
sub add_account_budget_proposal {
  ...
  my $account_budget_proposal =
    Google::Ads::GoogleAds::V13::Resources::AccountBudgetProposal->new({
      billingSetup =>
