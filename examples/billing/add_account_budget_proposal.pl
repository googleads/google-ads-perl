...
use Google::Ads::GoogleAds::V15::Resources::AccountBudgetProposal;
use Google::Ads::GoogleAds::V15::Enums::AccountBudgetProposalTypeEnum
  qw(CREATE);
use Google::Ads::GoogleAds::V15::Enums::TimeTypeEnum qw(NOW FOREVER);
use
  Google::Ads::GoogleAds::V15::Services::AccountBudgetProposalService::AccountBudgetProposalOperation;
...
sub add_account_budget_proposal {
  ...
  my $account_budget_proposal =
    Google::Ads::GoogleAds::V15::Resources::AccountBudgetProposal->new({
      billingSetup =>
