...
use Google::Ads::GoogleAds::V11::Resources::AccountBudgetProposal;
use Google::Ads::GoogleAds::V11::Enums::AccountBudgetProposalTypeEnum
  qw(CREATE);
use Google::Ads::GoogleAds::V11::Enums::TimeTypeEnum qw(NOW FOREVER);
use
