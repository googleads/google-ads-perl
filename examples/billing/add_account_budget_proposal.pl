...
use Google::Ads::GoogleAds::V1::Resources::AccountBudgetProposal;
use Google::Ads::GoogleAds::V1::Enums::AccountBudgetProposalTypeEnum qw(CREATE);
use Google::Ads::GoogleAds::V1::Enums::TimeTypeEnum qw(NOW FOREVER);
use
  Google::Ads::GoogleAds::V1::Services::AccountBudgetProposalService::AccountBudgetProposalOperation;
...
sub add_account_budget_proposal {
  ...
  my $account_budget_proposal_response =
    $client->AccountBudgetProposalService()->mutate({
...
# Call the example.
add_account_budget_proposal($client, $customer_id =~ s/-//gr,
  $billing_setup_id);
