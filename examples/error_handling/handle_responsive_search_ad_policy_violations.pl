...
use Google::Ads::GoogleAds::V24::Common::PolicyValidationParameter;
use Google::Ads::GoogleAds::V24::Enums::AdGroupStatusEnum qw(PAUSED);
...
sub request_exemption {
  ...
  $ad_group_ad_operation->{policyValidationParameter} =
    Google::Ads::GoogleAds::V24::Common::PolicyValidationParameter->new(
