...
use Google::Ads::GoogleAds::V19::Common::PolicyValidationParameter;
use Google::Ads::GoogleAds::V19::Enums::AdGroupStatusEnum qw(PAUSED);
...
sub request_exemption {
  ...
  $ad_group_ad_operation->{policyValidationParameter} =
    Google::Ads::GoogleAds::V19::Common::PolicyValidationParameter->new(
