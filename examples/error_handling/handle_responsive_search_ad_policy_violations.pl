...
use Google::Ads::GoogleAds::V20::Common::PolicyValidationParameter;
use Google::Ads::GoogleAds::V20::Enums::AdGroupStatusEnum qw(PAUSED);
...
sub request_exemption {
  ...
  $ad_group_ad_operation->{policyValidationParameter} =
    Google::Ads::GoogleAds::V20::Common::PolicyValidationParameter->new(
