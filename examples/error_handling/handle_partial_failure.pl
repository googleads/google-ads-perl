...
sub create_ad_groups {
  ...
  # params exists.
  my $ad_group1 = Google::Ads::GoogleAds::V19::Resources::AdGroup->new({
  ...
  # valid.
  my $ad_group2 = Google::Ads::GoogleAds::V19::Resources::AdGroup->new({
  ...
  my $ad_group3 = Google::Ads::GoogleAds::V19::Resources::AdGroup->new({
    name     => $ad_group1->{name},
    campaign => $campaign_resource_name
  });
