...
sub handle_partial_failure {
  ...
  my $ad_group1 = Google::Ads::GoogleAds::V1::Resources::AdGroup->new({
  ...
  # never valid.
  my $ad_group2 = Google::Ads::GoogleAds::V1::Resources::AdGroup->new({
      campaign => Google::Ads::GoogleAds::V1::Utils::ResourceNames::campaign(
        $customer_id, 0
      ),
  ...
  my $ad_group3 = Google::Ads::GoogleAds::V1::Resources::AdGroup->new({
      campaign => Google::Ads::GoogleAds::V1::Utils::ResourceNames::campaign(
        $customer_id, $campaign_id
      ),
      name => $ad_group1->{name}});
...
# Call the example.
handle_partial_failure($client, $customer_id =~ s/-//gr, $campaign_id);
