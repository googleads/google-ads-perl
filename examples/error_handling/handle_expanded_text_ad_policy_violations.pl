...
use Google::Ads::GoogleAds::V11::Common::PolicyValidationParameter;
use Google::Ads::GoogleAds::V11::Enums::AdGroupStatusEnum qw(PAUSED);
...
sub request_exemption {
  ...
  $ad_group_ad_operation->{policyValidationParameter} =
    Google::Ads::GoogleAds::V11::Common::PolicyValidationParameter->new(
