...
use Google::Ads::GoogleAds::V13::Enums::ServedAssetFieldTypeEnum qw(HEADLINE_1);
use Google::Ads::GoogleAds::V13::Services::AdService::AdOperation;
...
sub update_responsive_search_ad {
  ...
  my $ad = Google::Ads::GoogleAds::V13::Resources::Ad->new({
      resourceName => Google::Ads::GoogleAds::V13::Utils::ResourceNames::ad(
        $customer_id, $ad_id
      ),
      responsiveSearchAd =>
  ...
  # the update mask.
  my $ad_operation =
    Google::Ads::GoogleAds::V13::Services::AdService::AdOperation->new({
      update     => $ad,
