...
use Google::Ads::GoogleAds::V2::Common::ResponsiveSearchAdInfo;
use Google::Ads::GoogleAds::V2::Enums::ServedAssetFieldTypeEnum qw(HEADLINE_1);
...
sub add_responsive_search_ad {
  ...
  my $pinned_headline = Google::Ads::GoogleAds::V2::Common::AdTextAsset->new({
  ...
  my $responsive_search_ad_info =
    Google::Ads::GoogleAds::V2::Common::ResponsiveSearchAdInfo->new({
      headlines => [
        $pinned_headline,
...
sub create_ad_text_asset {
  my $text = shift;
  return Google::Ads::GoogleAds::V2::Common::AdTextAsset->new({
    text => $text
  });
}
