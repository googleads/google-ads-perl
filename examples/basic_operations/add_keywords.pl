...
#
# This example demonstrates how to add a keyword to an ad group. To get
# keywords, run get_keywords.pl.
...
use Google::Ads::GoogleAds::V1::Enums::KeywordMatchTypeEnum qw(EXACT);
use
...
sub add_keywords {
  my ($client, $customer_id, $ad_group_id, $keyword) = @_;
...
# Call the example.
add_keywords($client, $customer_id =~ s/-//gr, $ad_group_id, $keyword);
