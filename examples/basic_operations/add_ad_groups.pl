...
use Google::Ads::GoogleAds::V1::Enums::AdGroupStatusEnum qw(ENABLED);
use Google::Ads::GoogleAds::V1::Enums::AdGroupTypeEnum qw(SEARCH_STANDARD);
...
sub add_ad_groups {
  ...
  # Add the ad group.
  my $ad_group_response = $client->AdGroupService()->mutate({
...
# Call the example.
add_ad_groups($client, $customer_id =~ s/-//gr, $campaign_id);
