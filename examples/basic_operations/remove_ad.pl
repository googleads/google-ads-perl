...
sub remove_ad {
  ...
  my $ad_group_ad_operation =
    ...
    ->new({
      remove => Google::Ads::GoogleAds::V1::Utils::ResourceNames::ad_group_ad(
        $customer_id, $ad_group_id, $ad_id
      )});

  # Remove the ad group ad.
...
# Call the example.
remove_ad($client, $customer_id =~ s/-//gr, $ad_group_id, $ad_id);
