...
use Google::Ads::GoogleAds::V1::Enums::AdGroupStatusEnum qw(PAUSED);
...
sub update_ad_group {
  my ($client, $customer_id, $ad_group_id, $bid_micro_amount) = @_;
  ...
  my $ad_group = Google::Ads::GoogleAds::V1::Resources::AdGroup->new({
      resourceName =>
        Google::Ads::GoogleAds::V1::Utils::ResourceNames::ad_group(
  ...
  my $ad_group_operation =
    Google::Ads::GoogleAds::V1::Services::AdGroupService::AdGroupOperation->new(
    {
      update     => $ad_group,
...
# Call the example.
update_ad_group($client, $customer_id =~ s/-//gr,
