...
use Google::Ads::GoogleAds::V1::Enums::AdGroupAdStatusEnum qw(PAUSED);
...
sub pause_ad {
  my ($client, $customer_id, $ad_group_id, $ad_id) = @_;
  ...
  my $ad_group_ad_response = $client->AdGroupAdService()->mutate({
...
# Call the example.
pause_ad($client, $customer_id =~ s/-//gr, $ad_group_id, $ad_id);
