...
#
# This example gets ad groups for a customer or for a specific campaign.
# To add ad groups, run add_ad_groups.pl.
...
# Call the example.
get_ad_groups($client, $customer_id =~ s/-//gr, $campaign_id);
