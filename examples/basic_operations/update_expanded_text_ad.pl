...
use Google::Ads::GoogleAds::V4::Services::AdService::AdOperation;
...
sub update_expanded_text_ad {
  ...
  my $ad = Google::Ads::GoogleAds::V4::Resources::Ad->new({
      resourceName => Google::Ads::GoogleAds::V4::Utils::ResourceNames::ad(
        $customer_id, $ad_id
      ),
      expandedTextAd =>
  ...
  # the update mask.
  my $ad_operation =
    Google::Ads::GoogleAds::V4::Services::AdService::AdOperation->new({
      update     => $ad,
