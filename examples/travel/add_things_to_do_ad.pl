...
use Google::Ads::GoogleAds::V19::Resources::TravelCampaignSettings;
use Google::Ads::GoogleAds::V19::Common::MaximizeConversionValue;
use Google::Ads::GoogleAds::V19::Common::TravelAdInfo;
...
use Google::Ads::GoogleAds::V19::Enums::AdGroupTypeEnum qw(TRAVEL_ADS);
use Google::Ads::GoogleAds::V19::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V19::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V19::Enums::AdvertisingChannelTypeEnum qw(TRAVEL);
...
sub add_things_to_do_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V19::Resources::Campaign->new({
      ...
      travelCampaignSettings    =>
        Google::Ads::GoogleAds::V19::Resources::TravelCampaignSettings->new({
      ...
      maximizeConversionValue =>
        Google::Ads::GoogleAds::V19::Common::MaximizeConversionValue->new(),
      # Set the budget.
...
sub add_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V19::Resources::AdGroupAd->new({
      ...
      ad      => Google::Ads::GoogleAds::V19::Resources::Ad->new({
          travelAd => Google::Ads::GoogleAds::V19::Common::TravelAdInfo->new()}
      ),
