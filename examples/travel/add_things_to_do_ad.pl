...
use Google::Ads::GoogleAds::V18::Resources::TravelCampaignSettings;
...
use Google::Ads::GoogleAds::V18::Enums::AdGroupTypeEnum qw(TRAVEL_ADS);
use Google::Ads::GoogleAds::V18::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V18::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V18::Enums::AdvertisingChannelTypeEnum qw(TRAVEL);
...
sub add_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V18::Resources::AdGroupAd->new({
      ...
      ad      => Google::Ads::GoogleAds::V18::Resources::Ad->new({
          travelAd => Google::Ads::GoogleAds::V18::Common::TravelAdInfo->new()}
      ),
