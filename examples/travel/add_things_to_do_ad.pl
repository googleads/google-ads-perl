...
use Google::Ads::GoogleAds::V22::Resources::TravelCampaignSettings;
use Google::Ads::GoogleAds::V22::Common::MaximizeConversionValue;
use Google::Ads::GoogleAds::V22::Common::TravelAdInfo;
...
use Google::Ads::GoogleAds::V22::Enums::AdGroupTypeEnum qw(TRAVEL_ADS);
use Google::Ads::GoogleAds::V22::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V22::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V22::Enums::AdvertisingChannelTypeEnum qw(TRAVEL);
...
sub add_things_to_do_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V22::Resources::Campaign->new({
      ...
      travelCampaignSettings    =>
        Google::Ads::GoogleAds::V22::Resources::TravelCampaignSettings->new({
      ...
      maximizeConversionValue =>
        Google::Ads::GoogleAds::V22::Common::MaximizeConversionValue->new(),
      # Set the budget.
...
sub add_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V22::Resources::AdGroupAd->new({
      ...
      ad      => Google::Ads::GoogleAds::V22::Resources::Ad->new({
          travelAd => Google::Ads::GoogleAds::V22::Common::TravelAdInfo->new()}
      ),
      ...
      # or campaign level.
      status => Google::Ads::GoogleAds::V22::Enums::AdGroupAdStatusEnum::ENABLED
    });
