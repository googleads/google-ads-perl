...
use Google::Ads::GoogleAds::V15::Resources::NetworkSettings;
...
use Google::Ads::GoogleAds::V15::Resources::TravelCampaignSettings;
use Google::Ads::GoogleAds::V15::Common::MaximizeConversionValue;
use Google::Ads::GoogleAds::V15::Common::TravelAdInfo;
...
use Google::Ads::GoogleAds::V15::Enums::AdGroupTypeEnum qw(TRAVEL_ADS);
use Google::Ads::GoogleAds::V15::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V15::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V15::Enums::AdvertisingChannelTypeEnum qw(TRAVEL);
...
sub add_things_to_do_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V15::Resources::Campaign->new({
      ...
      travelCampaignSettings    =>
        Google::Ads::GoogleAds::V15::Resources::TravelCampaignSettings->new({
      ...
      maximizeConversionValue =>
        Google::Ads::GoogleAds::V15::Common::MaximizeConversionValue->new(),
      # Set the budget.
      campaignBudget => $budget_resource_name,
      # Configure the campaign network options. Only Google Search is allowed for
      # Things to do campaigns.
      networkSettings =>
        Google::Ads::GoogleAds::V15::Resources::NetworkSettings->new({
...
sub add_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V15::Resources::AdGroupAd->new({
      ...
      ad      => Google::Ads::GoogleAds::V15::Resources::Ad->new({
          travelAd => Google::Ads::GoogleAds::V15::Common::TravelAdInfo->new()}
      ),
      ...
      # or campaign level.
      status => Google::Ads::GoogleAds::V15::Enums::AdGroupAdStatusEnum::ENABLED
    });
