...
use Google::Ads::GoogleAds::V25::Resources::TravelCampaignSettings;
use Google::Ads::GoogleAds::V25::Common::MaximizeConversionValue;
use Google::Ads::GoogleAds::V25::Common::TravelAdInfo;
...
use Google::Ads::GoogleAds::V25::Enums::AdGroupTypeEnum qw(TRAVEL_ADS);
use Google::Ads::GoogleAds::V25::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V25::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V25::Enums::AdvertisingChannelTypeEnum qw(TRAVEL);
