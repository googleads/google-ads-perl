...
use Google::Ads::GoogleAds::V16::Resources::TravelCampaignSettings;
use Google::Ads::GoogleAds::V16::Common::MaximizeConversionValue;
use Google::Ads::GoogleAds::V16::Common::TravelAdInfo;
...
use Google::Ads::GoogleAds::V16::Enums::AdGroupTypeEnum qw(TRAVEL_ADS);
use Google::Ads::GoogleAds::V16::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V16::Enums::AdGroupAdStatusEnum;
use Google::Ads::GoogleAds::V16::Enums::AdvertisingChannelTypeEnum qw(TRAVEL);
