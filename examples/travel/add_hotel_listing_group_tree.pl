...
use Google::Ads::GoogleAds::V14::Common::HotelClassInfo;
use Google::Ads::GoogleAds::V14::Common::HotelCountryRegionInfo;
use Google::Ads::GoogleAds::V14::Enums::ListingGroupTypeEnum
  qw(SUBDIVISION UNIT);
use Google::Ads::GoogleAds::V14::Enums::AdGroupCriterionStatusEnum qw(ENABLED);
use
...
sub add_level_1_nodes {
  ...
  my $five_starred_dimension_info =
    Google::Ads::GoogleAds::V14::Common::ListingDimensionInfo->new({
      hotelClass => Google::Ads::GoogleAds::V14::Common::HotelClassInfo->new({
          value => 5
        })});
...
sub add_level_2_nodes {
  ...
  my $japan_dimension_info =
    Google::Ads::GoogleAds::V14::Common::ListingDimensionInfo->new({
      ...
      hotelCountryRegion =>
        Google::Ads::GoogleAds::V14::Common::HotelCountryRegionInfo->new({
