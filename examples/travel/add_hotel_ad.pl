...
use Google::Ads::GoogleAds::V24::Resources::HotelSettingInfo;
...
use Google::Ads::GoogleAds::V24::Enums::AdvertisingChannelTypeEnum qw(HOTEL);
use Google::Ads::GoogleAds::V24::Enums::AdGroupTypeEnum qw(HOTEL_ADS);
...
sub add_hotel_campaign {
  ...
  my $campaign = Google::Ads::GoogleAds::V24::Resources::Campaign->new({
      ...
      hotelSetting           =>
        Google::Ads::GoogleAds::V24::Resources::HotelSettingInfo->new({
      ...
      percentCpc => Google::Ads::GoogleAds::V24::Common::PercentCpc->new(
...
sub add_hotel_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V24::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V24::Resources::Ad->new({
          hotelAd => Google::Ads::GoogleAds::V24::Common::HotelAdInfo->new()}
      ),
