...
use Google::Ads::GoogleAds::V22::Resources::HotelSettingInfo;
...
use Google::Ads::GoogleAds::V22::Common::HotelAdInfo;
use Google::Ads::GoogleAds::V22::Enums::BudgetDeliveryMethodEnum   qw(STANDARD);
use Google::Ads::GoogleAds::V22::Enums::AdvertisingChannelTypeEnum qw(HOTEL);
use Google::Ads::GoogleAds::V22::Enums::AdGroupTypeEnum qw(HOTEL_ADS);
...
sub add_hotel_ad_group_ad {
  ...
  my $ad_group_ad = Google::Ads::GoogleAds::V22::Resources::AdGroupAd->new({
      ...
      ad => Google::Ads::GoogleAds::V22::Resources::Ad->new({
          hotelAd => Google::Ads::GoogleAds::V22::Common::HotelAdInfo->new()}
      ),
