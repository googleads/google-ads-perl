...
use Google::Ads::GoogleAds::V16::Resources::HotelSettingInfo;
...
use Google::Ads::GoogleAds::V16::Common::PercentCpc;
use Google::Ads::GoogleAds::V16::Common::HotelAdInfo;
use Google::Ads::GoogleAds::V16::Enums::BudgetDeliveryMethodEnum   qw(STANDARD);
use Google::Ads::GoogleAds::V16::Enums::AdvertisingChannelTypeEnum qw(HOTEL);
use Google::Ads::GoogleAds::V16::Enums::AdGroupTypeEnum qw(HOTEL_ADS);
