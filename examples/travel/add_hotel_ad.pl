...
use Google::Ads::GoogleAds::V25::Resources::HotelSettingInfo;
...
use Google::Ads::GoogleAds::V25::Common::PercentCpc;
use Google::Ads::GoogleAds::V25::Common::HotelAdInfo;
use Google::Ads::GoogleAds::V25::Enums::BudgetDeliveryMethodEnum   qw(STANDARD);
use Google::Ads::GoogleAds::V25::Enums::AdvertisingChannelTypeEnum qw(HOTEL);
use Google::Ads::GoogleAds::V25::Enums::AdGroupTypeEnum qw(HOTEL_ADS);
