...
use Google::Ads::GoogleAds::V19::Resources::AdGroupBidModifier;
use Google::Ads::GoogleAds::V19::Common::HotelCheckInDayInfo;
use Google::Ads::GoogleAds::V19::Common::HotelLengthOfStayInfo;
use Google::Ads::GoogleAds::V19::Enums::DayOfWeekEnum qw(MONDAY);
use
  Google::Ads::GoogleAds::V19::Services::AdGroupBidModifierService::AdGroupBidModifierOperation;
...
sub add_hotel_ad_group_bid_modifiers {
  ...
  my $check_in_day_ad_group_bid_modifier =
    Google::Ads::GoogleAds::V19::Resources::AdGroupBidModifier->new({
      # Set the ad group.
      adGroup => Google::Ads::GoogleAds::V19::Utils::ResourceNames::ad_group(
        $customer_id, $ad_group_id
      ),
      hotelCheckInDay =>
        Google::Ads::GoogleAds::V19::Common::HotelCheckInDayInfo->new({
          dayOfWeek => MONDAY
        }
        ),
  ...
  my $length_of_stay_ad_group_bid_modifier =
    Google::Ads::GoogleAds::V19::Resources::AdGroupBidModifier->new({
      ...
      hotelLengthOfStay =>
        Google::Ads::GoogleAds::V19::Common::HotelLengthOfStayInfo->new({
          minNights => 3,
          maxNights => 7
        }
        ),
