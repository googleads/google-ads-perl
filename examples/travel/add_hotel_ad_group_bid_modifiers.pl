...
use Google::Ads::GoogleAds::V25::Resources::AdGroupBidModifier;
use Google::Ads::GoogleAds::V25::Common::HotelCheckInDayInfo;
use Google::Ads::GoogleAds::V25::Common::HotelLengthOfStayInfo;
