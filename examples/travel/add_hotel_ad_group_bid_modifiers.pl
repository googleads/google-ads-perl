...
use Google::Ads::GoogleAds::V16::Resources::AdGroupBidModifier;
use Google::Ads::GoogleAds::V16::Common::HotelCheckInDayInfo;
use Google::Ads::GoogleAds::V16::Common::HotelLengthOfStayInfo;
