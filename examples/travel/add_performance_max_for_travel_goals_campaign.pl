...
use Google::Ads::GoogleAds::V24::Resources::AssetSet;
use Google::Ads::GoogleAds::V24::Resources::AssetSetAsset;
use Google::Ads::GoogleAds::V24::Common::CallToActionAsset;
use Google::Ads::GoogleAds::V24::Common::MaximizeConversionValue;
use Google::Ads::GoogleAds::V24::Common::TextAsset;
use Google::Ads::GoogleAds::V24::Common::HotelPropertyAsset;
...
use Google::Ads::GoogleAds::V24::Enums::HotelAssetSuggestionStatusEnum
  qw(SUCCESS);
...
use Google::Ads::GoogleAds::V24::Services::AssetSetService::AssetSetOperation;
use
  Google::Ads::GoogleAds::V24::Services::AssetSetAssetService::AssetSetAssetOperation;
...
sub create_hotel_asset_set {
  ...
  my $asset_set_operation =
    Google::Ads::GoogleAds::V24::Services::AssetSetService::AssetSetOperation->
    new({
      # Creates a hotel property asset set.
      create => Google::Ads::GoogleAds::V24::Resources::AssetSet->new({
...
sub create_hotel_asset {
  ...
  my $asset_resource_name =
    Google::Ads::GoogleAds::V24::Utils::ResourceNames::asset($customer_id,
    ASSET_TEMPORARY_ID);
      ...
      assetOperation =>
        ...
        new({
          create => Google::Ads::GoogleAds::V24::Resources::Asset->new({
              ...
              hotelPropertyAsset =>
                Google::Ads::GoogleAds::V24::Common::HotelPropertyAsset->new({
                  placeId => $place_id
                })})})});
  ...
  push @$operations,
    ...
    new({
      assetSetAssetOperation =>
        Google::Ads::GoogleAds::V24::Services::AssetSetAssetService::AssetSetAssetOperation
        ->new({
          create => Google::Ads::GoogleAds::V24::Resources::AssetSetAsset->new({
...
sub create_asset_group_operations {
  ...
  my $asset_group_resource_name =
    Google::Ads::GoogleAds::V24::Utils::ResourceNames::asset_group($customer_id,
        ...
        assetOperation =>
          ...
          new({
            create => Google::Ads::GoogleAds::V24::Resources::Asset->new({
                ...
                callToActionAsset =>
                  Google::Ads::GoogleAds::V24::Common::CallToActionAsset->new({
