...
use Google::Ads::GoogleAds::V18::Enums::AdvertisingChannelTypeEnum
  qw(PERFORMANCE_MAX);
use Google::Ads::GoogleAds::V18::Enums::AssetGroupStatusEnum;
use Google::Ads::GoogleAds::V18::Enums::AssetFieldTypeEnum
...
use Google::Ads::GoogleAds::V18::Enums::HotelAssetSuggestionStatusEnum
  qw(SUCCESS);
...
use Google::Ads::GoogleAds::V18::Services::AssetSetService::AssetSetOperation;
use
  Google::Ads::GoogleAds::V18::Services::AssetSetAssetService::AssetSetAssetOperation;
...
sub create_hotel_asset_set {
  ...
  my $asset_set_operation =
    Google::Ads::GoogleAds::V18::Services::AssetSetService::AssetSetOperation->
    new({
      # Creates a hotel property asset set.
      create => Google::Ads::GoogleAds::V18::Resources::AssetSet->new({
...
sub create_hotel_asset {
  ...
  my $asset_resource_name =
    Google::Ads::GoogleAds::V18::Utils::ResourceNames::asset($customer_id,
    ASSET_TEMPORARY_ID);
      ...
      assetOperation =>
        ...
        new({
          create => Google::Ads::GoogleAds::V18::Resources::Asset->new({
              ...
              hotelPropertyAsset =>
                Google::Ads::GoogleAds::V18::Common::HotelPropertyAsset->new({
                  placeId => $place_id
                })})})});
  ...
  push @$operations,
    ...
    new({
      assetSetAssetOperation =>
        Google::Ads::GoogleAds::V18::Services::AssetSetAssetService::AssetSetAssetOperation
        ->new({
          create => Google::Ads::GoogleAds::V18::Resources::AssetSetAsset->new({
...
sub create_asset_group_operations {
  ...
  my $asset_group_resource_name =
    Google::Ads::GoogleAds::V18::Utils::ResourceNames::asset_group($customer_id,
      ...
      ->new({
        assetOperation =>
          ...
          new({
            create => Google::Ads::GoogleAds::V18::Resources::Asset->new({
                resourceName =>
                  Google::Ads::GoogleAds::V18::Utils::ResourceNames::asset(
                  $customer_id, $next_temp_id
                  ),
                name => 'Suggested call-to-action asset #' . uniqid(),
                callToActionAsset =>
                  Google::Ads::GoogleAds::V18::Common::CallToActionAsset->new({
      ...
      assetOperation =>
        ...
        new({
          create => Google::Ads::GoogleAds::V18::Resources::Asset->new({
              ...
              textAsset => Google::Ads::GoogleAds::V18::Common::TextAsset->new({
                  text => $text
                })})})});
    ...
    new({
      assetGroupAssetOperation =>
        ...
        ->new({
          create =>
            Google::Ads::GoogleAds::V18::Resources::AssetGroupAsset->new({
              asset => Google::Ads::GoogleAds::V18::Utils::ResourceNames::asset(
                $customer_id, $next_temp_id
              ),
              assetGroup =>
                Google::Ads::GoogleAds::V18::Utils::ResourceNames::asset_group(
      ...
      assetOperation =>
        ...
        new({
          create => Google::Ads::GoogleAds::V18::Resources::Asset->new({
              ...
              name       => $asset_name,
              imageAsset =>
                Google::Ads::GoogleAds::V18::Common::ImageAsset->new({
