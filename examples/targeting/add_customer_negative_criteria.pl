...
use Google::Ads::GoogleAds::V13::Resources::CustomerNegativeCriterion;
use Google::Ads::GoogleAds::V13::Common::ContentLabelInfo;
use Google::Ads::GoogleAds::V13::Common::PlacementInfo;
use Google::Ads::GoogleAds::V13::Enums::ContentLabelTypeEnum qw(TRAGEDY);
...
sub add_customer_negative_criteria {
  ...
  my $tragedy_criterion =
    Google::Ads::GoogleAds::V13::Resources::CustomerNegativeCriterion->new({
      contentLabel =>
        Google::Ads::GoogleAds::V13::Common::ContentLabelInfo->new({
          type => TRAGEDY
        })});
  ...
  my $placement_criterion =
    Google::Ads::GoogleAds::V13::Resources::CustomerNegativeCriterion->new({
      placement => Google::Ads::GoogleAds::V13::Common::PlacementInfo->new({
