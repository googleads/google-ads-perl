...
use Google::Ads::GoogleAds::V12::Resources::CustomerNegativeCriterion;
use Google::Ads::GoogleAds::V12::Common::ContentLabelInfo;
use Google::Ads::GoogleAds::V12::Common::PlacementInfo;
use Google::Ads::GoogleAds::V12::Enums::ContentLabelTypeEnum qw(TRAGEDY);
...
sub add_customer_negative_criteria {
  ...
  my $tragedy_criterion =
    Google::Ads::GoogleAds::V12::Resources::CustomerNegativeCriterion->new({
      contentLabel =>
        Google::Ads::GoogleAds::V12::Common::ContentLabelInfo->new({
          type => TRAGEDY
        })});
  ...
  my $placement_criterion =
    Google::Ads::GoogleAds::V12::Resources::CustomerNegativeCriterion->new({
      placement => Google::Ads::GoogleAds::V12::Common::PlacementInfo->new({
