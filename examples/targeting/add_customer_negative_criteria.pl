...
use Google::Ads::GoogleAds::V14::Resources::CustomerNegativeCriterion;
use Google::Ads::GoogleAds::V14::Common::ContentLabelInfo;
use Google::Ads::GoogleAds::V14::Common::PlacementInfo;
use Google::Ads::GoogleAds::V14::Enums::ContentLabelTypeEnum qw(TRAGEDY);
...
sub add_customer_negative_criteria {
  ...
  my $tragedy_criterion =
    Google::Ads::GoogleAds::V14::Resources::CustomerNegativeCriterion->new({
      contentLabel =>
        Google::Ads::GoogleAds::V14::Common::ContentLabelInfo->new({
          type => TRAGEDY
        })});
  ...
  my $placement_criterion =
    Google::Ads::GoogleAds::V14::Resources::CustomerNegativeCriterion->new({
      placement => Google::Ads::GoogleAds::V14::Common::PlacementInfo->new({
