...
use Google::Ads::GoogleAds::V1::Resources::CustomerNegativeCriterion;
use Google::Ads::GoogleAds::V1::Common::ContentLabelInfo;
use Google::Ads::GoogleAds::V1::Common::PlacementInfo;
use Google::Ads::GoogleAds::V1::Enums::ContentLabelTypeEnum qw(TRAGEDY);
...
sub add_customer_negative_criteria {
  ...
  my $tragedy_criterion =
    Google::Ads::GoogleAds::V1::Resources::CustomerNegativeCriterion->new({
      contentLabel => Google::Ads::GoogleAds::V1::Common::ContentLabelInfo->new(
        {
          type => TRAGEDY
        })});
  ...
  my $placement_criterion =
    Google::Ads::GoogleAds::V1::Resources::CustomerNegativeCriterion->new({
      placement => Google::Ads::GoogleAds::V1::Common::PlacementInfo->new({
  ...
  my $customer_negative_criterion_response =
    $client->CustomerNegativeCriterionService()->mutate({
...
# Call the example.
add_customer_negative_criteria($client, $customer_id =~ s/-//gr);
