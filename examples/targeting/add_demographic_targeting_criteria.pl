...
use Google::Ads::GoogleAds::V5::Enums::GenderTypeEnum qw(MALE);
use Google::Ads::GoogleAds::V5::Enums::AgeRangeTypeEnum qw(AGE_RANGE_18_24);
use
...
sub add_demographic_targeting_criteria {
  ...
  my $ad_group_resource_name =
    Google::Ads::GoogleAds::V5::Utils::ResourceNames::ad_group($customer_id,
    $ad_group_id);
  ...
  my $gender_ad_group_criterion =
    Google::Ads::GoogleAds::V5::Resources::AdGroupCriterion->new({
      ...
      # Target male.
      gender => Google::Ads::GoogleAds::V5::Common::GenderInfo->new({
          type => MALE
        })});
  ...
  my $age_range_negative_ad_group_criterion =
    Google::Ads::GoogleAds::V5::Resources::AdGroupCriterion->new({
      ...
      ageRange => Google::Ads::GoogleAds::V5::Common::AgeRangeInfo->new({
