...
use Google::Ads::GoogleAds::V7::Common::ProximityInfo;
use Google::Ads::GoogleAds::V7::Common::AddressInfo;
use Google::Ads::GoogleAds::V7::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V7::Enums::ProximityRadiusUnitsEnum qw(MILES);
use
