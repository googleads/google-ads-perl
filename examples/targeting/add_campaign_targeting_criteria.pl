...
use Google::Ads::GoogleAds::V6::Common::ProximityInfo;
use Google::Ads::GoogleAds::V6::Common::AddressInfo;
use Google::Ads::GoogleAds::V6::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V6::Enums::ProximityRadiusUnitsEnum qw(MILES);
use
...
sub create_proximity_campaign_criterion_operation {
  ...
  my $campaign_criterion =
    Google::Ads::GoogleAds::V6::Resources::CampaignCriterion->new({
      proximity => Google::Ads::GoogleAds::V6::Common::ProximityInfo->new({
          address => Google::Ads::GoogleAds::V6::Common::AddressInfo->new({
