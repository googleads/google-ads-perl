...
use Google::Ads::GoogleAds::V5::Common::ProximityInfo;
use Google::Ads::GoogleAds::V5::Common::AddressInfo;
use Google::Ads::GoogleAds::V5::Enums::KeywordMatchTypeEnum qw(BROAD);
use Google::Ads::GoogleAds::V5::Enums::ProximityRadiusUnitsEnum qw(MILES);
use
...
sub create_proximity_campaign_criterion_operation {
  ...
  my $campaign_criterion =
    Google::Ads::GoogleAds::V5::Resources::CampaignCriterion->new({
      proximity => Google::Ads::GoogleAds::V5::Common::ProximityInfo->new({
          address => Google::Ads::GoogleAds::V5::Common::AddressInfo->new({
