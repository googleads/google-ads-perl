...
use
  Google::Ads::GoogleAds::V10::Services::ConversionUploadService::CallConversion;
use
  Google::Ads::GoogleAds::V10::Services::ConversionUploadService::CustomVariable;
      ...
      Google::Ads::GoogleAds::V10::Services::ConversionUploadService::CustomVariable
        ->new({
          conversionCustomVariable =>
            Google::Ads::GoogleAds::V10::Utils::ResourceNames::conversion_custom_variable(
