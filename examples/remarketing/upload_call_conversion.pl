...
use
  Google::Ads::GoogleAds::V11::Services::ConversionUploadService::CallConversion;
use
  Google::Ads::GoogleAds::V11::Services::ConversionUploadService::CustomVariable;
      ...
      Google::Ads::GoogleAds::V11::Services::ConversionUploadService::CustomVariable
        ->new({
          conversionCustomVariable =>
            Google::Ads::GoogleAds::V11::Utils::ResourceNames::conversion_custom_variable(
