...
use Google::Ads::GoogleAds::V25::Resources::FeedItemAttributeValue;
use Google::Ads::GoogleAds::V25::Resources::AdGroup;
use Google::Ads::GoogleAds::V25::Common::TargetingSetting;
use Google::Ads::GoogleAds::V25::Common::TargetRestriction;
use Google::Ads::GoogleAds::V25::Enums::TargetingDimensionEnum qw(AUDIENCE);
...
sub update_audience_target_restriction {
  ...
  my $targeting_setting =
    Google::Ads::GoogleAds::V25::Common::TargetingSetting->new();
