...
use Google::Ads::GoogleAds::V20::Resources::FeedItemAttributeValue;
use Google::Ads::GoogleAds::V20::Resources::AdGroup;
use Google::Ads::GoogleAds::V20::Common::TargetingSetting;
use Google::Ads::GoogleAds::V20::Common::TargetRestriction;
use Google::Ads::GoogleAds::V20::Enums::TargetingDimensionEnum qw(AUDIENCE);
    ...
    sub {
      ...
      foreach my $target_restriction (@target_restrictions) {
        ...
        if ($targeting_dimension ne AUDIENCE) {
          ...
          my $new_restriction =
            Google::Ads::GoogleAds::V20::Common::TargetRestriction->new({
