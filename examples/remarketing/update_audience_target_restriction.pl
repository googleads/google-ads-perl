...
use Google::Ads::GoogleAds::V19::Resources::FeedItemAttributeValue;
use Google::Ads::GoogleAds::V19::Resources::AdGroup;
use Google::Ads::GoogleAds::V19::Common::TargetingSetting;
use Google::Ads::GoogleAds::V19::Common::TargetRestriction;
use Google::Ads::GoogleAds::V19::Enums::TargetingDimensionEnum qw(AUDIENCE);
...
sub update_audience_target_restriction {
  ...
  my $targeting_setting =
    Google::Ads::GoogleAds::V19::Common::TargetingSetting->new();
    ...
    sub {
      ...
      foreach my $target_restriction (@target_restrictions) {
        ...
        if ($targeting_dimension ne AUDIENCE) {
          ...
          my $new_restriction =
            Google::Ads::GoogleAds::V19::Common::TargetRestriction->new({
