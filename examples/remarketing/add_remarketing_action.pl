...
use Google::Ads::GoogleAds::V8::Resources::RemarketingAction;
use
  Google::Ads::GoogleAds::V8::Services::RemarketingActionService::RemarketingActionOperation;
...
sub add_remarketing_action {
  ...
  my $remarketing_action =
    Google::Ads::GoogleAds::V8::Resources::RemarketingAction->new({
