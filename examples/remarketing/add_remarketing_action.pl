...
use Google::Ads::GoogleAds::V7::Resources::RemarketingAction;
use
  Google::Ads::GoogleAds::V7::Services::RemarketingActionService::RemarketingActionOperation;
...
sub add_remarketing_action {
  ...
  my $remarketing_action =
    Google::Ads::GoogleAds::V7::Resources::RemarketingAction->new({
