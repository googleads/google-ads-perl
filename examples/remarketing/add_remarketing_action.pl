...
use Google::Ads::GoogleAds::V6::Resources::RemarketingAction;
use
  Google::Ads::GoogleAds::V6::Services::RemarketingActionService::RemarketingActionOperation;
...
sub add_remarketing_action {
  ...
  my $remarketing_action =
    Google::Ads::GoogleAds::V6::Resources::RemarketingAction->new({
