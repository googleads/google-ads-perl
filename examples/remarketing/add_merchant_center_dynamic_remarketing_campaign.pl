...
use Google::Ads::GoogleAds::V22::Enums::AdvertisingChannelTypeEnum qw(DISPLAY);
use Google::Ads::GoogleAds::V22::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V22::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V22::Enums::DisplayAdFormatSettingEnum
  qw(NON_NATIVE);
...
sub create_ad {
  ...
  my $responsive_display_ad_info =
    Google::Ads::GoogleAds::V22::Common::ResponsiveDisplayAdInfo->new({
      marketingImages => [
      ...
      longHeadline => Google::Ads::GoogleAds::V22::Common::AdTextAsset->new({
