...
use Google::Ads::GoogleAds::V10::Resources::ShoppingSetting;
...
use Google::Ads::GoogleAds::V10::Common::ResponsiveDisplayAdInfo;
...
use Google::Ads::GoogleAds::V10::Common::UserListInfo;
use Google::Ads::GoogleAds::V10::Enums::AdvertisingChannelTypeEnum qw(DISPLAY);
use Google::Ads::GoogleAds::V10::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V10::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V10::Enums::DisplayAdFormatSettingEnum
  qw(NON_NATIVE);
use Google::Ads::GoogleAds::V10::Enums::AssetTypeEnum qw(IMAGE);
...
sub create_campaign {
  ...
  my $shopping_settings =
    Google::Ads::GoogleAds::V10::Resources::ShoppingSetting->new({
      campaignPriority => 0,
...
sub create_ad {
  ...
  my $responsive_display_ad_info =
    Google::Ads::GoogleAds::V10::Common::ResponsiveDisplayAdInfo->new({
      marketingImages => [
      ...
      longHeadline => Google::Ads::GoogleAds::V10::Common::AdTextAsset->new({
...
sub attach_user_list {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V10::Resources::AdGroupCriterion->new({
      adGroup  => $ad_group_resource_name,
      userList => Google::Ads::GoogleAds::V10::Common::UserListInfo->new({
          userList =>
            Google::Ads::GoogleAds::V10::Utils::ResourceNames::user_list(
