...
use Google::Ads::GoogleAds::V13::Common::ResponsiveDisplayAdInfo;
...
use Google::Ads::GoogleAds::V13::Enums::AdvertisingChannelTypeEnum qw(DISPLAY);
use Google::Ads::GoogleAds::V13::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V13::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V13::Enums::DisplayAdFormatSettingEnum
  qw(NON_NATIVE);
use Google::Ads::GoogleAds::V13::Enums::AssetTypeEnum qw(IMAGE);
...
sub create_ad {
  ...
  my $responsive_display_ad_info =
    Google::Ads::GoogleAds::V13::Common::ResponsiveDisplayAdInfo->new({
      marketingImages => [
      ...
      longHeadline => Google::Ads::GoogleAds::V13::Common::AdTextAsset->new({
...
sub upload_asset {
  ...
  my $asset = Google::Ads::GoogleAds::V13::Resources::Asset->new({
      name       => $asset_name,
      type       => IMAGE,
      imageAsset => Google::Ads::GoogleAds::V13::Common::ImageAsset->new({
          data => $image_data
        })});
