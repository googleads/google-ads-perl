...
use Google::Ads::GoogleAds::V25::Common::ResponsiveDisplayAdInfo;
...
use Google::Ads::GoogleAds::V25::Enums::AdvertisingChannelTypeEnum qw(DISPLAY);
use Google::Ads::GoogleAds::V25::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V25::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V25::Enums::DisplayAdFormatSettingEnum
  qw(NON_NATIVE);
