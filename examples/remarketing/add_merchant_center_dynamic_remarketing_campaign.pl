...
use Google::Ads::GoogleAds::V15::Enums::AdvertisingChannelTypeEnum qw(DISPLAY);
use Google::Ads::GoogleAds::V15::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V15::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V15::Enums::DisplayAdFormatSettingEnum
  qw(NON_NATIVE);
use Google::Ads::GoogleAds::V15::Enums::AssetTypeEnum qw(IMAGE);
...
sub create_ad {
  ...
  my $responsive_display_ad_info =
    Google::Ads::GoogleAds::V15::Common::ResponsiveDisplayAdInfo->new({
      marketingImages => [
      ...
      longHeadline => Google::Ads::GoogleAds::V15::Common::AdTextAsset->new({
...
sub upload_asset {
  ...
  # Create an asset.
  my $asset = Google::Ads::GoogleAds::V15::Resources::Asset->new({
      name       => $asset_name,
      type       => IMAGE,
      imageAsset => Google::Ads::GoogleAds::V15::Common::ImageAsset->new({
          data => $image_data
        })});

  # Create an asset operation.
  my $asset_operation =
    Google::Ads::GoogleAds::V15::Services::AssetService::AssetOperation->new({
      create => $asset
    });
...
sub attach_user_list {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V15::Resources::AdGroupCriterion->new({
      adGroup  => $ad_group_resource_name,
      userList => Google::Ads::GoogleAds::V15::Common::UserListInfo->new({
          userList =>
            Google::Ads::GoogleAds::V15::Utils::ResourceNames::user_list(
