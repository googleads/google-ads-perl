...
use Google::Ads::GoogleAds::V9::Common::ResponsiveDisplayAdInfo;
...
use Google::Ads::GoogleAds::V9::Common::UserListInfo;
use Google::Ads::GoogleAds::V9::Enums::AdvertisingChannelTypeEnum qw(DISPLAY);
use Google::Ads::GoogleAds::V9::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V9::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V9::Enums::DisplayAdFormatSettingEnum
  qw(NON_NATIVE);
...
sub create_ad {
  ...
  my $responsive_display_ad_info =
    Google::Ads::GoogleAds::V9::Common::ResponsiveDisplayAdInfo->new({
      marketingImages => [
      ...
      longHeadline => Google::Ads::GoogleAds::V9::Common::AdTextAsset->new({
...
sub attach_user_list {
  ...
  my $ad_group_criterion =
    Google::Ads::GoogleAds::V9::Resources::AdGroupCriterion->new({
      adGroup  => $ad_group_resource_name,
      userList => Google::Ads::GoogleAds::V9::Common::UserListInfo->new({
          userList =>
            Google::Ads::GoogleAds::V9::Utils::ResourceNames::user_list(
