...
use Google::Ads::GoogleAds::V12::Enums::AdvertisingChannelTypeEnum qw(DISPLAY);
use Google::Ads::GoogleAds::V12::Enums::CampaignStatusEnum;
use Google::Ads::GoogleAds::V12::Enums::AdGroupStatusEnum;
use Google::Ads::GoogleAds::V12::Enums::DisplayAdFormatSettingEnum
  qw(NON_NATIVE);
use Google::Ads::GoogleAds::V12::Enums::AssetTypeEnum qw(IMAGE);
...
sub create_ad {
  ...
  my $responsive_display_ad_info =
    Google::Ads::GoogleAds::V12::Common::ResponsiveDisplayAdInfo->new({
      ...
      longHeadline => Google::Ads::GoogleAds::V12::Common::AdTextAsset->new({
...
sub upload_asset {
  ...
  my $asset = Google::Ads::GoogleAds::V12::Resources::Asset->new({
      name       => $asset_name,
      type       => IMAGE,
      imageAsset => Google::Ads::GoogleAds::V12::Common::ImageAsset->new({
          data => $image_data
        })});
