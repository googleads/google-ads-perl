...
use Google::Ads::GoogleAds::V16::Common::LogicalUserListOperandInfo;
use Google::Ads::GoogleAds::V16::Common::UserListLogicalRuleInfo;
use Google::Ads::GoogleAds::V16::Common::LogicalUserListInfo;
use Google::Ads::GoogleAds::V16::Enums::UserListLogicalRuleOperatorEnum qw(ANY);
