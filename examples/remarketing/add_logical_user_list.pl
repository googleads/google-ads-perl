...
use Google::Ads::GoogleAds::V12::Common::LogicalUserListOperandInfo;
use Google::Ads::GoogleAds::V12::Common::UserListLogicalRuleInfo;
use Google::Ads::GoogleAds::V12::Common::LogicalUserListInfo;
use Google::Ads::GoogleAds::V12::Enums::UserListLogicalRuleOperatorEnum qw(ANY);
...
sub add_logical_user_list {
  ...
  foreach my $user_list_id (@$user_list_ids) {
    push @$logical_user_list_operand_info_list,
      Google::Ads::GoogleAds::V12::Common::LogicalUserListOperandInfo->new({
        userList =>
  ...
  my $user_list_logical_rule_info =
    Google::Ads::GoogleAds::V12::Common::UserListLogicalRuleInfo->new({
  ...
  my $user_list = Google::Ads::GoogleAds::V12::Resources::UserList->new({
      ...
      logicalUserList =>
        Google::Ads::GoogleAds::V12::Common::LogicalUserListInfo->new({
