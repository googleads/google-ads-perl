...
use Google::Ads::GoogleAds::V18::Enums::UserListLogicalRuleOperatorEnum qw(ANY);
...
sub add_logical_user_list {
  ...
  foreach my $user_list_id (@$user_list_ids) {
    push @$logical_user_list_operand_info_list,
      Google::Ads::GoogleAds::V18::Common::LogicalUserListOperandInfo->new({
        userList =>
  ...
  my $user_list_logical_rule_info =
    Google::Ads::GoogleAds::V18::Common::UserListLogicalRuleInfo->new({
  ...
  my $user_list = Google::Ads::GoogleAds::V18::Resources::UserList->new({
      ...
      logicalUserList =>
        Google::Ads::GoogleAds::V18::Common::LogicalUserListInfo->new({
