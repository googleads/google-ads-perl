...
use Google::Ads::GoogleAds::V25::Common::LogicalUserListOperandInfo;
use Google::Ads::GoogleAds::V25::Common::UserListLogicalRuleInfo;
use Google::Ads::GoogleAds::V25::Common::LogicalUserListInfo;
use Google::Ads::GoogleAds::V25::Enums::UserListLogicalRuleOperatorEnum qw(ANY);
