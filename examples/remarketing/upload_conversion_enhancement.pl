...
use Google::Ads::GoogleAds::V9::Enums::ConversionAdjustmentTypeEnum
  qw(ENHANCEMENT);
use Google::Ads::GoogleAds::V9::Enums::UserIdentifierSourceEnum qw(FIRST_PARTY);
use
  Google::Ads::GoogleAds::V9::Services::ConversionAdjustmentUploadService::ConversionAdjustment;
use
  Google::Ads::GoogleAds::V9::Services::ConversionAdjustmentUploadService::GclidDateTimePair;
use
  Google::Ads::GoogleAds::V9::Services::ConversionAdjustmentUploadService::RestatementValue;
