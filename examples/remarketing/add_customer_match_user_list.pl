...
use Google::Ads::GoogleAds::V25::Common::CrmBasedUserListInfo;
use Google::Ads::GoogleAds::V25::Common::CustomerMatchUserListMetadata;
...
use Google::Ads::GoogleAds::V25::Enums::CustomerMatchUploadKeyTypeEnum
  qw(CONTACT_INFO);
use Google::Ads::GoogleAds::V25::Enums::OfflineUserDataJobStatusEnum
