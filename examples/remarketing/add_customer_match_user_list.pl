...
use Google::Ads::GoogleAds::V23::Common::CrmBasedUserListInfo;
use Google::Ads::GoogleAds::V23::Common::CustomerMatchUserListMetadata;
...
use Google::Ads::GoogleAds::V23::Enums::CustomerMatchUploadKeyTypeEnum
  qw(CONTACT_INFO);
use Google::Ads::GoogleAds::V23::Enums::OfflineUserDataJobStatusEnum
...
sub add_users_to_customer_match_user_list {
  ...
  if (!defined $offline_user_data_job_id) {
    ...
    my $offline_user_data_job =
      Google::Ads::GoogleAds::V23::Resources::OfflineUserDataJob->new({
        ...
        customerMatchUserListMetadata =>
          Google::Ads::GoogleAds::V23::Common::CustomerMatchUserListMetadata->
          new({
    ...
    if ($ad_personalization_consent or $ad_user_data_consent) {
      my $consent = Google::Ads::GoogleAds::V23::Common::Consent->new({});
    ...
    $offline_user_data_job_resource_name =
      Google::Ads::GoogleAds::V23::Utils::ResourceNames::offline_user_data_job(
