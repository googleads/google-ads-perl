...
use Google::Ads::GoogleAds::V12::Enums::CustomerMatchUploadKeyTypeEnum
  qw(CONTACT_INFO);
use Google::Ads::GoogleAds::V12::Enums::OfflineUserDataJobStatusEnum
  qw(SUCCESS FAILED PENDING RUNNING);
use Google::Ads::GoogleAds::V12::Enums::OfflineUserDataJobTypeEnum
  qw(CUSTOMER_MATCH_USER_LIST);
use Google::Ads::GoogleAds::V12::Services::UserListService::UserListOperation;
use
  Google::Ads::GoogleAds::V12::Services::OfflineUserDataJobService::OfflineUserDataJobOperation;
use
...
sub create_customer_match_user_list {
  ...
  my $user_list = Google::Ads::GoogleAds::V12::Resources::UserList->new({
      ...
      crmBasedUserList   =>
        Google::Ads::GoogleAds::V12::Common::CrmBasedUserListInfo->new({
...
sub add_users_to_customer_match_user_list {
  ...
  my $offline_user_data_job =
    Google::Ads::GoogleAds::V12::Resources::OfflineUserDataJob->new({
      type                          => CUSTOMER_MATCH_USER_LIST,
      customerMatchUserListMetadata =>
        Google::Ads::GoogleAds::V12::Common::CustomerMatchUserListMetadata->new(
        {
