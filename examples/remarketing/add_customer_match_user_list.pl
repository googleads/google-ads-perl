...
use Google::Ads::GoogleAds::V19::Enums::CustomerMatchUploadKeyTypeEnum
  qw(CONTACT_INFO);
use Google::Ads::GoogleAds::V19::Enums::OfflineUserDataJobStatusEnum
...
sub create_customer_match_user_list {
  ...
  my $user_list = Google::Ads::GoogleAds::V19::Resources::UserList->new({
      ...
      # a CREATE operation.
      crmBasedUserList =>
        Google::Ads::GoogleAds::V19::Common::CrmBasedUserListInfo->new({
...
"Skipping addition of mailing address information because the following"
        ...
        push(
          ...
          Google::Ads::GoogleAds::V19::Common::UserIdentifier->new({
              addressInfo =>
                Google::Ads::GoogleAds::V19::Common::OfflineUserAddressInfo->
                new({
