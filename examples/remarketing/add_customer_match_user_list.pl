...
use Google::Ads::GoogleAds::V24::Common::CustomerMatchUserListMetadata;
use Google::Ads::GoogleAds::V24::Common::UserData;
use Google::Ads::GoogleAds::V24::Common::UserIdentifier;
use Google::Ads::GoogleAds::V24::Common::OfflineUserAddressInfo;
use Google::Ads::GoogleAds::V24::Enums::CustomerMatchUploadKeyTypeEnum
  qw(CONTACT_INFO);
use Google::Ads::GoogleAds::V24::Enums::OfflineUserDataJobStatusEnum
  qw(SUCCESS FAILED PENDING RUNNING);
use Google::Ads::GoogleAds::V24::Enums::OfflineUserDataJobTypeEnum
  qw(CUSTOMER_MATCH_USER_LIST);
use Google::Ads::GoogleAds::V24::Services::UserListService::UserListOperation;
use
  Google::Ads::GoogleAds::V24::Services::OfflineUserDataJobService::OfflineUserDataJobOperation;
use
...
sub create_customer_match_user_list {
  ...
  my $user_list = Google::Ads::GoogleAds::V24::Resources::UserList->new({
      ...
      # a CREATE operation.
      crmBasedUserList =>
        Google::Ads::GoogleAds::V24::Common::CrmBasedUserListInfo->new({
...
sub add_users_to_customer_match_user_list {
  ...
  if (!defined $offline_user_data_job_id) {
    ...
    my $offline_user_data_job =
      Google::Ads::GoogleAds::V24::Resources::OfflineUserDataJob->new({
        type                          => CUSTOMER_MATCH_USER_LIST,
        customerMatchUserListMetadata =>
          Google::Ads::GoogleAds::V24::Common::CustomerMatchUserListMetadata->
          new({
    ...
    if ($ad_personalization_consent or $ad_user_data_consent) {
      my $consent = Google::Ads::GoogleAds::V24::Common::Consent->new({});
    ...
    $offline_user_data_job_resource_name =
      Google::Ads::GoogleAds::V24::Utils::ResourceNames::offline_user_data_job(
...
"Skipping addition of mailing address information because the following"
        ...
        push(
          ...
          Google::Ads::GoogleAds::V24::Common::UserIdentifier->new({
              addressInfo =>
                Google::Ads::GoogleAds::V24::Common::OfflineUserAddressInfo->
                new({
    ...
    if (@$user_identifiers) {
      my $user_data = Google::Ads::GoogleAds::V24::Common::UserData->new({
