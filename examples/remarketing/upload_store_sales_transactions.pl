...
use Google::Ads::GoogleAds::V22::Common::ItemAttribute;
use Google::Ads::GoogleAds::V22::Common::OfflineUserAddressInfo;
use Google::Ads::GoogleAds::V22::Common::StoreSalesMetadata;
use Google::Ads::GoogleAds::V22::Common::StoreSalesThirdPartyMetadata;
use Google::Ads::GoogleAds::V22::Common::TransactionAttribute;
use Google::Ads::GoogleAds::V22::Common::UserData;
use Google::Ads::GoogleAds::V22::Common::UserIdentifier;
use Google::Ads::GoogleAds::V22::Enums::OfflineUserDataJobTypeEnum
...
sub create_offline_user_data_job {
  ...
  my $store_sales_metadata =
    ...
    # additional details.
    Google::Ads::GoogleAds::V22::Common::StoreSalesMetadata->new({
  ...
  if ($offline_user_data_job_type eq STORE_SALES_UPLOAD_THIRD_PARTY) {
    ...
    my $store_sales_third_party_metadata =
      Google::Ads::GoogleAds::V22::Common::StoreSalesThirdPartyMetadata->new({
...
sub build_offline_user_data_job_operations {
  ...
  my $user_data_with_email_address =
    Google::Ads::GoogleAds::V22::Common::UserData->new({
      userIdentifiers => [
      ...
      transactionAttribute =>
        Google::Ads::GoogleAds::V22::Common::TransactionAttribute->new({
          conversionAction =>
  ...
  if ($ad_personalization_consent or $ad_user_data_consent) {
    ...
    $user_data_with_email_address->{consent} =
      Google::Ads::GoogleAds::V22::Common::Consent({
  ...
  if (defined($item_id)) {
    $user_data_with_physical_address->{transactionAttribute}{itemAttribute} =
      Google::Ads::GoogleAds::V22::Common::ItemAttribute->new({
        itemId       => $item_id,
