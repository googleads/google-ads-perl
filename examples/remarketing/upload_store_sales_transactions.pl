...
use Google::Ads::GoogleAds::V10::Common::ItemAttribute;
use Google::Ads::GoogleAds::V10::Common::OfflineUserAddressInfo;
use Google::Ads::GoogleAds::V10::Common::StoreSalesMetadata;
use Google::Ads::GoogleAds::V10::Common::StoreSalesThirdPartyMetadata;
use Google::Ads::GoogleAds::V10::Common::TransactionAttribute;
...
sub create_offline_user_data_job {
  ...
  my $store_sales_metadata =
    ...
    # additional details.
    Google::Ads::GoogleAds::V10::Common::StoreSalesMetadata->new({
  ...
  if ($offline_user_data_job_type eq STORE_SALES_UPLOAD_THIRD_PARTY) {
    ...
    my $store_sales_third_party_metadata =
      Google::Ads::GoogleAds::V10::Common::StoreSalesThirdPartyMetadata->new({
...
sub build_offline_user_data_job_operations {
  ...
  my $user_data_with_email_address =
    Google::Ads::GoogleAds::V10::Common::UserData->new({
      ...
      transactionAttribute =>
        Google::Ads::GoogleAds::V10::Common::TransactionAttribute->new({
          conversionAction =>
  ...
  if (defined($item_id)) {
    $user_data_with_physical_address->{transactionAttribute}{itemAttribute} =
      Google::Ads::GoogleAds::V10::Common::ItemAttribute->new({
        itemId       => $item_id,
