...
use Google::Ads::GoogleAds::V24::Resources::ConversionAction;
use Google::Ads::GoogleAds::V24::Resources::ValueSettings;
use Google::Ads::GoogleAds::V24::Enums::ConversionActionCategoryEnum
  qw(DEFAULT);
use Google::Ads::GoogleAds::V24::Enums::ConversionActionTypeEnum   qw(WEBPAGE);
use Google::Ads::GoogleAds::V24::Enums::ConversionActionStatusEnum qw(ENABLED);
use
