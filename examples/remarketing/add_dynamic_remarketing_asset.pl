...
use Google::Ads::GoogleAds::V14::Common::DynamicEducationAsset;
use Google::Ads::GoogleAds::V14::Enums::AssetSetTypeEnum qw(DYNAMIC_EDUCATION);
...
sub create_asset {
  ...
  my $education_asset =
    Google::Ads::GoogleAds::V14::Common::DynamicEducationAsset->new({
