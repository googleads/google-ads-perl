...
use Google::Ads::GoogleAds::V24::Common::DynamicEducationAsset;
use Google::Ads::GoogleAds::V24::Enums::AssetSetTypeEnum qw(DYNAMIC_EDUCATION);
...
sub create_asset {
  ...
  my $education_asset =
    Google::Ads::GoogleAds::V24::Common::DynamicEducationAsset->new({
