...
use Google::Ads::GoogleAds::V10::Common::DynamicEducationAsset;
use Google::Ads::GoogleAds::V10::Enums::AssetSetTypeEnum qw(DYNAMIC_EDUCATION);
...
sub create_asset {
  ...
  my $education_asset =
    Google::Ads::GoogleAds::V10::Common::DynamicEducationAsset->new({
