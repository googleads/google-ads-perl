...
use Google::Ads::GoogleAds::V12::Common::DynamicEducationAsset;
use Google::Ads::GoogleAds::V12::Enums::AssetSetTypeEnum qw(DYNAMIC_EDUCATION);
...
sub create_asset {
  ...
  my $education_asset =
    Google::Ads::GoogleAds::V12::Common::DynamicEducationAsset->new({
