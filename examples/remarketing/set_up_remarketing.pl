...
use Google::Ads::GoogleAds::V19::Common::UserListInfo;
...
use
  Google::Ads::GoogleAds::V19::Services::GoogleAdsService::SearchGoogleAdsStreamRequest;
...
sub create_user_list {
  ...
  my $rule = Google::Ads::GoogleAds::V19::Common::UserListRuleItemInfo->new({
