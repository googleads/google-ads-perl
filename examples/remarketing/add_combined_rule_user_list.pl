...
use Google::Ads::GoogleAds::V5::Common::CombinedRuleUserListInfo;
use Google::Ads::GoogleAds::V5::Common::RuleBasedUserListInfo;
use Google::Ads::GoogleAds::V5::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V5::Enums::UserListCombinedRuleOperatorEnum qw(AND);
use Google::Ads::GoogleAds::V5::Enums::UserListPrepopulationStatusEnum
  qw(REQUESTED);
