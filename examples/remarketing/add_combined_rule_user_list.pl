...
use Google::Ads::GoogleAds::V6::Common::CombinedRuleUserListInfo;
...
use Google::Ads::GoogleAds::V6::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V6::Enums::UserListCombinedRuleOperatorEnum qw(AND);
...
sub add_combined_rule_user_list {
  ...
  my $user_visited_site1_rule_info =
    Google::Ads::GoogleAds::V6::Common::UserListRuleInfo->new({
      ruleItemGroups =>
  ...
  my $combined_rule_user_list_info =
    Google::Ads::GoogleAds::V6::Common::CombinedRuleUserListInfo->new({
