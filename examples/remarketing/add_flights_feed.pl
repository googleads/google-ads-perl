...
use Google::Ads::GoogleAds::V13::Resources::FeedAttribute;
...
use Google::Ads::GoogleAds::V13::Enums::FeedAttributeTypeEnum
  qw(STRING URL_LIST);
use Google::Ads::GoogleAds::V13::Enums::FlightPlaceholderFieldEnum
  qw(FLIGHT_DESCRIPTION DESTINATION_ID FLIGHT_PRICE FLIGHT_SALE_PRICE FINAL_URLS);
use Google::Ads::GoogleAds::V13::Enums::PlaceholderTypeEnum qw(DYNAMIC_FLIGHT);
use Google::Ads::GoogleAds::V13::Services::FeedService::FeedOperation;
use
  Google::Ads::GoogleAds::V13::Services::FeedMappingService::FeedMappingOperation;
...
sub create_feed {
  ...
  my $flight_description_attribute =
    Google::Ads::GoogleAds::V13::Resources::FeedAttribute->new({
      type => STRING,
...
sub create_feed_mapping {
  ...
  my $flight_description_mapping =
    Google::Ads::GoogleAds::V13::Resources::AttributeFieldMapping->new({
  ...
  # Create a feed mapping.
  my $feed_mapping = Google::Ads::GoogleAds::V13::Resources::FeedMapping->new({
...
sub create_feed_item {
  ...
  my $feed_item = Google::Ads::GoogleAds::V13::Resources::FeedItem->new({
      feed            => $feed_resource_name,
      attributeValues => [
