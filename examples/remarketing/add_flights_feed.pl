...
use Google::Ads::GoogleAds::V14::Enums::FeedAttributeTypeEnum
  qw(STRING URL_LIST);
use Google::Ads::GoogleAds::V14::Enums::FlightPlaceholderFieldEnum
  qw(FLIGHT_DESCRIPTION DESTINATION_ID FLIGHT_PRICE FLIGHT_SALE_PRICE FINAL_URLS);
use Google::Ads::GoogleAds::V14::Enums::PlaceholderTypeEnum qw(DYNAMIC_FLIGHT);
use Google::Ads::GoogleAds::V14::Services::FeedService::FeedOperation;
use
  Google::Ads::GoogleAds::V14::Services::FeedMappingService::FeedMappingOperation;
...
sub create_feed {
  ...
  my $flight_description_attribute =
    Google::Ads::GoogleAds::V14::Resources::FeedAttribute->new({
      type => STRING,
  ...
  # Create a feed.
  my $feed = Google::Ads::GoogleAds::V14::Resources::Feed->new({
...
sub create_feed_mapping {
  ...
  my $flight_description_mapping =
    Google::Ads::GoogleAds::V14::Resources::AttributeFieldMapping->new({
  ...
  # Create a feed mapping.
  my $feed_mapping = Google::Ads::GoogleAds::V14::Resources::FeedMapping->new({
...
sub create_feed_item {
  ...
  my $flight_description =
    Google::Ads::GoogleAds::V14::Resources::FeedItemAttributeValue->new({
      feedAttributeId => $feed_attributes->{FLIGHT_DESCRIPTION}{id},
  ...
  my $feed_item = Google::Ads::GoogleAds::V14::Resources::FeedItem->new({
      feed            => $feed_resource_name,
      attributeValues => [
