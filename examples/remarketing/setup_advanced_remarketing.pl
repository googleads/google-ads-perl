...
use Google::Ads::GoogleAds::V8::Common::RuleBasedUserListInfo;
use Google::Ads::GoogleAds::V8::Common::ExpressionRuleUserListInfo;
use Google::Ads::GoogleAds::V8::Common::UserListRuleInfo;
use Google::Ads::GoogleAds::V8::Common::UserListRuleItemGroupInfo;
use Google::Ads::GoogleAds::V8::Common::UserListRuleItemInfo;
use Google::Ads::GoogleAds::V8::Common::UserListStringRuleItemInfo;
use Google::Ads::GoogleAds::V8::Common::UserListNumberRuleItemInfo;
use Google::Ads::GoogleAds::V8::Common::UserListDateRuleItemInfo;
use Google::Ads::GoogleAds::V8::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V8::Enums::UserListNumberRuleItemOperatorEnum
  qw(GREATER_THAN);
use Google::Ads::GoogleAds::V8::Enums::UserListDateRuleItemOperatorEnum
  qw(AFTER BEFORE);
use Google::Ads::GoogleAds::V8::Enums::UserListMembershipStatusEnum qw(OPEN);
use Google::Ads::GoogleAds::V8::Enums::UserListPrepopulationStatusEnum
  qw(REQUESTED);
use Google::Ads::GoogleAds::V8::Services::UserListService::UserListOperation;
...
sub setup_advanced_remarketing {
  ...
  my $expression_rule_user_list_info =
    Google::Ads::GoogleAds::V8::Common::ExpressionRuleUserListInfo->new({
      rule => Google::Ads::GoogleAds::V8::Common::UserListRuleInfo->new({
          ruleItemGroups =>
  ...
  my $rule_based_user_list_info =
    Google::Ads::GoogleAds::V8::Common::RuleBasedUserListInfo->new({
  ...
  my $user_list = Google::Ads::GoogleAds::V8::Resources::UserList->new({
  ...
  my $user_list_operation =
    Google::Ads::GoogleAds::V8::Services::UserListService::UserListOperation->
    new({
      create => $user_list
    });
