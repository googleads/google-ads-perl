...
use Google::Ads::GoogleAds::V17::Common::UserListNumberRuleItemInfo;
use Google::Ads::GoogleAds::V17::Common::UserListDateRuleItemInfo;
...
use Google::Ads::GoogleAds::V17::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V17::Enums::UserListNumberRuleItemOperatorEnum
  qw(GREATER_THAN);
use Google::Ads::GoogleAds::V17::Enums::UserListDateRuleItemOperatorEnum
  qw(AFTER BEFORE);
