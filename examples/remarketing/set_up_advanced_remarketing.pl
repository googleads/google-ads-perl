...
use Google::Ads::GoogleAds::V14::Enums::UserListFlexibleRuleOperatorEnum
  qw(AND);
use Google::Ads::GoogleAds::V14::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V14::Enums::UserListNumberRuleItemOperatorEnum
  qw(GREATER_THAN);
use Google::Ads::GoogleAds::V14::Enums::UserListDateRuleItemOperatorEnum
  qw(AFTER BEFORE);
use Google::Ads::GoogleAds::V14::Enums::UserListMembershipStatusEnum qw(OPEN);
use Google::Ads::GoogleAds::V14::Enums::UserListPrepopulationStatusEnum
  qw(REQUESTED);
...
sub set_up_advanced_remarketing {
  ...
  my $checkout_rule =
    Google::Ads::GoogleAds::V14::Common::UserListRuleItemInfo->new({
      ...
      name           => "ecomm_pagetype",
      stringRuleItem =>
        Google::Ads::GoogleAds::V14::Common::UserListStringRuleItemInfo->new({
          operator => EQUALS,
          value    => "checkout"
        })});
  ...
  my $cart_size_rule =
    Google::Ads::GoogleAds::V14::Common::UserListRuleItemInfo->new({
      ...
      name           => "cart_size",
      numberRuleItem =>
        Google::Ads::GoogleAds::V14::Common::UserListNumberRuleItemInfo->new({
  ...
  my $checkout_and_cart_size_rule_group =
    Google::Ads::GoogleAds::V14::Common::UserListRuleItemGroupInfo->new(
  ...
  my $start_date_rule =
    Google::Ads::GoogleAds::V14::Common::UserListRuleItemInfo->new({
      ...
      name         => "checkoutdate",
      dateRuleItem =>
        Google::Ads::GoogleAds::V14::Common::UserListDateRuleItemInfo->new({
  ...
  my $flexible_rule_user_list_info =
    Google::Ads::GoogleAds::V14::Common::FlexibleRuleUserListInfo->new({
      inclusiveRuleOperator => AND,
      inclusiveOperands     => [
        Google::Ads::GoogleAds::V14::Common::FlexibleRuleOperandInfo->new({
            rule => Google::Ads::GoogleAds::V14::Common::UserListRuleInfo->new({
  ...
  my $rule_based_user_list_info =
    Google::Ads::GoogleAds::V14::Common::RuleBasedUserListInfo->new({
