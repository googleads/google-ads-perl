...
use Google::Ads::GoogleAds::V16::Common::UserListNumberRuleItemInfo;
use Google::Ads::GoogleAds::V16::Common::UserListDateRuleItemInfo;
...
use Google::Ads::GoogleAds::V16::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V16::Enums::UserListNumberRuleItemOperatorEnum
  qw(GREATER_THAN);
use Google::Ads::GoogleAds::V16::Enums::UserListDateRuleItemOperatorEnum
  qw(AFTER BEFORE);
