...
use Google::Ads::GoogleAds::V19::Common::RuleBasedUserListInfo;
use Google::Ads::GoogleAds::V19::Common::FlexibleRuleOperandInfo;
use Google::Ads::GoogleAds::V19::Common::FlexibleRuleUserListInfo;
use Google::Ads::GoogleAds::V19::Common::UserListRuleInfo;
use Google::Ads::GoogleAds::V19::Common::UserListRuleItemGroupInfo;
use Google::Ads::GoogleAds::V19::Common::UserListRuleItemInfo;
use Google::Ads::GoogleAds::V19::Common::UserListStringRuleItemInfo;
use Google::Ads::GoogleAds::V19::Common::UserListNumberRuleItemInfo;
use Google::Ads::GoogleAds::V19::Common::UserListDateRuleItemInfo;
use Google::Ads::GoogleAds::V19::Enums::UserListFlexibleRuleOperatorEnum
  qw(AND);
use Google::Ads::GoogleAds::V19::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V19::Enums::UserListNumberRuleItemOperatorEnum
  qw(GREATER_THAN);
use Google::Ads::GoogleAds::V19::Enums::UserListDateRuleItemOperatorEnum
  qw(AFTER BEFORE);
use Google::Ads::GoogleAds::V19::Enums::UserListMembershipStatusEnum qw(OPEN);
use Google::Ads::GoogleAds::V19::Enums::UserListPrepopulationStatusEnum
  qw(REQUESTED);
use Google::Ads::GoogleAds::V19::Services::UserListService::UserListOperation;
...
sub set_up_advanced_remarketing {
  ...
  my $checkout_rule =
    Google::Ads::GoogleAds::V19::Common::UserListRuleItemInfo->new({
      ...
      name           => "ecomm_pagetype",
      stringRuleItem =>
        Google::Ads::GoogleAds::V19::Common::UserListStringRuleItemInfo->new({
          operator => EQUALS,
          value    => "checkout"
        })});
  ...
  my $cart_size_rule =
    Google::Ads::GoogleAds::V19::Common::UserListRuleItemInfo->new({
      ...
      name           => "cart_size",
      numberRuleItem =>
        Google::Ads::GoogleAds::V19::Common::UserListNumberRuleItemInfo->new({
  ...
  my $checkout_and_cart_size_rule_group =
    Google::Ads::GoogleAds::V19::Common::UserListRuleItemGroupInfo->new(
  ...
  my $start_date_rule =
    Google::Ads::GoogleAds::V19::Common::UserListRuleItemInfo->new({
      ...
      name         => "checkoutdate",
      dateRuleItem =>
        Google::Ads::GoogleAds::V19::Common::UserListDateRuleItemInfo->new({
  ...
  my $flexible_rule_user_list_info =
    Google::Ads::GoogleAds::V19::Common::FlexibleRuleUserListInfo->new({
      inclusiveRuleOperator => AND,
      inclusiveOperands     => [
        Google::Ads::GoogleAds::V19::Common::FlexibleRuleOperandInfo->new({
            rule => Google::Ads::GoogleAds::V19::Common::UserListRuleInfo->new({
  ...
  my $rule_based_user_list_info =
    Google::Ads::GoogleAds::V19::Common::RuleBasedUserListInfo->new({
  ...
  my $user_list_operation =
    Google::Ads::GoogleAds::V19::Services::UserListService::UserListOperation->
    new({
      create => $user_list
    });
