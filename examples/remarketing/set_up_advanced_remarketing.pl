...
use Google::Ads::GoogleAds::V20::Common::UserListNumberRuleItemInfo;
use Google::Ads::GoogleAds::V20::Common::UserListDateRuleItemInfo;
...
use Google::Ads::GoogleAds::V20::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V20::Enums::UserListNumberRuleItemOperatorEnum
  qw(GREATER_THAN);
use Google::Ads::GoogleAds::V20::Enums::UserListDateRuleItemOperatorEnum
  qw(AFTER BEFORE);
...
sub set_up_advanced_remarketing {
  ...
  my $cart_size_rule =
    Google::Ads::GoogleAds::V20::Common::UserListRuleItemInfo->new({
      ...
      name           => "cart_size",
      numberRuleItem =>
        Google::Ads::GoogleAds::V20::Common::UserListNumberRuleItemInfo->new({
  ...
  my $start_date_rule =
    Google::Ads::GoogleAds::V20::Common::UserListRuleItemInfo->new({
      ...
      name         => "checkoutdate",
      dateRuleItem =>
        Google::Ads::GoogleAds::V20::Common::UserListDateRuleItemInfo->new({
    ...
    Google::Ads::GoogleAds::V20::Common::FlexibleRuleUserListInfo->new({
      ...
      inclusiveOperands     => [
        Google::Ads::GoogleAds::V20::Common::FlexibleRuleOperandInfo->new({
            rule => Google::Ads::GoogleAds::V20::Common::UserListRuleInfo->new({
