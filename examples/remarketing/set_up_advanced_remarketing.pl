...
use Google::Ads::GoogleAds::V25::Resources::UserList;
use Google::Ads::GoogleAds::V25::Common::RuleBasedUserListInfo;
use Google::Ads::GoogleAds::V25::Common::FlexibleRuleOperandInfo;
use Google::Ads::GoogleAds::V25::Common::FlexibleRuleUserListInfo;
use Google::Ads::GoogleAds::V25::Common::UserListRuleInfo;
use Google::Ads::GoogleAds::V25::Common::UserListRuleItemGroupInfo;
use Google::Ads::GoogleAds::V25::Common::UserListRuleItemInfo;
use Google::Ads::GoogleAds::V25::Common::UserListStringRuleItemInfo;
use Google::Ads::GoogleAds::V25::Common::UserListNumberRuleItemInfo;
use Google::Ads::GoogleAds::V25::Common::UserListDateRuleItemInfo;
use Google::Ads::GoogleAds::V25::Enums::UserListFlexibleRuleOperatorEnum
  qw(AND);
use Google::Ads::GoogleAds::V25::Enums::UserListStringRuleItemOperatorEnum
  qw(EQUALS);
use Google::Ads::GoogleAds::V25::Enums::UserListNumberRuleItemOperatorEnum
  qw(GREATER_THAN);
use Google::Ads::GoogleAds::V25::Enums::UserListDateRuleItemOperatorEnum
  qw(AFTER BEFORE);
use Google::Ads::GoogleAds::V25::Enums::UserListMembershipStatusEnum qw(OPEN);
use Google::Ads::GoogleAds::V25::Enums::UserListPrepopulationStatusEnum
  qw(REQUESTED);
use Google::Ads::GoogleAds::V25::Services::UserListService::UserListOperation;
