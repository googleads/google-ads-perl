...
package Google::Ads::GoogleAds::V10::Services::KeywordPlanIdeaService;
...
sub generate_keyword_ideas {
  ...
  my $request_body = shift;
  my $http_method  = 'POST';
  my $request_path = 'v10/customers/{+customerId}:generateKeywordIdeas';
  my $response_type =
'Google::Ads::GoogleAds::V10::Services::KeywordPlanIdeaService::GenerateKeywordIdeaResponse';
