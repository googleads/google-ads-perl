...
Returns a list of L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsError> instances
...
with the detail list containing L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsFailure>
instances.
...
An array containing the L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsError>
instances for the given operation index.

=head2 get_google_ads_failure

Extracts the L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsFailure> instance
...
A L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsFailure> object or undef if not found.

=head2 __get_google_ads_errors

The private method to extract a list of L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsError>
instances from a L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsFailure> instance
for a given operation index.
...
I<google_ads_failure>: the L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsFailure> instance.
...
An array containing the L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsError>
instances from the L<Google::Ads::GoogleAds::V13::Errors::GoogleAdsFailure>
