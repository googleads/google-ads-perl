...
package Google::Ads::GoogleAds::V23::Enums::ServedAssetFieldTypeEnum;
...
use Const::Exporter enums => [
  ...
  HEADLINE_AS_SITELINK_POSITION_ONE => "HEADLINE_AS_SITELINK_POSITION_ONE",
  HEADLINE_AS_SITELINK_POSITION_TWO => "HEADLINE_AS_SITELINK_POSITION_TWO",
