...
package Google::Ads::GoogleAds::V23::Resources::AdGroup;
...
sub new {
  ...
  my $self = {
    ...
    effectiveTargetCpc            => $args->{effectiveTargetCpc},
    effectiveTargetCpcSource      => $args->{effectiveTargetCpcSource},
    ...
    targetCpcMicros               => $args->{targetCpcMicros},
    ...
    verticalAdsFormatSetting      => $args->{verticalAdsFormatSetting},
