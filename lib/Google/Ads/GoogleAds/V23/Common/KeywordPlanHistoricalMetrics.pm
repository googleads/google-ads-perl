...
package Google::Ads::GoogleAds::V23::Common::KeywordPlanHistoricalMetrics;
...
sub new {
  ...
  my $self = {
    ...
    lowTopOfPageBidMicros  => $args->{lowTopOfPageBidMicros},
    monthlySearchVolumes   => $args->{monthlySearchVolumes}};
