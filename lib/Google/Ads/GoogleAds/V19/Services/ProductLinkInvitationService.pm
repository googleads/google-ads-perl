...
package Google::Ads::GoogleAds::V19::Services::ProductLinkInvitationService;
...
sub create {
  ...
  my $http_method  = 'POST';
  my $request_path =
    'v19/customers/{+customerId}/productLinkInvitations:create';
  my $response_type =
'Google::Ads::GoogleAds::V19::Services::ProductLinkInvitationService::CreateProductLinkInvitationResponse';
