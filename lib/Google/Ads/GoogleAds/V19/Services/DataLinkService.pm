...
package Google::Ads::GoogleAds::V19::Services::DataLinkService;
...
sub create {
  ...
  my $http_method  = 'POST';
  my $request_path = 'v19/customers/{+customerId}/dataLinks:create';
  my $response_type =
'Google::Ads::GoogleAds::V19::Services::DataLinkService::CreateDataLinkResponse';
