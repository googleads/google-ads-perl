...
Extracts a L<Google::Ads::GoogleAds::V17::Errors::GoogleAdsFailure> object from the
L</details> attribute of the current exception object.

=head3 Returns

A L<Google::Ads::GoogleAds::V17::Errors::GoogleAdsFailure> object or undef if not found.
