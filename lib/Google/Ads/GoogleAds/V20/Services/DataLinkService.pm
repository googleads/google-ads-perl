...
package Google::Ads::GoogleAds::V20::Services::DataLinkService;
...
sub create {
  ...
  my $http_method  = 'POST';
  my $request_path = 'v20/customers/{+customerId}/dataLinks:create';
  my $response_type =
'Google::Ads::GoogleAds::V20::Services::DataLinkService::CreateDataLinkResponse';
