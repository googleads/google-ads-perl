...
package Google::Ads::GoogleAds::V18::Services::CustomerService;
...
sub create_customer_client {
  ...
  my $http_method  = 'POST';
  my $request_path = 'v18/customers/{+customerId}:createCustomerClient';
  my $response_type =
...
sub list_accessible_customers {
  ...
  my $request_body = shift;
  my $http_method  = 'GET';
  my $request_path = 'v18/customers:listAccessibleCustomers';
  my $response_type =
...
sub mutate {
  ...
  my $request_body = shift;
  my $http_method  = 'POST';
  my $request_path = 'v18/customers/{+customerId}:mutate';
  my $response_type =
