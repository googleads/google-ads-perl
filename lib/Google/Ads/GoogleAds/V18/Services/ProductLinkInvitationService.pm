...
package Google::Ads::GoogleAds::V18::Services::ProductLinkInvitationService;
...
sub create {
  ...
  my $http_method  = 'POST';
  my $request_path =
    'v18/customers/{+customerId}/productLinkInvitations:create';
  my $response_type =
'Google::Ads::GoogleAds::V18::Services::ProductLinkInvitationService::CreateProductLinkInvitationResponse';
