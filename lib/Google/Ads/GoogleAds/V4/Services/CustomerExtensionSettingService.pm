...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $request_path =
    'v4/customers/{+customerId}/customerExtensionSettings:mutate';
  my $response_type =
'Google::Ads::GoogleAds::V4::Services::CustomerExtensionSettingService::MutateCustomerExtensionSettingsResponse';
