...
package Google::Ads::GoogleAds::V2::Services::AdGroupCriterionLabelService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::AdGroupCriterionLabelService::MutateAdGroupCriterionLabelsResponse';
  my $request_path = 'v2/customers/{+customerId}/adGroupCriterionLabels:mutate';
