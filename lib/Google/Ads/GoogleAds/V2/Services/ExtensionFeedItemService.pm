...
package Google::Ads::GoogleAds::V2::Services::ExtensionFeedItemService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::ExtensionFeedItemService::MutateExtensionFeedItemsResponse';
  my $request_path = 'v2/customers/{+customerId}/extensionFeedItems:mutate';
