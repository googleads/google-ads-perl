...
package Google::Ads::GoogleAds::V2::Services::RemarketingActionService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::RemarketingActionService::MutateRemarketingActionsResponse';
  my $request_path = 'v2/customers/{+customerId}/remarketingActions:mutate';
