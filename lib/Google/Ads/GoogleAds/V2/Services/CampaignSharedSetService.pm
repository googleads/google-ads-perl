...
package Google::Ads::GoogleAds::V2::Services::CampaignSharedSetService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::CampaignSharedSetService::MutateCampaignSharedSetsResponse';
  my $request_path = 'v2/customers/{+customerId}/campaignSharedSets:mutate';
