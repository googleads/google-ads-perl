...
package Google::Ads::GoogleAds::V2::Services::CampaignExtensionSettingService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::CampaignExtensionSettingService::MutateCampaignExtensionSettingsResponse';
  my $request_path =
    'v2/customers/{+customerId}/campaignExtensionSettings:mutate';
