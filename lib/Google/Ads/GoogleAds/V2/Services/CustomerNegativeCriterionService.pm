...
package Google::Ads::GoogleAds::V2::Services::CustomerNegativeCriterionService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::CustomerNegativeCriterionService::MutateCustomerNegativeCriteriaResponse';
  my $request_path =
    'v2/customers/{+customerId}/customerNegativeCriteria:mutate';
