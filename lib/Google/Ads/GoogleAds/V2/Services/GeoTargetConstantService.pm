...
package Google::Ads::GoogleAds::V2::Services::GeoTargetConstantService;
...
sub suggest {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::GeoTargetConstantService::SuggestGeoTargetConstantsResponse';
  my $request_path = 'v2/geoTargetConstants:suggest';
