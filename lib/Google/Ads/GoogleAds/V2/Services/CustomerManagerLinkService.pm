...
package Google::Ads::GoogleAds::V2::Services::CustomerManagerLinkService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::CustomerManagerLinkService::MutateCustomerManagerLinkResponse';
  my $request_path = 'v2/customers/{+customerId}/customerManagerLinks:mutate';
