...
package Google::Ads::GoogleAds::V2::Services::KeywordPlanNegativeKeywordService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::KeywordPlanNegativeKeywordService::MutateKeywordPlanNegativeKeywordsResponse';
  my $request_path =
    'v2/customers/{+customerId}/keywordPlanNegativeKeywords:mutate';
