...
package Google::Ads::GoogleAds::V2::Services::AdGroupExtensionSettingService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V2::Services::AdGroupExtensionSettingService::MutateAdGroupExtensionSettingsResponse';
  my $request_path =
    'v2/customers/{+customerId}/adGroupExtensionSettings:mutate';
