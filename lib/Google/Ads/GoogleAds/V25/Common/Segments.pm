...
sub new {
  ...
  my $self = {
    ...
    conversionLiftConversionCategory => $args->{conversionLiftConversionCategory},
    conversionLiftEndDate => $args->{conversionLiftEndDate},
    conversionLiftIncludedConversionActionTypes => $args->{conversionLiftIncludedConversionActionTypes},
    conversionLiftStartDate => $args->{conversionLiftStartDate},
    conversionOrAdjustmentLagBucket => $args->{conversionOrAdjustmentLagBucket},
    conversionValueRulePrimaryDimension => $args->{conversionValueRulePrimaryDimension},
    ...
    lengthOfBooking => $args->{lengthOfBooking},
    ...
    skAdNetworkCoarseConversionValue => $args->{skAdNetworkCoarseConversionValue},
    skAdNetworkFineConversionValue => $args->{skAdNetworkFineConversionValue},
    skAdNetworkPostbackSequenceIndex => $args->{skAdNetworkPostbackSequenceIndex},
    skAdNetworkRedistributedFineConversionValue => $args->{skAdNetworkRedistributedFineConversionValue},
    ...
    userSetDates => $args->{userSetDates},
    verticalAdsEventParticipantDisplayNames => $args->{verticalAdsEventParticipantDisplayNames},
    ...
    verticalAdsPriceTier => $args->{verticalAdsPriceTier},
    verticalAdsRateRuleId => $args->{verticalAdsRateRuleId},
    verticalAdsRateType => $args->{verticalAdsRateType},
