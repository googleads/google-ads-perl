...
package Google::Ads::GoogleAds::V25::Common::Segments;
...
sub new {
  ...
  my $self = {
    ...
    adSubFormatType                 => $args->{adSubFormatType},
    ...
    brandLiftMeasurementType        => $args->{brandLiftMeasurementType},
    ...
    conversionLiftConversionCategory =>
      $args->{conversionLiftConversionCategory},
    conversionLiftEndDate => $args->{conversionLiftEndDate},
    conversionLiftIncludedConversionActionTypes =>
      $args->{conversionLiftIncludedConversionActionTypes},
    conversionLiftStartDate         => $args->{conversionLiftStartDate},
    ...
    countryLocalizedName             => $args->{countryLocalizedName},
    date                             => $args->{date},
    ...
    loyaltyMembership                => $args->{loyaltyMembership},
    ...
    productSoldBrand                 => $args->{productSoldBrand},
    productSoldCategoryLevel1        => $args->{productSoldCategoryLevel1},
    productSoldCategoryLevel2        => $args->{productSoldCategoryLevel2},
    productSoldCategoryLevel3        => $args->{productSoldCategoryLevel3},
    productSoldCategoryLevel4        => $args->{productSoldCategoryLevel4},
    productSoldCategoryLevel5        => $args->{productSoldCategoryLevel5},
    productSoldCondition             => $args->{productSoldCondition},
    productSoldCustomAttribute0      => $args->{productSoldCustomAttribute0},
    productSoldCustomAttribute1      => $args->{productSoldCustomAttribute1},
    productSoldCustomAttribute2      => $args->{productSoldCustomAttribute2},
    productSoldCustomAttribute3      => $args->{productSoldCustomAttribute3},
    productSoldCustomAttribute4      => $args->{productSoldCustomAttribute4},
    productSoldItemId                => $args->{productSoldItemId},
    productSoldTitle                 => $args->{productSoldTitle},
    productSoldTypeL1                => $args->{productSoldTypeL1},
    productSoldTypeL2                => $args->{productSoldTypeL2},
    productSoldTypeL3                => $args->{productSoldTypeL3},
    productSoldTypeL4                => $args->{productSoldTypeL4},
    productSoldTypeL5                => $args->{productSoldTypeL5},
