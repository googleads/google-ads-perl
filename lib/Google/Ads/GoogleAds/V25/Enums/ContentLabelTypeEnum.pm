...
use Const::Exporter enums => [
  ...
  BRAND_SUITABILITY_CONTENT_FOR_FAMILIES => "BRAND_SUITABILITY_CONTENT_FOR_FAMILIES",
  ...
  BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED => "BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED",
  ...
  BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED => "BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED",
