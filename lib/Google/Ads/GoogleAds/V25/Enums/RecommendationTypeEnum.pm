...
package Google::Ads::GoogleAds::V25::Enums::RecommendationTypeEnum;
...
use Const::Exporter enums => [
  ...
  SHOPPING_FIX_SUSPENDED_MERCHANT_CENTER_ACCOUNT => "SHOPPING_FIX_SUSPENDED_MERCHANT_CENTER_ACCOUNT",
  SHOPPING_FIX_MERCHANT_CENTER_ACCOUNT_SUSPENSION_WARNING => "SHOPPING_FIX_MERCHANT_CENTER_ACCOUNT_SUSPENSION_WARNING",
  ...
  MIGRATE_DYNAMIC_SEARCH_ADS_CAMPAIGN_TO_PERFORMANCE_MAX => "MIGRATE_DYNAMIC_SEARCH_ADS_CAMPAIGN_TO_PERFORMANCE_MAX",
  ...
  CAMPAIGN_SPECIFIC_APP_GOAL => "CAMPAIGN_SPECIFIC_APP_GOAL",
  RAISE_TARGET_CPA_PERFORMANCE_BID_TOO_LOW => "RAISE_TARGET_CPA_PERFORMANCE_BID_TOO_LOW",
  LOWER_TARGET_ROAS_PERFORMANCE_BID_TOO_LOW => "LOWER_TARGET_ROAS_PERFORMANCE_BID_TOO_LOW"
];
