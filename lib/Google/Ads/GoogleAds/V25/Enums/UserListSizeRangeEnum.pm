...
use Const::Exporter enums => [
  ...
  FIFTY_THOUSAND_TO_ONE_HUNDRED_THOUSAND => "FIFTY_THOUSAND_TO_ONE_HUNDRED_THOUSAND",
  ONE_HUNDRED_THOUSAND_TO_THREE_HUNDRED_THOUSAND => "ONE_HUNDRED_THOUSAND_TO_THREE_HUNDRED_THOUSAND",
  THREE_HUNDRED_THOUSAND_TO_FIVE_HUNDRED_THOUSAND => "THREE_HUNDRED_THOUSAND_TO_FIVE_HUNDRED_THOUSAND",
  FIVE_HUNDRED_THOUSAND_TO_ONE_MILLION => "FIVE_HUNDRED_THOUSAND_TO_ONE_MILLION",
