...
use Const::Exporter enums => [
  ...
  AD_GROUP_CRITERION_BELOW_FIRST_PAGE_BID => "AD_GROUP_CRITERION_BELOW_FIRST_PAGE_BID",
  ...
  AD_GROUP_CRITERION_PAUSED_DUE_TO_LOW_ACTIVITY => "AD_GROUP_CRITERION_PAUSED_DUE_TO_LOW_ACTIVITY",
