...
package Google::Ads::GoogleAds::V25::Enums::AppCampaignBiddingStrategyGoalTypeEnum;
...
use Const::Exporter enums => [
  ...
  OPTIMIZE_INSTALLS_WITHOUT_TARGET_INSTALL_COST => "OPTIMIZE_INSTALLS_WITHOUT_TARGET_INSTALL_COST",
