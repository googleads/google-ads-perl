...
package Google::Ads::GoogleAds::V25::Enums::ConversionActionTypeEnum;
...
use Const::Exporter enums => [
  ...
  GOOGLE_ANALYTICS_4_GENERATE_LEAD => "GOOGLE_ANALYTICS_4_GENERATE_LEAD",
  GOOGLE_ANALYTICS_4_QUALIFY_LEAD => "GOOGLE_ANALYTICS_4_QUALIFY_LEAD",
  GOOGLE_ANALYTICS_4_CLOSE_CONVERT_LEAD => "GOOGLE_ANALYTICS_4_CLOSE_CONVERT_LEAD",
  FIREBASE_ANDROID_GENERATE_LEAD => "FIREBASE_ANDROID_GENERATE_LEAD",
  FIREBASE_ANDROID_QUALIFY_LEAD => "FIREBASE_ANDROID_QUALIFY_LEAD",
  FIREBASE_ANDROID_CLOSE_CONVERT_LEAD => "FIREBASE_ANDROID_CLOSE_CONVERT_LEAD",
  FIREBASE_IOS_GENERATE_LEAD => "FIREBASE_IOS_GENERATE_LEAD",
  FIREBASE_IOS_QUALIFY_LEAD => "FIREBASE_IOS_QUALIFY_LEAD",
  FIREBASE_IOS_CLOSE_CONVERT_LEAD => "FIREBASE_IOS_CLOSE_CONVERT_LEAD",
  LOCAL_SERVICES_ADS => "LOCAL_SERVICES_ADS",
  FIREBASE_ANDROID_APP_AD_IMPRESSION => "FIREBASE_ANDROID_APP_AD_IMPRESSION",
  FIREBASE_IOS_APP_AD_IMPRESSION => "FIREBASE_IOS_APP_AD_IMPRESSION"
];
