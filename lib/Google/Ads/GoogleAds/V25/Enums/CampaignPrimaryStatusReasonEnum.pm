...
use Const::Exporter enums => [
  ...
  NO_MOBILE_APPLICATION_AD_GROUP_CRITERIA => "NO_MOBILE_APPLICATION_AD_GROUP_CRITERIA",
  CAMPAIGN_GROUP_PAUSED => "CAMPAIGN_GROUP_PAUSED",
  CAMPAIGN_GROUP_ALL_GROUP_BUDGETS_ENDED => "CAMPAIGN_GROUP_ALL_GROUP_BUDGETS_ENDED",
