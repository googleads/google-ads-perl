...
package Google::Ads::GoogleAds::V25::Enums::ConversionOrAdjustmentLagBucketEnum;
...
use Const::Exporter enums => [
  ...
  ADJUSTMENT_NINETY_TO_ONE_HUNDRED_AND_FORTY_FIVE_DAYS => "ADJUSTMENT_NINETY_TO_ONE_HUNDRED_AND_FORTY_FIVE_DAYS",
