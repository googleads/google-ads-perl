...
package Google::Ads::GoogleAds::V25::Enums::AppBiddingGoalEnum;
...
use Const::Exporter enums => [
  ...
  OPTIMIZE_FOR_TARGET_IN_APP_CONVERSION => "OPTIMIZE_FOR_TARGET_IN_APP_CONVERSION",
  OPTIMIZE_FOR_RETURN_ON_ADVERTISING_SPEND => "OPTIMIZE_FOR_RETURN_ON_ADVERTISING_SPEND",
  OPTIMIZE_FOR_INSTALL_CONVERSION_VOLUME_WITHOUT_TARGET_CPI => "OPTIMIZE_FOR_INSTALL_CONVERSION_VOLUME_WITHOUT_TARGET_CPI",
