...
package Google::Ads::GoogleAds::V25::Services::GoogleAdsService::MutateOperation;
...
sub new {
  ...
  my $self = {
    ...
    adGroupCriterionCustomizerOperation => $args->{adGroupCriterionCustomizerOperation},
    ...
    assetGroupListingGroupFilterOperation => $args->{assetGroupListingGroupFilterOperation},
    ...
    biddingSeasonalityAdjustmentOperation => $args->{biddingSeasonalityAdjustmentOperation},
    biddingStrategyOperation => $args->{biddingStrategyOperation},
    bookCampaignsOperation => $args->{bookCampaignsOperation},
    ...
    conversionCustomVariableOperation => $args->{conversionCustomVariableOperation},
    conversionGoalCampaignConfigOperation => $args->{conversionGoalCampaignConfigOperation},
    ...
    customerNegativeCriterionOperation => $args->{customerNegativeCriterionOperation},
    ...
    keywordPlanAdGroupKeywordOperation => $args->{keywordPlanAdGroupKeywordOperation},
    keywordPlanAdGroupOperation => $args->{keywordPlanAdGroupOperation},
    keywordPlanCampaignKeywordOperation => $args->{keywordPlanCampaignKeywordOperation},
    ...
    quoteCampaignsOperation => $args->{quoteCampaignsOperation},
    recommendationSubscriptionOperation => $args->{recommendationSubscriptionOperation},
