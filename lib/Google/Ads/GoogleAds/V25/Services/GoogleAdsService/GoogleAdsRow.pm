...
package Google::Ads::GoogleAds::V25::Services::GoogleAdsService::GoogleAdsRow;
...
sub new {
  ...
  my $self = {
    ...
    aiMaxSearchTermAdCombinationView => $args->{aiMaxSearchTermAdCombinationView},
    androidPrivacySharedKeyGoogleAdGroup => $args->{androidPrivacySharedKeyGoogleAdGroup},
    androidPrivacySharedKeyGoogleCampaign => $args->{androidPrivacySharedKeyGoogleCampaign},
    androidPrivacySharedKeyGoogleNetworkType => $args->{androidPrivacySharedKeyGoogleNetworkType},
    ...
    cartDataSalesView => $args->{cartDataSalesView},
    ...
    detailContentSuitabilityPlacementView => $args->{detailContentSuitabilityPlacementView},
    ...
    goal => $args->{goal},
    groupContentSuitabilityPlacementView => $args->{groupContentSuitabilityPlacementView},
    ...
    liftMeasurementAgeRange => $args->{liftMeasurementAgeRange},
    liftMeasurementCampaign => $args->{liftMeasurementCampaign},
    liftMeasurementConfig => $args->{liftMeasurementConfig},
    liftMeasurementDevice => $args->{liftMeasurementDevice},
    liftMeasurementFlight => $args->{liftMeasurementFlight},
    liftMeasurementGender => $args->{liftMeasurementGender},
    liftMeasurementVideo => $args->{liftMeasurementVideo},
    ...
    localServicesVerificationArtifact => $args->{localServicesVerificationArtifact},
    ...
    offlineConversionUploadClientSummary => $args->{offlineConversionUploadClientSummary},
    offlineConversionUploadConversionActionSummary => $args->{offlineConversionUploadConversionActionSummary},
