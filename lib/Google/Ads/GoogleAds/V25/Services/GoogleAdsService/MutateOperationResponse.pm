...
package Google::Ads::GoogleAds::V25::Services::GoogleAdsService::MutateOperationResponse;
...
sub new {
  ...
  my $self = {
    ...
    adGroupCriterionCustomizerResult => $args->{adGroupCriterionCustomizerResult},
    ...
    assetGroupListingGroupFilterResult => $args->{assetGroupListingGroupFilterResult},
    ...
    biddingSeasonalityAdjustmentResult => $args->{biddingSeasonalityAdjustmentResult},
    ...
    conversionGoalCampaignConfigResult => $args->{conversionGoalCampaignConfigResult},
    ...
    keywordPlanCampaignKeywordResult => $args->{keywordPlanCampaignKeywordResult},
    ...
    recommendationSubscriptionResult => $args->{recommendationSubscriptionResult},
