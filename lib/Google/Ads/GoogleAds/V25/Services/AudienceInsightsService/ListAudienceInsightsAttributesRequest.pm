...
package Google::Ads::GoogleAds::V25::Services::AudienceInsightsService::ListAudienceInsightsAttributesRequest;
...
sub new {
  ...
  my $self = {
    ...
    knowledgeGraphEntitySearchOptions => $args->{knowledgeGraphEntitySearchOptions},
