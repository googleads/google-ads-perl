...
package Google::Ads::GoogleAds::V25::Services::RecommendationService::ApplyRecommendationOperation;
...
sub new {
  ...
  my $self = {
    ...
    lowerTargetRoasPerformanceBidTooLow => $args->{lowerTargetRoasPerformanceBidTooLow},
    ...
    raiseTargetCpaPerformanceBidTooLow => $args->{raiseTargetCpaPerformanceBidTooLow},
    resourceName => $args->{resourceName},
    responsiveSearchAd => $args->{responsiveSearchAd},
    responsiveSearchAdAsset => $args->{responsiveSearchAdAsset},
    responsiveSearchAdImproveAdStrength => $args->{responsiveSearchAdImproveAdStrength},
