...
package Google::Ads::GoogleAds::V25::Resources::Campaign;
...
sub new {
  ...
  my $self = {
    ...
    missingEuPoliticalAdvertisingDeclaration => $args->{missingEuPoliticalAdvertisingDeclaration},
    name => $args->{name},
    ...
    textGuidelines => $args->{textGuidelines},
    ...
    viewThroughConversionOptimizationEnabled => $args->{viewThroughConversionOptimizationEnabled}
  };
