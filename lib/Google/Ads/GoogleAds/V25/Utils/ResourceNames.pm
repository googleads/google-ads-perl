...
package Google::Ads::GoogleAds::V25::Utils::ResourceNames;
...
sub accessible_bidding_strategy {
  ...
  my $path_template = 'customers/{customer_id}/accessibleBiddingStrategies/{bidding_strategy_id}';

  return expand_path_template($path_template, [$customer_id, $bidding_strategy_id]);
}
...
sub account_budget {
  ...
  my $path_template = 'customers/{customer_id}/accountBudgets/{account_budget_id}';

  return expand_path_template($path_template, [$customer_id, $account_budget_id]);
}
...
sub account_budget_proposal {
  ...
  my $path_template = 'customers/{customer_id}/accountBudgetProposals/{account_budget_proposal_id}';

  return expand_path_template($path_template, [$customer_id, $account_budget_proposal_id]);
}
...
sub ad_group_ad {
  ...
  my $path_template = 'customers/{customer_id}/adGroupAds/{ad_group_id}~{ad_id}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $ad_id]);
}
...
sub ad_group_ad_asset_combination_view {
  my ($customer_id, $ad_group_id, $ad_id, $asset_combination_id_low, $asset_combination_id_high) = @_;

  my $path_template = 'customers/{customer_id}/adGroupAdAssetCombinationViews/{ad_group_id}~{ad_id}~{asset_combination_id_low}~{asset_combination_id_high}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $ad_id, $asset_combination_id_low, $asset_combination_id_high]);
}
...
sub ad_group_ad_asset_view {
  ...
  my $path_template = 'customers/{customer_id}/adGroupAdAssetViews/{ad_group_id}~{ad_id}~{asset_id}~{field_type}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $ad_id, $asset_id, $field_type]);
}
...
sub ad_group_ad_label {
  ...
  my $path_template = 'customers/{customer_id}/adGroupAdLabels/{ad_group_id}~{ad_id}~{label_id}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $ad_id, $label_id]);
}
...
sub ad_group_asset {
  ...
  my $path_template = 'customers/{customer_id}/adGroupAssets/{ad_group_id}~{asset_id}~{field_type}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $asset_id, $field_type]);
}
...
sub ad_group_asset_set {
  ...
  my $path_template = 'customers/{customer_id}/adGroupAssetSets/{ad_group_id}~{asset_set_id}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $asset_set_id]);
}
...
sub ad_group_audience_view {
  ...
  my $path_template = 'customers/{customer_id}/adGroupAudienceViews/{ad_group_id}~{criterion_id}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $criterion_id]);
}
...
sub ad_group_bid_modifier {
  ...
  my $path_template = 'customers/{customer_id}/adGroupBidModifiers/{ad_group_id}~{criterion_id}';
...
sub ad_group_criterion {
  ...
  my $path_template = 'customers/{customer_id}/adGroupCriteria/{ad_group_id}~{criterion_id}';
...
sub ad_group_criterion_customizer {
  ...
  my $path_template = 'customers/{customer_id}/adGroupCriterionCustomizers/{ad_group_id}~{criterion_id}~{customizer_attribute_id}';
...
sub ad_group_criterion_label {
  ...
  my $path_template = 'customers/{customer_id}/adGroupCriterionLabels/{ad_group_id}~{criterion_id}~{label_id}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $criterion_id, $label_id]);
}

# Returns the ad_group_criterion_simulation resource name for the specified components.
sub ad_group_criterion_simulation {
  my ($customer_id, $ad_group_id, $criterion_id, $type, $modification_method, $start_date, $end_date) = @_;

  my $path_template = 'customers/{customer_id}/adGroupCriterionSimulations/{ad_group_id}~{criterion_id}~{type}~{modification_method}~{start_date}~{end_date}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $criterion_id, $type, $modification_method, $start_date, $end_date]);
}
...
sub ad_group_customizer {
  ...
  my $path_template = 'customers/{customer_id}/adGroupCustomizers/{ad_group_id}~{customizer_attribute_id}';
...
sub ad_group_label {
  ...
  my $path_template = 'customers/{customer_id}/adGroupLabels/{ad_group_id}~{label_id}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $label_id]);
}

# Returns the ad_group_simulation resource name for the specified components.
sub ad_group_simulation {
  my ($customer_id, $ad_group_id, $type, $modification_method, $start_date, $end_date) = @_;

  my $path_template = 'customers/{customer_id}/adGroupSimulations/{ad_group_id}~{type}~{modification_method}~{start_date}~{end_date}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $type, $modification_method, $start_date, $end_date]);
}
...
sub ad_parameter {
  ...
  my $path_template = 'customers/{customer_id}/adParameters/{ad_group_id}~{criterion_id}~{parameter_index}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $criterion_id, $parameter_index]);
}
...
sub ad_schedule_view {
  ...
  my $path_template = 'customers/{customer_id}/adScheduleViews/{campaign_id}~{criterion_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $criterion_id]);
}
...
sub age_range_view {
  ...
  my $path_template = 'customers/{customer_id}/ageRangeViews/{ad_group_id}~{criterion_id}';
...
sub ai_max_search_term_ad_combination_view {
  ...
  my $path_template = 'customers/{customer_id}/aiMaxSearchTermAdCombinationViews/{ad_group_id}~{search_term}~{landing_page}~{headline}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $search_term, $landing_page, $headline]);
}
...
sub android_privacy_shared_key_google_ad_group {
  my ($customer_id, $campaign_id, $ad_group_id, $android_privacy_interaction_type, $android_privacy_network_type, $android_privacy_interaction_date) = @_;

  my $path_template = 'customers/{customer_id}/androidPrivacySharedKeyGoogleAdGroups/{campaign_id}~{ad_group_id}~{android_privacy_interaction_type}~{android_privacy_network_type}~{android_privacy_interaction_date}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $ad_group_id, $android_privacy_interaction_type, $android_privacy_network_type, $android_privacy_interaction_date]);
}
...
sub android_privacy_shared_key_google_campaign {
  my ($customer_id, $campaign_id, $android_privacy_interaction_type, $android_privacy_interaction_date) = @_;

  my $path_template = 'customers/{customer_id}/androidPrivacySharedKeyGoogleCampaigns/{campaign_id}~{android_privacy_interaction_type}~{android_privacy_interaction_date}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $android_privacy_interaction_type, $android_privacy_interaction_date]);
}
...
sub android_privacy_shared_key_google_network_type {
  my ($customer_id, $campaign_id, $android_privacy_interaction_type, $android_privacy_network_type, $android_privacy_interaction_date) = @_;

  my $path_template = 'customers/{customer_id}/androidPrivacySharedKeyGoogleNetworkTypes/{campaign_id}~{android_privacy_interaction_type}~{android_privacy_network_type}~{android_privacy_interaction_date}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $android_privacy_interaction_type, $android_privacy_network_type, $android_privacy_interaction_date]);
}
...
sub app_top_combination_view {
  ...
  my $path_template = 'customers/{customer_id}/appTopCombinationViews/{ad_group_id}~{ad_id}~{asset_combination_category}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $ad_id, $asset_combination_category]);
}
...
sub applied_incentive {
  ...
  my $path_template = 'customers/{customer_id}/appliedIncentives/{coupon_code}';

  return expand_path_template($path_template, [$customer_id, $coupon_code]);
}
...
sub asset_field_type_view {
  ...
  my $path_template = 'customers/{customer_id}/assetFieldTypeViews/{field_type}';
...
sub asset_group_asset {
  ...
  my $path_template = 'customers/{customer_id}/assetGroupAssets/{asset_group_id}~{asset_id}~{field_type}';

  return expand_path_template($path_template, [$customer_id, $asset_group_id, $asset_id, $field_type]);
}
...
sub asset_group_listing_group_filter {
  ...
  my $path_template = 'customers/{customer_id}/assetGroupListingGroupFilters/{asset_group_id}~{listing_group_filter_id}';
...
sub asset_group_product_group_view {
  ...
  my $path_template = 'customers/{customer_id}/assetGroupProductGroupViews/{asset_group_id}~{listing_group_filter_id}';
...
sub asset_group_signal {
  ...
  my $path_template = 'customers/{customer_id}/assetGroupSignals/{asset_group_id}~{criterion_id}';

  return expand_path_template($path_template, [$customer_id, $asset_group_id, $criterion_id]);
}
...
sub asset_group_top_combination_view {
  ...
  my $path_template = 'customers/{customer_id}/assetGroupTopCombinationViews/{asset_group_id}~{asset_combination_category}';

  return expand_path_template($path_template, [$customer_id, $asset_group_id, $asset_combination_category]);
}
...
sub asset_set_asset {
  ...
  my $path_template = 'customers/{customer_id}/assetSetAssets/{asset_set_id}~{asset_id}';

  return expand_path_template($path_template, [$customer_id, $asset_set_id, $asset_id]);
}
...
sub asset_set_type_view {
  ...
  my $path_template = 'customers/{customer_id}/assetSetTypeViews/{asset_set_type}';
...
sub bidding_data_exclusion {
  ...
  my $path_template = 'customers/{customer_id}/biddingDataExclusions/{seasonality_event_id}';

  return expand_path_template($path_template, [$customer_id, $seasonality_event_id]);
}
...
sub bidding_seasonality_adjustment {
  ...
  my $path_template = 'customers/{customer_id}/biddingSeasonalityAdjustments/{seasonality_event_id}';
...
sub bidding_strategy {
  ...
  my $path_template = 'customers/{customer_id}/biddingStrategies/{bidding_strategy_id}';
...
sub bidding_strategy_simulation {
  my ($customer_id, $bidding_strategy_id, $type, $modification_method, $start_date, $end_date) = @_;

  my $path_template = 'customers/{customer_id}/biddingStrategySimulations/{bidding_strategy_id}~{type}~{modification_method}~{start_date}~{end_date}';

  return expand_path_template($path_template, [$customer_id, $bidding_strategy_id, $type, $modification_method, $start_date, $end_date]);
}
...
sub billing_setup {
  ...
  my $path_template = 'customers/{customer_id}/billingSetups/{billing_setup_id}';

  return expand_path_template($path_template, [$customer_id, $billing_setup_id]);
}
...
sub campaign_aggregate_asset_view {
  my ($customer_id, $campaign_id, $asset_id, $asset_link_source, $field_type) = @_;

  my $path_template = 'customers/{customer_id}/campaignAggregateAssetViews/{campaign_id}~{asset_id}~{asset_link_source}~{field_type}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $asset_id, $asset_link_source, $field_type]);
}
...
sub campaign_asset {
  ...
  my $path_template = 'customers/{customer_id}/campaignAssets/{campaign_id}~{asset_id}~{field_type}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $asset_id, $field_type]);
}
...
sub campaign_asset_set {
  ...
  my $path_template = 'customers/{customer_id}/campaignAssetSets/{campaign_id}~{asset_set_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $asset_set_id]);
}
...
sub campaign_audience_view {
  ...
  my $path_template = 'customers/{customer_id}/campaignAudienceViews/{campaign_id}~{criterion_id}';
...
sub campaign_bid_modifier {
  ...
  my $path_template = 'customers/{customer_id}/campaignBidModifiers/{campaign_id}~{criterion_id}';
...
sub campaign_budget {
  ...
  my $path_template = 'customers/{customer_id}/campaignBudgets/{campaign_budget_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_budget_id]);
}
...
sub campaign_conversion_goal {
  ...
  my $path_template = 'customers/{customer_id}/campaignConversionGoals/{campaign_id}~{category}~{source}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $category, $source]);
}
...
sub campaign_criterion {
  ...
  my $path_template = 'customers/{customer_id}/campaignCriteria/{campaign_id}~{criterion_id}';
...
sub campaign_criterion_simulation {
  my ($customer_id, $campaign_id, $criterion_id, $type, $modification_method, $start_date, $end_date) = @_;

  my $path_template = 'customers/{customer_id}/campaignCriterionSimulations/{campaign_id}~{criterion_id}~{type}~{modification_method}~{start_date}~{end_date}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $criterion_id, $type, $modification_method, $start_date, $end_date]);
}
...
sub campaign_customizer {
  ...
  my $path_template = 'customers/{customer_id}/campaignCustomizers/{campaign_id}~{customizer_attribute_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $customizer_attribute_id]);
}
...
sub campaign_draft {
  ...
  my $path_template = 'customers/{customer_id}/campaignDrafts/{base_campaign_id}~{draft_id}';

  return expand_path_template($path_template, [$customer_id, $base_campaign_id, $draft_id]);
}
...
sub campaign_goal_config {
  ...
  my $path_template = 'customers/{customer_id}/campaignGoalConfigs/{campaign_id}~{unified_goal_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $unified_goal_id]);
}
...
sub campaign_group {
  ...
  my $path_template = 'customers/{customer_id}/campaignGroups/{campaign_group_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_group_id]);
}
...
sub campaign_label {
  ...
  my $path_template = 'customers/{customer_id}/campaignLabels/{campaign_id}~{label_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $label_id]);
}
...
sub campaign_search_term_insight {
  ...
  my $path_template = 'customers/{customer_id}/campaignSearchTermInsights/{campaign_id}~{cluster_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $cluster_id]);
}
...
sub campaign_search_term_view {
  ...
  my $path_template = 'customers/{customer_id}/campaignSearchTermViews/{campaign_id}~{query}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $query]);
}
...
sub campaign_shared_set {
  ...
  my $path_template = 'customers/{customer_id}/campaignSharedSets/{campaign_id}~{shared_set_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $shared_set_id]);
}

# Returns the campaign_simulation resource name for the specified components.
sub campaign_simulation {
  my ($customer_id, $campaign_id, $type, $modification_method, $start_date, $end_date) = @_;

  my $path_template = 'customers/{customer_id}/campaignSimulations/{campaign_id}~{type}~{modification_method}~{start_date}~{end_date}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $type, $modification_method, $start_date, $end_date]);
}
...
# Returns the cart_data_sales_view resource name for the specified components.
sub cart_data_sales_view {
  my ($customer_id) = @_;

  my $path_template = 'customers/{customer_id}/cartDataSalesView';
...
sub change_event {
  ...
  my $path_template = 'customers/{customer_id}/changeEvents/{timestamp_micros}~{command_index}~{mutate_index}';

  return expand_path_template($path_template, [$customer_id, $timestamp_micros, $command_index, $mutate_index]);
}
...
sub change_status {
  ...
  return expand_path_template($path_template, [$customer_id, $change_status_id]);
}

# Returns the channel_aggregate_asset_view resource name for the specified components.
sub channel_aggregate_asset_view {
  my ($customer_id, $advertising_channel_type, $asset_id, $asset_source, $field_type) = @_;

  my $path_template = 'customers/{customer_id}/channelAggregateAssetViews/{advertising_channel_type}~{asset_id}~{asset_source}~{field_type}';

  return expand_path_template($path_template, [$customer_id, $advertising_channel_type, $asset_id, $asset_source, $field_type]);
}
...
sub combined_audience {
  ...
  my $path_template = 'customers/{customer_id}/combinedAudiences/{combined_audience_id}';

  return expand_path_template($path_template, [$customer_id, $combined_audience_id]);
}
...
sub content_criterion_view {
  ...
  my $path_template = 'customers/{customer_id}/contentCriterionViews/{ad_group_id}~{criterion_id}';
...
sub conversion_action {
  ...
  my $path_template = 'customers/{customer_id}/conversionActions/{conversion_action_id}';

  return expand_path_template($path_template, [$customer_id, $conversion_action_id]);
}
...
sub conversion_custom_variable {
  ...
  my $path_template = 'customers/{customer_id}/conversionCustomVariables/{conversion_custom_variable_id}';

  return expand_path_template($path_template, [$customer_id, $conversion_custom_variable_id]);
}
...
sub conversion_goal_campaign_config {
  ...
  my $path_template = 'customers/{customer_id}/conversionGoalCampaignConfigs/{campaign_id}';
...
sub conversion_value_rule {
  ...
  my $path_template = 'customers/{customer_id}/conversionValueRules/{conversion_value_rule_id}';

  return expand_path_template($path_template, [$customer_id, $conversion_value_rule_id]);
}
...
sub conversion_value_rule_set {
  ...
  my $path_template = 'customers/{customer_id}/conversionValueRuleSets/{conversion_value_rule_set_id}';

  return expand_path_template($path_template, [$customer_id, $conversion_value_rule_set_id]);
}
...
sub custom_audience {
  ...
  my $path_template = 'customers/{customer_id}/customAudiences/{custom_audience_id}';

  return expand_path_template($path_template, [$customer_id, $custom_audience_id]);
}
...
sub custom_interest {
  ...
  my $path_template = 'customers/{customer_id}/customInterests/{custom_interest_id}';

  return expand_path_template($path_template, [$customer_id, $custom_interest_id]);
}
...
sub customer_asset {
  ...
  my $path_template = 'customers/{customer_id}/customerAssets/{asset_id}~{field_type}';

  return expand_path_template($path_template, [$customer_id, $asset_id, $field_type]);
}
...
sub customer_asset_set {
  ...
  my $path_template = 'customers/{customer_id}/customerAssetSets/{asset_set_id}';
...
sub customer_client {
  ...
  my $path_template = 'customers/{customer_id}/customerClients/{client_customer_id}';

  return expand_path_template($path_template, [$customer_id, $client_customer_id]);
}
...
sub customer_client_link {
  ...
  my $path_template = 'customers/{customer_id}/customerClientLinks/{client_customer_id}~{manager_link_id}';

  return expand_path_template($path_template, [$customer_id, $client_customer_id, $manager_link_id]);
}
...
sub customer_conversion_goal {
  ...
  my $path_template = 'customers/{customer_id}/customerConversionGoals/{category}~{source}';

  return expand_path_template($path_template, [$customer_id, $category, $source]);
}
...
sub customer_customizer {
  ...
  my $path_template = 'customers/{customer_id}/customerCustomizers/{customizer_attribute_id}';

  return expand_path_template($path_template, [$customer_id, $customizer_attribute_id]);
}
...
sub customer_manager_link {
  ...
  my $path_template = 'customers/{customer_id}/customerManagerLinks/{manager_customer_id}~{manager_link_id}';

  return expand_path_template($path_template, [$customer_id, $manager_customer_id, $manager_link_id]);
}
...
sub customer_negative_criterion {
  ...
  my $path_template = 'customers/{customer_id}/customerNegativeCriteria/{criterion_id}';
...
sub customer_search_term_insight {
  ...
  my $path_template = 'customers/{customer_id}/customerSearchTermInsights/{cluster_id}';
...
sub customer_sk_ad_network_conversion_value_schema {
  ...
  my $path_template = 'customers/{customer_id}/customerSkAdNetworkConversionValueSchemas/{account_link_id}';
...
sub customer_user_access_invitation {
  ...
  my $path_template = 'customers/{customer_id}/customerUserAccessInvitations/{invitation_id}';
...
sub customizer_attribute {
  ...
  my $path_template = 'customers/{customer_id}/customizerAttributes/{customizer_attribute_id}';
...
sub data_link {
  ...
  my $path_template = 'customers/{customer_id}/dataLinks/{product_link_id}~{data_link_id}';

  return expand_path_template($path_template, [$customer_id, $product_link_id, $data_link_id]);
}
...
sub detail_content_suitability_placement_view {
  ...
  my $path_template = 'customers/{customer_id}/detailContentSuitabilityPlacementViews/{placement_fingerprint}';

  return expand_path_template($path_template, [$customer_id, $placement_fingerprint]);
}
...
sub detail_placement_view {
  ...
  my $path_template = 'customers/{customer_id}/detailPlacementViews/{ad_group_id}~{base64_placement}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $base64_placement]);
}
...
sub detailed_demographic {
  ...
  my $path_template = 'customers/{customer_id}/detailedDemographics/{detailed_demographic_id}';

  return expand_path_template($path_template, [$customer_id, $detailed_demographic_id]);
}
...
sub display_keyword_view {
  ...
  my $path_template = 'customers/{customer_id}/displayKeywordViews/{ad_group_id}~{criterion_id}';
...
sub distance_view {
  ...
  my $path_template = 'customers/{customer_id}/distanceViews/{placeholder_chain_id}~{distance_bucket}';

  return expand_path_template($path_template, [$customer_id, $placeholder_chain_id, $distance_bucket]);
}
...
sub domain_category {
  ...
  my $path_template = 'customers/{customer_id}/domainCategories/{campaign_id}~{base64_category}~{language_code}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $base64_category, $language_code]);
}
...
sub dynamic_search_ads_search_term_view {
  my ($customer_id, $ad_group_id, $search_term_fingerprint, $headline_fingerprint, $landing_page_fingerprint, $page_url_fingerprint) = @_;

  my $path_template = 'customers/{customer_id}/dynamicSearchAdsSearchTermViews/{ad_group_id}~{search_term_fingerprint}~{headline_fingerprint}~{landing_page_fingerprint}~{page_url_fingerprint}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $search_term_fingerprint, $headline_fingerprint, $landing_page_fingerprint, $page_url_fingerprint]);
}
...
sub expanded_landing_page_view {
  ...
  my $path_template = 'customers/{customer_id}/expandedLandingPageViews/{expanded_final_url_fingerprint}';

  return expand_path_template($path_template, [$customer_id, $expanded_final_url_fingerprint]);
}
...
sub experiment_arm {
  ...
  my $path_template = 'customers/{customer_id}/experimentArms/{trial_id}~{trial_arm_id}';

  return expand_path_template($path_template, [$customer_id, $trial_id, $trial_arm_id]);
}
...
sub final_url_expansion_asset_view {
  ...
  my $path_template = 'customers/{customer_id}/finalUrlExpansionAssetViews/{campaign_id}~{asset_id}~{field_type}~{url_fp}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $asset_id, $field_type, $url_fp]);
}
...
sub gender_view {
  ...
  my $path_template = 'customers/{customer_id}/genderViews/{ad_group_id}~{criterion_id}';
...
sub geographic_view {
  ...
  my $path_template = 'customers/{customer_id}/geographicViews/{country_criterion_id}~{location_type}';

  return expand_path_template($path_template, [$customer_id, $country_criterion_id, $location_type]);
}
...
sub group_content_suitability_placement_view {
  ...
  my $path_template = 'customers/{customer_id}/groupContentSuitabilityPlacementViews/{placement_fingerprint}';
...
sub group_placement_view {
  ...
  my $path_template = 'customers/{customer_id}/groupPlacementViews/{ad_group_id}~{base64_placement}';
...
sub hotel_group_view {
  ...
  my $path_template = 'customers/{customer_id}/hotelGroupViews/{ad_group_id}~{criterion_id}';
...
sub hotel_reconciliation {
  ...
  my $path_template = 'customers/{customer_id}/hotelReconciliations/{commission_id}';
...
sub income_range_view {
  ...
  my $path_template = 'customers/{customer_id}/incomeRangeViews/{ad_group_id}~{criterion_id}';
...
sub keyword_plan_ad_group {
  ...
  my $path_template = 'customers/{customer_id}/keywordPlanAdGroups/{keyword_plan_ad_group_id}';

  return expand_path_template($path_template, [$customer_id, $keyword_plan_ad_group_id]);
}
...
sub keyword_plan_ad_group_keyword {
  ...
  my $path_template = 'customers/{customer_id}/keywordPlanAdGroupKeywords/{keyword_plan_ad_group_keyword_id}';

  return expand_path_template($path_template, [$customer_id, $keyword_plan_ad_group_keyword_id]);
}
...
sub keyword_plan_campaign {
  ...
  my $path_template = 'customers/{customer_id}/keywordPlanCampaigns/{keyword_plan_campaign_id}';

  return expand_path_template($path_template, [$customer_id, $keyword_plan_campaign_id]);
}
...
sub keyword_plan_campaign_keyword {
  ...
  my $path_template = 'customers/{customer_id}/keywordPlanCampaignKeywords/{keyword_plan_campaign_keyword_id}';

  return expand_path_template($path_template, [$customer_id, $keyword_plan_campaign_keyword_id]);
}
...
sub keyword_theme_constant {
  ...
  my $path_template = 'keywordThemeConstants/{express_category_id}~{express_sub_category_id}';

  return expand_path_template($path_template, [$express_category_id, $express_sub_category_id]);
}
...
sub keyword_view {
  ...
  my $path_template = 'customers/{customer_id}/keywordViews/{ad_group_id}~{criterion_id}';
...
sub landing_page_view {
  ...
  my $path_template = 'customers/{customer_id}/landingPageViews/{unexpanded_final_url_fingerprint}';

  return expand_path_template($path_template, [$customer_id, $unexpanded_final_url_fingerprint]);
}
...
sub lead_form_submission_data {
  ...
  my $path_template = 'customers/{customer_id}/leadFormSubmissionData/{lead_form_user_submission_id}';

  return expand_path_template($path_template, [$customer_id, $lead_form_user_submission_id]);
}
...
sub lift_measurement_age_range {
  my ($customer_id, $lift_measurement_configuration_id, $campaign_id, $criterion_id) = @_;

  my $path_template = 'customers/{customer_id}/liftMeasurementAgeRanges/{lift_measurement_configuration_id}~{campaign_id}~{criterion_id}';

  return expand_path_template($path_template, [$customer_id, $lift_measurement_configuration_id, $campaign_id, $criterion_id]);
}
...
sub lift_measurement_campaign {
  ...
  my $path_template = 'customers/{customer_id}/liftMeasurementCampaigns/{lift_measurement_configuration_id}~{campaign_id}';

  return expand_path_template($path_template, [$customer_id, $lift_measurement_configuration_id, $campaign_id]);
}
...
sub lift_measurement_config {
  ...
  my $path_template = 'customers/{customer_id}/liftMeasurementConfigs/{lift_measurement_configuration_id}';

  return expand_path_template($path_template, [$customer_id, $lift_measurement_configuration_id]);
}
...
sub lift_measurement_device {
  ...
  my $path_template = 'customers/{customer_id}/liftMeasurementDevices/{lift_measurement_configuration_id}~{campaign_id}~{criterion_id}';
...
sub lift_measurement_flight {
  my ($customer_id, $lift_measurement_configuration_id, $lift_measurement_flight_id) = @_;

  my $path_template = 'customers/{customer_id}/liftMeasurementFlights/{lift_measurement_configuration_id}~{lift_measurement_flight_id}';

  return expand_path_template($path_template, [$customer_id, $lift_measurement_configuration_id, $lift_measurement_flight_id]);
}
...
sub lift_measurement_gender {
  ...
  my $path_template = 'customers/{customer_id}/liftMeasurementGenders/{lift_measurement_configuration_id}~{campaign_id}~{criterion_id}';
...
sub lift_measurement_video {
  my ($customer_id, $lift_measurement_configuration_id, $campaign_id, $external_video_id) = @_;

  my $path_template = 'customers/{customer_id}/liftMeasurementVideos/{lift_measurement_configuration_id}~{campaign_id}~{external_video_id}';

  return expand_path_template($path_template, [$customer_id, $lift_measurement_configuration_id, $campaign_id, $external_video_id]);
}
...
sub local_services_employee {
  ...
  my $path_template = 'customers/{customer_id}/localServicesEmployees/{gls_employee_id}';
...
sub local_services_lead {
  ...
  my $path_template = 'customers/{customer_id}/localServicesLeads/{local_services_lead_id}';

  return expand_path_template($path_template, [$customer_id, $local_services_lead_id]);
}
...
sub local_services_lead_conversation {
  ...
  my $path_template = 'customers/{customer_id}/localServicesLeadConversations/{local_services_lead_conversation_id}';

  return expand_path_template($path_template, [$customer_id, $local_services_lead_conversation_id]);
}
...
sub local_services_verification_artifact {
  ...
  my $path_template = 'customers/{customer_id}/localServicesVerificationArtifacts/{gls_verification_artifact_id}';

  return expand_path_template($path_template, [$customer_id, $gls_verification_artifact_id]);
}
...
sub location_interest_view {
  ...
  my $path_template = 'customers/{customer_id}/locationInterestViews/{campaign_id}~{ad_group_id}~{criterion_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $ad_group_id, $criterion_id]);
}
...
sub location_view {
  ...
  my $path_template = 'customers/{customer_id}/locationViews/{campaign_id}~{criterion_id}';
...
sub managed_placement_view {
  ...
  my $path_template = 'customers/{customer_id}/managedPlacementViews/{ad_group_id}~{criterion_id}';

  return expand_path_template($path_template, [$customer_id, $ad_group_id, $criterion_id]);
}

# Returns the matched_location_interest_view resource name for the specified components.
sub matched_location_interest_view {
  my ($customer_id, $country_criterion_id) = @_;

  my $path_template = 'customers/{customer_id}/matchedLocationInterestViews/{country_criterion_id}';

  return expand_path_template($path_template, [$customer_id, $country_criterion_id]);
}
...
sub merchant_center_link {
  ...
  my $path_template = 'customers/{customer_id}/merchantCenterLinks/{merchant_center_id}';

  return expand_path_template($path_template, [$customer_id, $merchant_center_id]);
}
...
sub multi_party_auth_review {
  ...
  my $path_template = 'customers/{customer_id}/multiPartyAuthReviews/{customer_invitation_id}';

  return expand_path_template($path_template, [$customer_id, $customer_invitation_id]);
}
...
sub offline_conversion_upload_client_summary {
  ...
  my $path_template = 'customers/{customer_id}/offlineConversionUploadClientSummaries/{client}';
...
sub offline_conversion_upload_conversion_action_summary {
  ...
  my $path_template = 'customers/{customer_id}/offlineConversionUploadConversionActionSummaries/{conversion_type_id}~{client}';

  return expand_path_template($path_template, [$customer_id, $conversion_type_id, $client]);
}
...
sub offline_user_data_job {
  ...
  my $path_template = 'customers/{customer_id}/offlineUserDataJobs/{offline_user_data_update_id}';

  return expand_path_template($path_template, [$customer_id, $offline_user_data_update_id]);
}
...
sub paid_organic_search_term_view {
  ...
  my $path_template = 'customers/{customer_id}/paidOrganicSearchTermViews/{campaign_id}~{ad_group_id}~{base64_search_term}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $ad_group_id, $base64_search_term]);
}
...
sub parental_status_view {
  ...
  my $path_template = 'customers/{customer_id}/parentalStatusViews/{ad_group_id}~{criterion_id}';
...
sub payments_account {
  ...
  my $path_template = 'customers/{customer_id}/paymentsAccounts/{payments_account_id}';

  return expand_path_template($path_template, [$customer_id, $payments_account_id]);
}
...
sub performance_max_placement_view {
  ...
  my $path_template = 'customers/{customer_id}/performanceMaxPlacementViews/{base_64_placement}';

  return expand_path_template($path_template, [$customer_id, $base_64_placement]);
}
...
sub product_group_view {
  ...
  my $path_template = 'customers/{customer_id}/productGroupViews/{adgroup_id}~{criterion_id}';

  return expand_path_template($path_template, [$customer_id, $adgroup_id, $criterion_id]);
}
...
sub product_link_invitation {
  ...
  my $path_template = 'customers/{customer_id}/productLinkInvitations/{customer_invitation_id}';
...
sub recommendation {
  ...
  my $path_template = 'customers/{customer_id}/recommendations/{recommendation_id}';

  return expand_path_template($path_template, [$customer_id, $recommendation_id]);
}
...
sub recommendation_subscription {
  ...
  my $path_template = 'customers/{customer_id}/recommendationSubscriptions/{recommendation_type}';

  return expand_path_template($path_template, [$customer_id, $recommendation_type]);
}
...
sub remarketing_action {
  ...
  my $path_template = 'customers/{customer_id}/remarketingActions/{remarketing_action_id}';

  return expand_path_template($path_template, [$customer_id, $remarketing_action_id]);
}
...
sub search_term_view {
  ...
  my $path_template = 'customers/{customer_id}/searchTermViews/{campaign_id}~{ad_group_id}~{query}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $ad_group_id, $query]);
}
...
sub shared_criterion {
  ...
  my $path_template = 'customers/{customer_id}/sharedCriteria/{shared_set_id}~{criterion_id}';

  return expand_path_template($path_template, [$customer_id, $shared_set_id, $criterion_id]);
}
...
sub shopping_product {
  my ($customer_id, $merchant_center_id, $channel, $language_code, $feed_label, $item_id) = @_;

  my $path_template = 'customers/{customer_id}/shoppingProducts/{merchant_center_id}~{channel}~{language_code}~{feed_label}~{item_id}';

  return expand_path_template($path_template, [$customer_id, $merchant_center_id, $channel, $language_code, $feed_label, $item_id]);
}
...
sub smart_campaign_search_term_view {
  ...
  my $path_template = 'customers/{customer_id}/smartCampaignSearchTermViews/{campaign_id}~{query}';
...
sub smart_campaign_setting {
  ...
  my $path_template = 'customers/{customer_id}/smartCampaignSettings/{campaign_id}';

  return expand_path_template($path_template, [$customer_id, $campaign_id]);
}

# Returns the targeting_expansion_view resource name for the specified components.
sub targeting_expansion_view {
  my ($customer_id, $campaign_id, $targeting_expansion_type) = @_;

  my $path_template = 'customers/{customer_id}/targetingExpansionViews/{campaign_id}~{targeting_expansion_type}';

  return expand_path_template($path_template, [$customer_id, $campaign_id, $targeting_expansion_type]);
}
...
sub third_party_app_analytics_link {
  ...
  my $path_template = 'customers/{customer_id}/thirdPartyAppAnalyticsLinks/{customer_link_id}';

  return expand_path_template($path_template, [$customer_id, $customer_link_id]);
}
...
sub topic_view {
  ...
  my $path_template = 'customers/{customer_id}/topicViews/{ad_group_id}~{criterion_id}';
...
sub travel_activity_group_view {
  ...
  my $path_template = 'customers/{customer_id}/travelActivityGroupViews/{ad_group_id}~{criterion_id}';
...
sub user_interest {
  ...
  my $path_template = 'customers/{customer_id}/userInterests/{user_interest_id}';

  return expand_path_template($path_template, [$customer_id, $user_interest_id]);
}
...
sub user_list_customer_type {
  ...
  my $path_template = 'customers/{customer_id}/userListCustomerTypes/{user_list_id}~{semantic_label}';

  return expand_path_template($path_template, [$customer_id, $user_list_id, $semantic_label]);
}
...
sub user_location_view {
  ...
  my $path_template = 'customers/{customer_id}/userLocationViews/{country_criterion_id}~{is_targeting_location}';

  return expand_path_template($path_template, [$customer_id, $country_criterion_id, $is_targeting_location]);
}
...
sub video_enhancement {
  ...
  my $path_template = 'customers/{customer_id}/videoEnhancements/{video_enhancement}';

  return expand_path_template($path_template, [$customer_id, $video_enhancement]);
}
...
sub webpage_view {
  ...
  my $path_template = 'customers/{customer_id}/webpageViews/{ad_group_id}~{criterion_id}';
...
sub you_tube_video_upload {
  ...
  my $path_template = 'customers/{customer_id}/youTubeVideoUploads/{video_upload_id}';
