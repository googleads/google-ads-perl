...
package Google::Ads::GoogleAds::V25::Errors::ErrorCode;
...
sub new {
  ...
  my $self = {
    ...
    assetGroupListingGroupFilterError => $args->{assetGroupListingGroupFilterError},
    ...
    automaticallyCreatedAssetRemovalError => $args->{automaticallyCreatedAssetRemovalError},
    ...
    businessProfileLocationSyncError => $args->{businessProfileLocationSyncError},
    ...
    conversionGoalCampaignConfigError => $args->{conversionGoalCampaignConfigError},
    ...
    customerSkAdNetworkConversionValueSchemaError => $args->{customerSkAdNetworkConversionValueSchemaError},
    ...
    geoTargetConstantSuggestionError => $args->{geoTargetConstantSuggestionError},
