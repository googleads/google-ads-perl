...
package Google::Ads::GoogleAds::V1::Services::CustomerExtensionSettingService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::CustomerExtensionSettingService::MutateCustomerExtensionSettingsResponse';
  my $request_path =
    'v1/customers/{+customerId}/customerExtensionSettings:mutate';
