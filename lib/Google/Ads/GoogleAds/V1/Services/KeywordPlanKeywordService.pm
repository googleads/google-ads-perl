...
package Google::Ads::GoogleAds::V1::Services::KeywordPlanKeywordService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::KeywordPlanKeywordService::MutateKeywordPlanKeywordsResponse';
  my $request_path = 'v1/customers/{+customerId}/keywordPlanKeywords:mutate';
