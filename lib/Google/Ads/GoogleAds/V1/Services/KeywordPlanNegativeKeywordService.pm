...
package Google::Ads::GoogleAds::V1::Services::KeywordPlanNegativeKeywordService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::KeywordPlanNegativeKeywordService::MutateKeywordPlanNegativeKeywordsResponse';
  my $request_path =
    'v1/customers/{+customerId}/keywordPlanNegativeKeywords:mutate';
