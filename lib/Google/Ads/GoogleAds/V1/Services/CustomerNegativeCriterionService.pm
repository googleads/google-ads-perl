...
package Google::Ads::GoogleAds::V1::Services::CustomerNegativeCriterionService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::CustomerNegativeCriterionService::MutateCustomerNegativeCriteriaResponse';
  my $request_path =
    'v1/customers/{+customerId}/customerNegativeCriteria:mutate';
