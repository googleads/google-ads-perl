...
package Google::Ads::GoogleAds::V1::Services::GeoTargetConstantService;
...
sub suggest {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::GeoTargetConstantService::SuggestGeoTargetConstantsResponse';
  my $request_path = 'v1/geoTargetConstants:suggest';
