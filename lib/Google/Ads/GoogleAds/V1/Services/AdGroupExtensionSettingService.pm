...
package Google::Ads::GoogleAds::V1::Services::AdGroupExtensionSettingService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::AdGroupExtensionSettingService::MutateAdGroupExtensionSettingsResponse';
  my $request_path =
    'v1/customers/{+customerId}/adGroupExtensionSettings:mutate';
