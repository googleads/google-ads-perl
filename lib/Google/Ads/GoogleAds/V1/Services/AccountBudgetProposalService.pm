...
package Google::Ads::GoogleAds::V1::Services::AccountBudgetProposalService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::AccountBudgetProposalService::MutateAccountBudgetProposalResponse';
  my $request_path = 'v1/customers/{+customerId}/accountBudgetProposals:mutate';
