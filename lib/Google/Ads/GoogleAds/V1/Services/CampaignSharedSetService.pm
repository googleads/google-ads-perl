...
package Google::Ads::GoogleAds::V1::Services::CampaignSharedSetService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::CampaignSharedSetService::MutateCampaignSharedSetsResponse';
  my $request_path = 'v1/customers/{+customerId}/campaignSharedSets:mutate';
