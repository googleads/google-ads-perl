...
package Google::Ads::GoogleAds::V1::Services::KeywordPlanCampaignService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::KeywordPlanCampaignService::MutateKeywordPlanCampaignsResponse';
  my $request_path = 'v1/customers/{+customerId}/keywordPlanCampaigns:mutate';
