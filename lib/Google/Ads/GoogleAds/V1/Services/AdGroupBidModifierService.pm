...
package Google::Ads::GoogleAds::V1::Services::AdGroupBidModifierService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::AdGroupBidModifierService::MutateAdGroupBidModifiersResponse';
  my $request_path = 'v1/customers/{+customerId}/adGroupBidModifiers:mutate';
