...
package Google::Ads::GoogleAds::V1::Services::RemarketingActionService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::RemarketingActionService::MutateRemarketingActionsResponse';
  my $request_path = 'v1/customers/{+customerId}/remarketingActions:mutate';
