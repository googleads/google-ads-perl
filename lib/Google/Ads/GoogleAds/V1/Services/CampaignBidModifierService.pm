...
package Google::Ads::GoogleAds::V1::Services::CampaignBidModifierService;
...
sub mutate {
  ...
  my $http_method  = 'POST';
  my $response_type =
'Google::Ads::GoogleAds::V1::Services::CampaignBidModifierService::MutateCampaignBidModifiersResponse';
  my $request_path = 'v1/customers/{+customerId}/campaignBidModifiers:mutate';
