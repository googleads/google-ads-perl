...
package Google::Ads::GoogleAds::V1::Utils::ResourceNames;
...
'customers/{customer_id}/adParameters/{ad_group_id}~{criterion_id}~{parameter_index}';
  ...
  return expand_path_template(
    $path_template, $customer_id, $ad_group_id,
...
sub campaign_draft {
  ...
  return expand_path_template($path_template, $customer_id, $base_campaign_id,
    $draft_id);
}
...
sub click_view {
  ...
  return expand_path_template($path_template, $customer_id, $date_yyyy_MM_dd,
    $gclid);
}
...
'customers/{customer_id}/customerClientLinks/{client_customer_id}~{manager_link_id}';
  ...
  return expand_path_template($path_template, $customer_id,
    $client_customer_id, $manager_link_id);
}
...
'customers/{customer_id}/domainCategories/{campaign_id}~{category_base64}~{language_code}';
  ...
  return expand_path_template(
    $path_template,   $customer_id, $campaign_id,
    $category_base64, $language_code
  );
}
...
'customers/{customer_id}/dynamicSearchAdsSearchTermViews/{ad_group_id}~{search_term_fp}~{headline_fp}~{landing_page_fp}~{page_url_fp}';
  ...
  return expand_path_template(
    $path_template, $customer_id,     $ad_group_id, $search_term_fp,
    $headline_fp,   $landing_page_fp, $page_url_fp
  );
}
...
'customers/{customer_id}/feedItemTargets/{feed_id}~{feed_item_id}~{feed_item_target_type}~{feed_item_target_id}';
  ...
  return expand_path_template($path_template, $customer_id, $feed_id,
    $feed_item_id, $feed_item_target_type, $feed_item_target_id);
}
...
sub feed_placeholder_view {
  ...
  return expand_path_template($path_template, $customer_id, $placeholder_type);
}
...
# Returns the keyword_plan_keyword resource name for the specified components.
sub keyword_plan_keyword {
...
# Returns the keyword_plan_negative_keyword resource name for the specified components.
sub keyword_plan_negative_keyword {
  my ($customer_id, $kp_negative_keyword_id) = @_;
...
# Returns the mutate_job resource name for the specified components.
sub mutate_job {
  my ($customer_id, $mutate_job_id) = @_;

  my $path_template = 'customers/{customer_id}/mutateJobs/{mutate_job_id}';
...
'customers/{customer_id}/paidOrganicSearchTermViews/{campaign_id}~{ad_group_id}~{URL_base64_search_term}';
  ...
  return expand_path_template($path_template, $customer_id, $campaign_id,
    $ad_group_id, $URL_base64_search_term);
}
