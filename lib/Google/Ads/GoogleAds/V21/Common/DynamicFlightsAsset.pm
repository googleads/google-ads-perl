...
package Google::Ads::GoogleAds::V21::Common::DynamicFlightsAsset;
...
sub new {
  ...
  my $self = {
    ...
    flightDescription     => $args->{flightDescription},
    flightPrice           => $args->{flightPrice},
    flightSalePrice       => $args->{flightSalePrice},
    ...
    similarDestinationIds => $args->{similarDestinationIds}};
