...
package Google::Ads::GoogleAds::V21::Services::KeywordPlanIdeaService::CampaignToForecast;
...
sub new {
  ...
  my $self = {
    ...
    geoModifiers       => $args->{geoModifiers},
    keywordPlanNetwork => $args->{keywordPlanNetwork},
    languageConstants  => $args->{languageConstants},
