...
package Google::Ads::GoogleAds::V21::Resources::Ad;
...
sub new {
  ...
  my $self = {
    ...
    callAd                      => $args->{callAd},
    demandGenCarouselAd         => $args->{demandGenCarouselAd},
    demandGenMultiAssetAd       => $args->{demandGenMultiAssetAd},
    demandGenProductAd          => $args->{demandGenProductAd},
    demandGenVideoResponsiveAd  => $args->{demandGenVideoResponsiveAd},
